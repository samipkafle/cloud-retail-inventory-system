...
| FR-07 | Publish low-stock notifications and store alert history | Must | Partially implemented — alert history is written on each sale; SNS notification publishing not started |
