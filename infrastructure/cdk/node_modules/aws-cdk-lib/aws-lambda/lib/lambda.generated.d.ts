...
import { aws_cognito as cognitoRefs, aws_events as eventsRefs, aws_iam as iamRefs, aws_iot as ioTRefs, aws_kinesis as kinesisRefs, aws_kinesisfirehose as kinesisFirehoseRefs, aws_kms as kmsRefs, aws_lambda as lambdaRefs, aws_logs as logsRefs, aws_msk as mskRefs, aws_s3 as s3Refs, aws_sns as snsRefs, aws_sqs as sqsRefs } from "../../interfaces";
import { AliasReference, CapacityProviderReference, CodeSigningConfigReference, EventInvokeConfigReference, EventSourceMappingReference, FunctionReference, IAliasRef, ICapacityProviderRef, ICodeSigningConfigRef, IEventInvokeConfigRef, IEventSourceMappingRef, IFunctionRef, ILayerVersionPermissionRef, ILayerVersionRef, IMicrovmImageRef, INetworkConnectorRef, IPermissionRef, IUrlRef, IVersionRef, LayerVersionPermissionReference, LayerVersionReference, MicrovmImageReference, NetworkConnectorReference, PermissionReference, UrlReference, VersionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
/**
...
export declare class CfnAlias extends cdk.CfnResource implements cdk.IInspectable, IAliasRef {
     ...
     * Specifies a [provisioned concurrency](https://docs.aws.amazon.com/lambda/latest/dg/configuration-concurrency.html) configuration for a function's alias.
     */
    get provisionedConcurrencyConfig(): cdk.IResolvable | CfnAlias.ProvisionedConcurrencyConfigurationProperty | undefined;
    /**
     * Specifies a [provisioned concurrency](https://docs.aws.amazon.com/lambda/latest/dg/configuration-concurrency.html) configuration for a function's alias.
     */
    set provisionedConcurrencyConfig(value: cdk.IResolvable | CfnAlias.ProvisionedConcurrencyConfigurationProperty | undefined);
    /**
     * The [routing configuration](https://docs.aws.amazon.com/lambda/latest/dg/lambda-traffic-shifting-using-aliases.html) of the alias.
     */
    get routingConfig(): CfnAlias.AliasRoutingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The [routing configuration](https://docs.aws.amazon.com/lambda/latest/dg/lambda-traffic-shifting-using-aliases.html) of the alias.
     */
    set routingConfig(value: CfnAlias.AliasRoutingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the alias.
     *
     * @cloudformationAttribute AliasArn
     */
    get attrAliasArn(): string;
...
export interface CfnAliasProps {
     ...
     */
    readonly functionName: lambdaRefs.IFunctionRef | string;
    /**
     * The function version that the alias invokes.
     *
...
export declare class CfnCodeSigningConfig extends cdk.CfnResource implements cdk.IInspectable, ICodeSigningConfigRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCodeSigningConfig(x: any): x is CfnCodeSigningConfig;
    static arnForCodeSigningConfig(resource: ICodeSigningConfigRef): string;
    /**
     ...
     * List of allowed publishers.
     */
    get allowedPublishers(): CfnCodeSigningConfig.AllowedPublishersProperty | cdk.IResolvable;
    /**
     * List of allowed publishers.
     */
    set allowedPublishers(value: CfnCodeSigningConfig.AllowedPublishersProperty | cdk.IResolvable);
    /**
     * The code signing policy controls the validation failure action for signature mismatch or expiry.
     */
    get codeSigningPolicies(): CfnCodeSigningConfig.CodeSigningPoliciesProperty | cdk.IResolvable | undefined;
    /**
     * The code signing policy controls the validation failure action for signature mismatch or expiry.
     */
    set codeSigningPolicies(value: CfnCodeSigningConfig.CodeSigningPoliciesProperty | cdk.IResolvable | undefined);
    /**
     * Code signing configuration description.
     */
    get description(): string | undefined;
...
export declare class CfnEventInvokeConfig extends cdk.CfnResource implements cdk.IInspectable, IEventInvokeConfigRef {
     ...
     */
    static isCfnEventInvokeConfig(x: any): x is CfnEventInvokeConfig;
    /**
     ...
     * A destination for events after they have been sent to a function for processing.
     */
    get destinationConfig(): CfnEventInvokeConfig.DestinationConfigProperty | cdk.IResolvable | undefined;
    /**
     * A destination for events after they have been sent to a function for processing.
     */
    set destinationConfig(value: CfnEventInvokeConfig.DestinationConfigProperty | cdk.IResolvable | undefined);
    /**
     * The name of the Lambda function.
     */
    get functionName(): string;
...
export declare class CfnEventSourceMapping extends cdk.CfnResource implements cdk.IInspectable, IEventSourceMappingRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnEventSourceMapping(x: any): x is CfnEventSourceMapping;
    static arnForEventSourceMapping(resource: IEventSourceMappingRef): string;
    /**
     ...
     * Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.
     */
    get amazonManagedKafkaEventSourceConfig(): CfnEventSourceMapping.AmazonManagedKafkaEventSourceConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.
     */
    set amazonManagedKafkaEventSourceConfig(value: CfnEventSourceMapping.AmazonManagedKafkaEventSourceConfigProperty | cdk.IResolvable | undefined);
    /**
     * The maximum number of records in each batch that Lambda pulls from your stream or queue and sends to your function.
     */
     ...
     * (Kinesis and DynamoDB Streams only) If the function returns an error, split the batch in two and retry.
     */
    get bisectBatchOnFunctionError(): boolean | cdk.IResolvable | undefined;
    /**
     * (Kinesis and DynamoDB Streams only) If the function returns an error, split the batch in two and retry.
     */
    set bisectBatchOnFunctionError(value: boolean | cdk.IResolvable | undefined);
    /**
     * (Kinesis, DynamoDB Streams, Amazon MSK, and self-managed Apache Kafka) A configuration object that specifies the destination of an event after Lambda processes it.
     */
    get destinationConfig(): CfnEventSourceMapping.DestinationConfigProperty | cdk.IResolvable | undefined;
    /**
     * (Kinesis, DynamoDB Streams, Amazon MSK, and self-managed Apache Kafka) A configuration object that specifies the destination of an event after Lambda processes it.
     */
    set destinationConfig(value: CfnEventSourceMapping.DestinationConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specific configuration settings for a DocumentDB event source.
     */
    get documentDbEventSourceConfig(): CfnEventSourceMapping.DocumentDBEventSourceConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specific configuration settings for a DocumentDB event source.
     */
    set documentDbEventSourceConfig(value: CfnEventSourceMapping.DocumentDBEventSourceConfigProperty | cdk.IResolvable | undefined);
    /**
     * When true, the event source mapping is active. When false, Lambda pauses polling and invocation.
     */
     ...
     * The Amazon Resource Name (ARN) of the event source.
     */
    get eventSourceArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the event source.
     */
    set eventSourceArn(value: string | undefined);
    /**
     * An object that defines the filter criteria that determine whether Lambda should process an event.
     */
    get filterCriteria(): CfnEventSourceMapping.FilterCriteriaProperty | cdk.IResolvable | undefined;
    /**
     * An object that defines the filter criteria that determine whether Lambda should process an event.
     */
    set filterCriteria(value: CfnEventSourceMapping.FilterCriteriaProperty | cdk.IResolvable | undefined);
    /**
     * The name or ARN of the Lambda function.
     */
    get functionName(): string;
     ...
     * (Kinesis, DynamoDB Streams, and SQS) A list of current response type enums applied to the event source mapping.
     */
    get functionResponseTypes(): Array<string> | undefined;
    /**
     * (Kinesis, DynamoDB Streams, and SQS) A list of current response type enums applied to the event source mapping.
     */
    set functionResponseTypes(value: Array<string> | undefined);
    /**
     * The ARN of the AWS Key Management Service ( AWS  ) customer managed key that Lambda uses to encrypt your function's [filter criteria](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html#filtering-basics) .
     */
     ...
     * The function's Amazon CloudWatch Logs configuration settings.
     */
    get loggingConfig(): cdk.IResolvable | CfnEventSourceMapping.LoggingConfigProperty | undefined;
    /**
     * The function's Amazon CloudWatch Logs configuration settings.
     */
    set loggingConfig(value: cdk.IResolvable | CfnEventSourceMapping.LoggingConfigProperty | undefined);
    /**
     * The maximum amount of time, in seconds, that Lambda spends gathering records before invoking the function.
     */
     ...
     * The metrics configuration for your event source.
     */
    get metricsConfig(): cdk.IResolvable | CfnEventSourceMapping.MetricsConfigProperty | undefined;
    /**
     * The metrics configuration for your event source.
     */
    set metricsConfig(value: cdk.IResolvable | CfnEventSourceMapping.MetricsConfigProperty | undefined);
    /**
     * (Kinesis and DynamoDB Streams only) The number of batches to process concurrently from each shard.
     */
     ...
     * (Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source.
     */
    get provisionedPollerConfig(): cdk.IResolvable | CfnEventSourceMapping.ProvisionedPollerConfigProperty | undefined;
    /**
     * (Amazon SQS, Amazon MSK, and self-managed Apache Kafka only) The provisioned mode configuration for the event source.
     */
    set provisionedPollerConfig(value: cdk.IResolvable | CfnEventSourceMapping.ProvisionedPollerConfigProperty | undefined);
    /**
     * (Amazon MQ) The name of the Amazon MQ broker destination queue to consume.
     */
    get queues(): Array<string> | undefined;
    /**
     * (Amazon MQ) The name of the Amazon MQ broker destination queue to consume.
     */
    set queues(value: Array<string> | undefined);
    /**
     * This property is for Amazon SQS event sources only.
     */
    get scalingConfig(): cdk.IResolvable | CfnEventSourceMapping.ScalingConfigProperty | undefined;
    /**
     * This property is for Amazon SQS event sources only.
     */
    set scalingConfig(value: cdk.IResolvable | CfnEventSourceMapping.ScalingConfigProperty | undefined);
    /**
     * The self-managed Apache Kafka cluster for your event source.
     */
    get selfManagedEventSource(): cdk.IResolvable | CfnEventSourceMapping.SelfManagedEventSourceProperty | undefined;
    /**
     * The self-managed Apache Kafka cluster for your event source.
     */
    set selfManagedEventSource(value: cdk.IResolvable | CfnEventSourceMapping.SelfManagedEventSourceProperty | undefined);
    /**
     * Specific configuration settings for a self-managed Apache Kafka event source.
     */
    get selfManagedKafkaEventSourceConfig(): cdk.IResolvable | CfnEventSourceMapping.SelfManagedKafkaEventSourceConfigProperty | undefined;
    /**
     * Specific configuration settings for a self-managed Apache Kafka event source.
     */
    set selfManagedKafkaEventSourceConfig(value: cdk.IResolvable | CfnEventSourceMapping.SelfManagedKafkaEventSourceConfigProperty | undefined);
    /**
     * An array of the authentication protocol, VPC components, or virtual host to secure and define your event source.
     */
    get sourceAccessConfigurations(): Array<cdk.IResolvable | CfnEventSourceMapping.SourceAccessConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * An array of the authentication protocol, VPC components, or virtual host to secure and define your event source.
     */
    set sourceAccessConfigurations(value: Array<cdk.IResolvable | CfnEventSourceMapping.SourceAccessConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The position in a stream from which to start reading. Required for Amazon Kinesis and Amazon DynamoDB.
     */
     ...
     * With `StartingPosition` set to `AT_TIMESTAMP` , the time from which to start reading, in Unix time seconds.
     */
    get startingPositionTimestamp(): number | undefined;
    /**
     * With `StartingPosition` set to `AT_TIMESTAMP` , the time from which to start reading, in Unix time seconds.
     */
    set startingPositionTimestamp(value: number | undefined);
    /**
     * A list of tags to add to the event source mapping.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * (Kinesis and DynamoDB Streams only) The duration in seconds of a processing window for DynamoDB and Kinesis Streams event sources.
     */
    get tumblingWindowInSeconds(): number | undefined;
    /**
     * (Kinesis and DynamoDB Streams only) The duration in seconds of a processing window for DynamoDB and Kinesis Streams event sources.
     */
    set tumblingWindowInSeconds(value: number | undefined);
    /**
     * The Amazon Resource Name (ARN) of the event source mapping.
     *
     * @cloudformationAttribute EventSourceMappingArn
     */
    get attrEventSourceMappingArn(): string;
    /**
...
export interface CfnEventSourceMappingProps {
     ...
     */
    readonly eventSourceArn?: kinesisRefs.IStreamRef | mskRefs.IClusterRef | sqsRefs.IQueueRef | string;
    /**
     * An object that defines the filter criteria that determine whether Lambda should process an event.
     *
     ...
     */
    readonly functionName: lambdaRefs.IFunctionRef | lambdaRefs.IVersionRef | string;
    /**
     * (Kinesis, DynamoDB Streams, and SQS) A list of current response type enums applied to the event source mapping.
     *
     ...
     */
    readonly loggingConfig?: cdk.IResolvable | CfnEventSourceMapping.LoggingConfigProperty;
    /**
     * The maximum amount of time, in seconds, that Lambda spends gathering records before invoking the function.
     *
...
export declare class CfnFunction extends cdk.CfnResource implements cdk.IInspectable, IFunctionRef, cdk.ITaggable {
     ...
     */
    static fromFunctionArn(scope: constructs.Construct, id: string, arn: string): IFunctionRef;
    /**
     * Creates a new IFunctionRef from a functionName
     */
    static fromFunctionName(scope: constructs.Construct, id: string, functionName: string): IFunctionRef;
    ...
    private _publishToLatestPublished?;
    /**
     ...
     */
    private _runtimeManagementConfig?;
    /**
     ...
     * The instruction set architecture that the function supports.
     */
    get architectures(): Array<string> | undefined;
    /**
     * The instruction set architecture that the function supports.
     */
    set architectures(value: Array<string> | undefined);
    /**
     * Configuration for the capacity provider that manages compute resources for Lambda functions.
     */
    get capacityProviderConfig(): CfnFunction.CapacityProviderConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration for the capacity provider that manages compute resources for Lambda functions.
     */
    set capacityProviderConfig(value: CfnFunction.CapacityProviderConfigProperty | cdk.IResolvable | undefined);
    /**
     * The code for the function. You can define your function code in multiple ways:.
     */
    get code(): CfnFunction.CodeProperty | cdk.IResolvable;
    /**
     * The code for the function. You can define your function code in multiple ways:.
     */
    set code(value: CfnFunction.CodeProperty | cdk.IResolvable);
    /**
     * To enable code signing for this function, specify the ARN of a code-signing configuration.
     */
    get codeSigningConfigArn(): string | undefined;
    /**
     * To enable code signing for this function, specify the ARN of a code-signing configuration.
     */
    set codeSigningConfigArn(value: string | undefined);
    /**
     * A dead-letter queue configuration that specifies the queue or topic where Lambda sends asynchronous events when they fail processing.
     */
    get deadLetterConfig(): CfnFunction.DeadLetterConfigProperty | cdk.IResolvable | undefined;
    /**
     * A dead-letter queue configuration that specifies the queue or topic where Lambda sends asynchronous events when they fail processing.
     */
    set deadLetterConfig(value: CfnFunction.DeadLetterConfigProperty | cdk.IResolvable | undefined);
    /**
     * A description of the function.
     */
    get description(): string | undefined;
     ...
     * Configuration settings for [durable functions](https://docs.aws.amazon.com/lambda/latest/dg/durable-functions.html) , including execution timeout and retention period for execution history.
     */
    get durableConfig(): CfnFunction.DurableConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration settings for [durable functions](https://docs.aws.amazon.com/lambda/latest/dg/durable-functions.html) , including execution timeout and retention period for execution history.
     */
    set durableConfig(value: CfnFunction.DurableConfigProperty | cdk.IResolvable | undefined);
    /**
     * Environment variables that are accessible from function code during execution.
     */
    get environment(): CfnFunction.EnvironmentProperty | cdk.IResolvable | undefined;
    /**
     * Environment variables that are accessible from function code during execution.
     */
    set environment(value: CfnFunction.EnvironmentProperty | cdk.IResolvable | undefined);
    /**
     * The size of the function's `/tmp` directory in MB.
     */
    get ephemeralStorage(): CfnFunction.EphemeralStorageProperty | cdk.IResolvable | undefined;
    /**
     * The size of the function's `/tmp` directory in MB.
     */
    set ephemeralStorage(value: CfnFunction.EphemeralStorageProperty | cdk.IResolvable | undefined);
    /**
     * Connection settings for an Amazon EFS file system.
     */
    get fileSystemConfigs(): Array<CfnFunction.FileSystemConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Connection settings for an Amazon EFS file system.
     */
    set fileSystemConfigs(value: Array<CfnFunction.FileSystemConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the Lambda function, up to 64 characters in length.
     */
     ...
     * The name of the Lambda function, up to 64 characters in length.
     */
    set functionName(value: string | undefined);
    /**
     * Configuration that defines the scaling behavior for a Lambda Managed Instances function, including the minimum and maximum number of execution environments that can be provisioned.
     */
    get functionScalingConfig(): CfnFunction.FunctionScalingConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration that defines the scaling behavior for a Lambda Managed Instances function, including the minimum and maximum number of execution environments that can be provisioned.
     */
    set functionScalingConfig(value: CfnFunction.FunctionScalingConfigProperty | cdk.IResolvable | undefined);
    /**
     * The name of the method within your code that Lambda calls to run your function.
     */
     ...
     * Configuration values that override the container image Dockerfile settings.
     */
    get imageConfig(): CfnFunction.ImageConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration values that override the container image Dockerfile settings.
     */
    set imageConfig(value: CfnFunction.ImageConfigProperty | cdk.IResolvable | undefined);
    /**
     * The ARN of the AWS Key Management Service ( AWS  ) customer managed key that's used to encrypt the following resources:.
     */
    get kmsKeyArn(): string | undefined;
     ...
     * A list of [function layers](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html) to add to the function's execution environment. Specify each layer by its ARN, including the version.
     */
    get layers(): Array<string> | undefined;
    /**
     * A list of [function layers](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html) to add to the function's execution environment. Specify each layer by its ARN, including the version.
     */
    set layers(value: Array<string> | undefined);
    /**
     * The function's Amazon CloudWatch Logs configuration settings.
     */
    get loggingConfig(): cdk.IResolvable | CfnFunction.LoggingConfigProperty | undefined;
    /**
     * The function's Amazon CloudWatch Logs configuration settings.
     */
    set loggingConfig(value: cdk.IResolvable | CfnFunction.LoggingConfigProperty | undefined);
    /**
     * The amount of [memory available to the function](https://docs.aws.amazon.com/lambda/latest/dg/configuration-function-common.html#configuration-memory-console) at runtime. Increasing the function memory also increases its CPU allocation. The default value is 128 MB. The value can be any multiple of 1 MB. Note that new AWS accounts have reduced concurrency and memory quotas. AWS raises these quotas automatically based on your usage. You can also request a quota increase.
     */
     ...
     * The type of deployment package.
     */
    get packageType(): string | undefined;
    /**
     * The type of deployment package.
     */
    set packageType(value: string | undefined);
    get publishToLatestPublished(): boolean | cdk.IResolvable | undefined;
    set publishToLatestPublished(value: boolean | cdk.IResolvable | undefined);
    /**
     * The status of your function's recursive loop detection configuration.
     */
    get recursiveLoop(): string | undefined;
    /**
     * The status of your function's recursive loop detection configuration.
     */
    set recursiveLoop(value: string | undefined);
    /**
     * The number of simultaneous executions to reserve for the function.
     */
     ...
     * The identifier of the function's [runtime](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html) . Runtime is required if the deployment package is a .zip file archive. Specifying a runtime results in an error if you're deploying a function using a container image.
     */
    set runtime(value: string | undefined);
    /**
     * Sets the runtime management configuration for a function's version.
     */
    get runtimeManagementConfig(): cdk.IResolvable | CfnFunction.RuntimeManagementConfigProperty | undefined;
    /**
     * Sets the runtime management configuration for a function's version.
     */
    set runtimeManagementConfig(value: cdk.IResolvable | CfnFunction.RuntimeManagementConfigProperty | undefined);
    /**
     * The function's [AWS Lambda SnapStart](https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html) setting.
     */
    get snapStart(): cdk.IResolvable | CfnFunction.SnapStartProperty | undefined;
    /**
     * The function's [AWS Lambda SnapStart](https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html) setting.
     */
    set snapStart(value: cdk.IResolvable | CfnFunction.SnapStartProperty | undefined);
    /**
     * A list of [tags](https://docs.aws.amazon.com/lambda/latest/dg/tagging.html) to apply to the function.
     */
     ...
     * The function's tenant isolation configuration settings.
     */
    get tenancyConfig(): cdk.IResolvable | CfnFunction.TenancyConfigProperty | undefined;
    /**
     * The function's tenant isolation configuration settings.
     */
    set tenancyConfig(value: cdk.IResolvable | CfnFunction.TenancyConfigProperty | undefined);
    /**
     * The amount of time (in seconds) that Lambda allows a function to run before stopping it.
     */
     ...
     * Set `Mode` to `Active` to sample and trace a subset of incoming requests with [X-Ray](https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html) .
     */
    get tracingConfig(): cdk.IResolvable | CfnFunction.TracingConfigProperty | undefined;
    /**
     * Set `Mode` to `Active` to sample and trace a subset of incoming requests with [X-Ray](https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html) .
     */
    set tracingConfig(value: cdk.IResolvable | CfnFunction.TracingConfigProperty | undefined);
    /**
     * For network connectivity to AWS resources in a VPC, specify a list of security groups and subnets in the VPC.
     */
    get vpcConfig(): cdk.IResolvable | CfnFunction.VpcConfigProperty | undefined;
    /**
     * For network connectivity to AWS resources in a VPC, specify a list of security groups and subnets in the VPC.
     */
    set vpcConfig(value: cdk.IResolvable | CfnFunction.VpcConfigProperty | undefined);
    /**
...
export declare namespace CfnFunction {
    ...
    interface CapacityProviderConfigProperty {
         ...
         */
        readonly lambdaManagedInstancesCapacityProviderConfig: cdk.IResolvable | CfnFunction.LambdaManagedInstancesCapacityProviderConfigProperty;
    }
    /**
     * Configuration for Lambda-managed instances used by the capacity provider.
     *
...
export interface CfnFunctionProps {
     ...
     */
    readonly capacityProviderConfig?: CfnFunction.CapacityProviderConfigProperty | cdk.IResolvable;
    /**
     * The code for the function. You can define your function code in multiple ways:.
     *
     ...
     */
    readonly codeSigningConfigArn?: lambdaRefs.ICodeSigningConfigRef | string;
    /**
     * A dead-letter queue configuration that specifies the queue or topic where Lambda sends asynchronous events when they fail processing.
     *
     ...
     */
    readonly durableConfig?: CfnFunction.DurableConfigProperty | cdk.IResolvable;
    /**
     * Environment variables that are accessible from function code during execution.
     *
     ...
     */
    readonly functionScalingConfig?: CfnFunction.FunctionScalingConfigProperty | cdk.IResolvable;
    /**
     * The name of the method within your code that Lambda calls to run your function.
     *
     ...
     */
    readonly layers?: Array<lambdaRefs.ILayerVersionRef | string>;
    /**
     * The function's Amazon CloudWatch Logs configuration settings.
     *
     ...
     */
    readonly publishToLatestPublished?: boolean | cdk.IResolvable;
    /**
     * The status of your function's recursive loop detection configuration.
     *
     ...
     */
    readonly tenancyConfig?: cdk.IResolvable | CfnFunction.TenancyConfigProperty;
    /**
     * The amount of time (in seconds) that Lambda allows a function to run before stopping it.
     *
...
export declare class CfnLayerVersion extends cdk.CfnResource implements cdk.IInspectable, ILayerVersionRef {
     ...
     */
    static isCfnLayerVersion(x: any): x is CfnLayerVersion;
    static arnForLayerVersion(resource: ILayerVersionRef): string;
    /**
     ...
     * A list of compatible [instruction set architectures](https://docs.aws.amazon.com/lambda/latest/dg/foundation-arch.html) .
     */
    get compatibleArchitectures(): Array<string> | undefined;
    /**
     * A list of compatible [instruction set architectures](https://docs.aws.amazon.com/lambda/latest/dg/foundation-arch.html) .
     */
    set compatibleArchitectures(value: Array<string> | undefined);
    /**
     * A list of compatible [function runtimes](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html) . Used for filtering with [ListLayers](https://docs.aws.amazon.com/lambda/latest/dg/API_ListLayers.html) and [ListLayerVersions](https://docs.aws.amazon.com/lambda/latest/dg/API_ListLayerVersions.html) .
     */
    get compatibleRuntimes(): Array<string> | undefined;
    /**
     * A list of compatible [function runtimes](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html) . Used for filtering with [ListLayers](https://docs.aws.amazon.com/lambda/latest/dg/API_ListLayers.html) and [ListLayerVersions](https://docs.aws.amazon.com/lambda/latest/dg/API_ListLayerVersions.html) .
     */
    set compatibleRuntimes(value: Array<string> | undefined);
    /**
     * The function layer archive.
     */
    get content(): CfnLayerVersion.ContentProperty | cdk.IResolvable;
    /**
     * The function layer archive.
     */
    set content(value: CfnLayerVersion.ContentProperty | cdk.IResolvable);
    /**
     * The description of the version.
     */
    get description(): string | undefined;
     ...
     */
    get attrLayerVersionArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnLayerVersionPermission extends cdk.CfnResource implements cdk.IInspectable, ILayerVersionPermissionRef {
     ...
     */
    static isCfnLayerVersionPermission(x: any): x is CfnLayerVersionPermission;
    /**
...
export interface CfnLayerVersionPermissionProps {
     ...
     */
    readonly layerVersionArn: lambdaRefs.ILayerVersionRef | string;
    /**
     * With the principal set to `*` , grant permission to all accounts in the specified organization.
     *
...
export declare class CfnPermission extends cdk.CfnResource implements cdk.IInspectable, IPermissionRef {
     ...
     */
    private _invokedViaFunctionUrl?;
    /**
     ...
     * The type of authentication that your function URL uses.
     */
    get functionUrlAuthType(): string | undefined;
    /**
     * The type of authentication that your function URL uses.
     */
    set functionUrlAuthType(value: string | undefined);
    /**
     * Indicates whether the permission applies when the function is invoked through a function URL.
     */
    get invokedViaFunctionUrl(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the permission applies when the function is invoked through a function URL.
     */
    set invokedViaFunctionUrl(value: boolean | cdk.IResolvable | undefined);
    /**
     * The AWS service , AWS account , IAM user, or IAM role that invokes the function.
     */
    get principal(): string;
     ...
     * The identifier for your organization in AWS Organizations .
     */
    get principalOrgId(): string | undefined;
    /**
     * The identifier for your organization in AWS Organizations .
     */
    set principalOrgId(value: string | undefined);
    /**
     * For AWS service , the ID of the AWS account that owns the resource.
     */
...
export interface CfnPermissionProps {
     ...
     */
    readonly invokedViaFunctionUrl?: boolean | cdk.IResolvable;
    /**
     * The AWS service , AWS account , IAM user, or IAM role that invokes the function.
     *
     ...
     */
    readonly principal: iamRefs.IRoleRef | iamRefs.IUserRef | string;
    /**
     * The identifier for your organization in AWS Organizations .
     *
     ...
     */
    readonly sourceArn?: cognitoRefs.IUserPoolRef | eventsRefs.IRuleRef | iamRefs.IRoleRef | ioTRefs.ITopicRuleRef | kinesisFirehoseRefs.IDeliveryStreamRef | lambdaRefs.IFunctionRef | logsRefs.ILogGroupRef | s3Refs.IBucketRef | snsRefs.ITopicRef | sqsRefs.IQueueRef | string;
}
/**
...
export declare class CfnUrl extends cdk.CfnResource implements cdk.IInspectable, IUrlRef {
     ...
     */
    static isCfnUrl(x: any): x is CfnUrl;
    /**
     * The type of authentication that your function URL uses.
     */
    private _authType;
     ...
     * The [Cross-Origin Resource Sharing (CORS)](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) settings for your function URL.
     */
    get cors(): CfnUrl.CorsProperty | cdk.IResolvable | undefined;
    /**
     * The [Cross-Origin Resource Sharing (CORS)](https://docs.aws.amazon.com/https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) settings for your function URL.
     */
    set cors(value: CfnUrl.CorsProperty | cdk.IResolvable | undefined);
    /**
     * Use one of the following options:.
     */
    get invokeMode(): string | undefined;
    /**
     * Use one of the following options:.
     */
    set invokeMode(value: string | undefined);
    /**
     * The alias name.
     */
     ...
     * The name of the Lambda function.
     */
    get targetFunctionArn(): string;
    /**
     * The name of the Lambda function.
     */
    set targetFunctionArn(value: string);
    /**
     * The Amazon Resource Name (ARN) of the function.
     *
     * @cloudformationAttribute FunctionArn
     */
    get attrFunctionArn(): string;
    /**
     * The HTTP URL endpoint for your function.
     *
     * @cloudformationAttribute FunctionUrl
     */
    get attrFunctionUrl(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnUrlProps {
     ...
     */
    readonly targetFunctionArn: lambdaRefs.IFunctionRef | string;
}
/**
...
export declare class CfnVersion extends cdk.CfnResource implements cdk.IInspectable, IVersionRef {
     ...
     */
    static isCfnVersion(x: any): x is CfnVersion;
    /**
     ...
     * Only publish a version if the hash value matches the value that's specified.
     */
    get codeSha256(): string | undefined;
    /**
     * Only publish a version if the hash value matches the value that's specified.
     */
    set codeSha256(value: string | undefined);
    /**
     * A description for the version to override the description in the function configuration.
     */
    get description(): string | undefined;
     ...
     * Configuration that defines the scaling behavior for a Lambda Managed Instances function, including the minimum and maximum number of execution environments that can be provisioned.
     */
    get functionScalingConfig(): CfnVersion.FunctionScalingConfigProperty | cdk.IResolvable | undefined;
    /**
     * Configuration that defines the scaling behavior for a Lambda Managed Instances function, including the minimum and maximum number of execution environments that can be provisioned.
     */
    set functionScalingConfig(value: CfnVersion.FunctionScalingConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies a provisioned concurrency configuration for a function's version.
     */
    get provisionedConcurrencyConfig(): cdk.IResolvable | CfnVersion.ProvisionedConcurrencyConfigurationProperty | undefined;
    /**
     * Specifies a provisioned concurrency configuration for a function's version.
     */
    set provisionedConcurrencyConfig(value: cdk.IResolvable | CfnVersion.ProvisionedConcurrencyConfigurationProperty | undefined);
    /**
     * Runtime Management Config of a function.
     */
    get runtimePolicy(): cdk.IResolvable | CfnVersion.RuntimePolicyProperty | undefined;
    /**
     * Runtime Management Config of a function.
     */
    set runtimePolicy(value: cdk.IResolvable | CfnVersion.RuntimePolicyProperty | undefined);
    /**
...
export interface CfnVersionProps {
     ...
     */
    readonly functionScalingConfig?: CfnVersion.FunctionScalingConfigProperty | cdk.IResolvable;
    /**
     * Specifies a provisioned concurrency configuration for a function's version.
     *
     * Updates are not supported for this property.
 ...
 */
export declare class CfnCapacityProvider extends cdk.CfnResource implements cdk.IInspectable, ICapacityProviderRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static fromCapacityProviderArn(scope: constructs.Construct, id: string, arn: string): ICapacityProviderRef;
    /**
    ...
    get capacityProviderName(): string | undefined;
    set capacityProviderName(value: string | undefined);
    /**
     * The scaling configuration for the capacity provider.
     */
    get capacityProviderScalingConfig(): CfnCapacityProvider.CapacityProviderScalingConfigProperty | cdk.IResolvable | undefined;
    /**
     * The scaling configuration for the capacity provider.
     */
    set capacityProviderScalingConfig(value: CfnCapacityProvider.CapacityProviderScalingConfigProperty | cdk.IResolvable | undefined);
    /**
     * The instance requirements for compute resources managed by the capacity provider.
     */
    get instanceRequirements(): CfnCapacityProvider.InstanceRequirementsProperty | cdk.IResolvable | undefined;
    /**
     * The instance requirements for compute resources managed by the capacity provider.
     */
    set instanceRequirements(value: CfnCapacityProvider.InstanceRequirementsProperty | cdk.IResolvable | undefined);
    /**
     * The ARN of the KMS key used to encrypt the capacity provider's resources.
     */
    get kmsKeyArn(): string | undefined;
     ...
     * The permissions configuration for the capacity provider.
     */
    get permissionsConfig(): CfnCapacityProvider.CapacityProviderPermissionsConfigProperty | cdk.IResolvable;
    /**
     * The permissions configuration for the capacity provider.
     */
    set permissionsConfig(value: CfnCapacityProvider.CapacityProviderPermissionsConfigProperty | cdk.IResolvable);
    /**
     * Configuration that defines how tags are propagated to managed resources.
     */
    get propagateTags(): cdk.IResolvable | CfnCapacityProvider.PropagateTagsConfigProperty | undefined;
    /**
     * Configuration that defines how tags are propagated to managed resources.
     */
    set propagateTags(value: cdk.IResolvable | CfnCapacityProvider.PropagateTagsConfigProperty | undefined);
    /**
     * A key-value pair that provides metadata for the capacity provider.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    set tags(value: Array<cdk.CfnTag> | undefined);
    get telemetryConfig(): CfnCapacityProvider.CapacityProviderTelemetryConfigProperty | cdk.IResolvable | undefined;
    set telemetryConfig(value: CfnCapacityProvider.CapacityProviderTelemetryConfigProperty | cdk.IResolvable | undefined);
    /**
     * The VPC configuration for the capacity provider.
     */
    get vpcConfig(): CfnCapacityProvider.CapacityProviderVpcConfigProperty | cdk.IResolvable;
    /**
     * The VPC configuration for the capacity provider.
     */
    set vpcConfig(value: CfnCapacityProvider.CapacityProviderVpcConfigProperty | cdk.IResolvable);
    /**
     * @cloudformationAttribute Arn
     */
    get attrArn(): string;
...
export declare namespace CfnCapacityProvider {
    ...
    interface CapacityProviderScalingConfigProperty {
         ...
         */
        readonly scalingPolicies?: Array<cdk.IResolvable | CfnCapacityProvider.TargetTrackingScalingPolicyProperty> | cdk.IResolvable;
    }
    /**
     ...
     */
    interface PropagateTagsConfigProperty {
        /**
         ...
         */
        readonly explicitTags?: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable;
        /**
     ...
     */
    interface CapacityProviderTelemetryConfigProperty {
        /**
         ...
         */
        readonly loggingConfig?: CfnCapacityProvider.CapacityProviderLoggingConfigProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface CapacityProviderLoggingConfigProperty {
        /**
...
export interface CfnCapacityProviderProps {
     ...
     */
    readonly capacityProviderScalingConfig?: CfnCapacityProvider.CapacityProviderScalingConfigProperty | cdk.IResolvable;
    /**
     * The instance requirements for compute resources managed by the capacity provider.
     *
     ...
     */
    readonly instanceRequirements?: CfnCapacityProvider.InstanceRequirementsProperty | cdk.IResolvable;
    /**
     * The ARN of the KMS key used to encrypt the capacity provider's resources.
     *
     ...
     */
    readonly permissionsConfig: CfnCapacityProvider.CapacityProviderPermissionsConfigProperty | cdk.IResolvable;
    /**
     * Configuration that defines how tags are propagated to managed resources.
     *
     ...
     */
    readonly propagateTags?: cdk.IResolvable | CfnCapacityProvider.PropagateTagsConfigProperty;
    /**
     * A key-value pair that provides metadata for the capacity provider.
     *
     ...
     */
    readonly telemetryConfig?: CfnCapacityProvider.CapacityProviderTelemetryConfigProperty | cdk.IResolvable;
    /**
     * The VPC configuration for the capacity provider.
     *
     ...
     */
    readonly vpcConfig: CfnCapacityProvider.CapacityProviderVpcConfigProperty | cdk.IResolvable;
}
/**
 ...
 */
export declare class CfnMicrovmImage extends cdk.CfnResource implements cdk.IInspectable, IMicrovmImageRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMicrovmImage from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMicrovmImage;
    /**
     * Checks whether the given object is a CfnMicrovmImage
     */
    static isCfnMicrovmImage(x: any): x is CfnMicrovmImage;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnMicrovmImageProps);
    get microvmImageRef(): MicrovmImageReference;
    get additionalOsCapabilities(): Array<string>;
    set additionalOsCapabilities(value: Array<string>);
    /**
     * ARN of the base MicroVM image.
     */
    ...
    get codeArtifact(): CfnMicrovmImage.CodeArtifactProperty | cdk.IResolvable;
    set codeArtifact(value: CfnMicrovmImage.CodeArtifactProperty | cdk.IResolvable);
    get cpuConfigurations(): Array<CfnMicrovmImage.CpuConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    set cpuConfigurations(value: Array<CfnMicrovmImage.CpuConfigurationProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Human-readable description of the MicroVM image and its purpose.
     */
    ...
    get egressNetworkConnectors(): Array<string>;
    set egressNetworkConnectors(value: Array<string>);
    /**
     * Environment variables to set in the container during the snapshot build.
     */
    get environmentVariables(): Array<CfnMicrovmImage.EnvironmentVariableProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Environment variables to set in the container during the snapshot build.
     */
    set environmentVariables(value: Array<CfnMicrovmImage.EnvironmentVariableProperty | cdk.IResolvable> | cdk.IResolvable);
    get hooks(): CfnMicrovmImage.HooksProperty | cdk.IResolvable;
    set hooks(value: CfnMicrovmImage.HooksProperty | cdk.IResolvable);
    get logging(): cdk.IResolvable | CfnMicrovmImage.LoggingProperty;
    set logging(value: cdk.IResolvable | CfnMicrovmImage.LoggingProperty);
    /**
     * Unique name for the MicroVM image within the account.
     */
    get name(): string;
     ...
     */
    set name(value: string);
    get resources(): Array<cdk.IResolvable | CfnMicrovmImage.ResourcesProperty> | cdk.IResolvable;
    set resources(value: Array<cdk.IResolvable | CfnMicrovmImage.ResourcesProperty> | cdk.IResolvable);
    /**
     * Key-value pairs to associate with the MicroVM image for organization and management.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnMicrovmImage {
    /**
     * @struct
     * @stability external
     ...
     */
    interface MicrovmImageHooksProperty {
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lambda-microvmimage.html
 */
export interface CfnMicrovmImageProps {
    /**
 ...
 */
export declare class CfnNetworkConnector extends cdk.CfnResource implements cdk.IInspectable, INetworkConnectorRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnNetworkConnector from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnNetworkConnector;
    /**
     * Checks whether the given object is a CfnNetworkConnector
     */
    static isCfnNetworkConnector(x: any): x is CfnNetworkConnector;
    static arnForNetworkConnector(resource: INetworkConnectorRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnNetworkConnectorProps);
    get networkConnectorRef(): NetworkConnectorReference;
    /**
     * The network configuration for the connector.
     */
    get configuration(): CfnNetworkConnector.ConfigProperty | cdk.IResolvable;
    /**
     * The network configuration for the connector.
     */
    set configuration(value: CfnNetworkConnector.ConfigProperty | cdk.IResolvable);
    /**
     * A unique name for the network connector within your account and Region.
     */
     ...
     * The ARN of the IAM role that Lambda assumes to manage elastic network interfaces in your VPC.
     */
    get operatorRole(): string | undefined;
    /**
     * The ARN of the IAM role that Lambda assumes to manage elastic network interfaces in your VPC.
     */
    set operatorRole(value: string | undefined);
    /**
     * A list of tags to apply to the network connector.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnNetworkConnector {
    /**
     * The network configuration for the connector.
     *
    ...
    interface ConfigProperty {
         ...
         */
        readonly vpcEgressConfiguration: cdk.IResolvable | CfnNetworkConnector.VpcEgressConfigurationProperty;
    }
    /**
     * The VPC egress configuration for the network connector.
     *
    ...
    interface VpcEgressConfigurationProperty {
         ...
         */
        readonly associatedComputeResourceTypes: Array<string>;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lambda-networkconnector.html
 */
export interface CfnNetworkConnectorProps {
    /**
     * The network configuration for the connector.
     *
     * Specify a VpcEgressConfiguration to enable outbound traffic routing through your VPC.
     ...
     */
    readonly configuration: CfnNetworkConnector.ConfigProperty | cdk.IResolvable;
    /**
     * A unique name for the network connector within your account and Region.
     *
...
export type { ICodeSigningConfigRef, CodeSigningConfigReference };
export type { IEventInvokeConfigRef, EventInvokeConfigReference };
export type { IEventSourceMappingRef, EventSourceMappingReference };
export type { IFunctionRef, FunctionReference };
export type { ILayerVersionRef, LayerVersionReference };
export type { ILayerVersionPermissionRef, LayerVersionPermissionReference };
export type { IPermissionRef, PermissionReference };
export type { IUrlRef, UrlReference };
export type { IVersionRef, VersionReference };
export type { ICapacityProviderRef, CapacityProviderReference };
export type { IMicrovmImageRef, MicrovmImageReference };
export type { INetworkConnectorRef, NetworkConnectorReference };
