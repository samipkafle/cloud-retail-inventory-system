...
import { DataDeletionJobReference, DatasetGroupReference, DatasetReference, IDataDeletionJobRef, IDatasetGroupRef, IDatasetRef, ISchemaRef, ISolutionRef, SchemaReference, SolutionReference } from "../../interfaces/generated/aws-personalize-interfaces.generated";
/**
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef {
     ...
     */
    private _datasetGroupArn;
    /**
     * Describes a job that imports training data from a data source (Amazon S3 bucket) to an Amazon Personalize dataset.
     */
    private _datasetImportJob?;
    /**
     ...
     * The Amazon Resource Name (ARN) of the dataset group.
     */
    get datasetGroupArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the dataset group.
     */
    set datasetGroupArn(value: string);
    /**
     * Describes a job that imports training data from a data source (Amazon S3 bucket) to an Amazon Personalize dataset.
     */
    get datasetImportJob(): CfnDataset.DatasetImportJobProperty | cdk.IResolvable | undefined;
    /**
     * Describes a job that imports training data from a data source (Amazon S3 bucket) to an Amazon Personalize dataset.
     */
    set datasetImportJob(value: CfnDataset.DatasetImportJobProperty | cdk.IResolvable | undefined);
    /**
     * One of the following values:.
     */
...
export declare class CfnSolution extends cdk.CfnResource implements cdk.IInspectable, ISolutionRef {
     ...
     */
    static isCfnSolution(x: any): x is CfnSolution;
    static arnForSolution(resource: ISolutionRef): string;
    /**
     ...
     * The event type (for example, 'click' or 'like') that is used for training the model.
     */
    set eventType(value: string | undefined);
    /**
     * The name of the solution.
     */
    get name(): string;
     ...
     * > We don't recommend enabling automated machine learning.
     */
    get performAutoMl(): boolean | cdk.IResolvable | undefined;
    /**
     * > We don't recommend enabling automated machine learning.
     */
    set performAutoMl(value: boolean | cdk.IResolvable | undefined);
    /**
     * Whether to perform hyperparameter optimization (HPO) on the chosen recipe.
     */
    get performHpo(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to perform hyperparameter optimization (HPO) on the chosen recipe.
     */
    set performHpo(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARN of the recipe used to create the solution.
     */
    get recipeArn(): string | undefined;
    /**
     * The ARN of the recipe used to create the solution.
     */
    set recipeArn(value: string | undefined);
    /**
     * Describes the configuration properties for the solution.
     */
    get solutionConfig(): cdk.IResolvable | CfnSolution.SolutionConfigProperty | undefined;
    /**
     * Describes the configuration properties for the solution.
     */
    set solutionConfig(value: cdk.IResolvable | CfnSolution.SolutionConfigProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the solution.
     *
     * @cloudformationAttribute SolutionArn
     */
    get attrSolutionArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnDataDeletionJob extends cdk.CfnResource implements cdk.IInspectable, IDataDeletionJobRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDataDeletionJob from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDataDeletionJob;
    /**
     * Checks whether the given object is a CfnDataDeletionJob
     */
    static isCfnDataDeletionJob(x: any): x is CfnDataDeletionJob;
    static arnForDataDeletionJob(resource: IDataDeletionJobRef): string;
    private _datasetGroupArn?;
    private _dataSource?;
    private _jobName?;
    private _roleArn?;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnDataDeletionJobProps);
    get dataDeletionJobRef(): DataDeletionJobReference;
    get datasetGroupArn(): string | undefined;
    set datasetGroupArn(value: string | undefined);
    get dataSource(): CfnDataDeletionJob.DataSourceProperty | cdk.IResolvable | undefined;
    set dataSource(value: CfnDataDeletionJob.DataSourceProperty | cdk.IResolvable | undefined);
    get jobName(): string | undefined;
    set jobName(value: string | undefined);
    get roleArn(): string | undefined;
    set roleArn(value: string | undefined);
    /**
     * @cloudformationAttribute CreationDateTime
     */
    get attrCreationDateTime(): string;
    /**
     * @cloudformationAttribute DataDeletionJobArn
     */
    get attrDataDeletionJobArn(): string;
    /**
     ...
     */
    get attrLastUpdatedDateTime(): string;
    /**
...
export declare namespace CfnDataDeletionJob {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-personalize-datadeletionjob.html
 */
export interface CfnDataDeletionJobProps {
    /**
     ...
     */
    readonly dataSource?: CfnDataDeletionJob.DataSourceProperty | cdk.IResolvable;
    /**
...
export type { ISolutionRef, SolutionReference };
export type { IDataDeletionJobRef, DataDeletionJobReference };
