...
import { AccountReference, AcmeDomainValidationReference, AcmeEndpointReference, AcmeExternalAccountBindingReference, CertificateReference, IAccountRef, IAcmeDomainValidationRef, IAcmeEndpointRef, IAcmeExternalAccountBindingRef, ICertificateRef } from "../../interfaces/generated/aws-certificatemanager-interfaces.generated";
/**
 ...
 */
export declare class CfnAcmeDomainValidation extends cdk.CfnResource implements cdk.IInspectable, IAcmeDomainValidationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAcmeDomainValidation from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAcmeDomainValidation;
    /**
     * Checks whether the given object is a CfnAcmeDomainValidation
     */
    static isCfnAcmeDomainValidation(x: any): x is CfnAcmeDomainValidation;
    static arnForAcmeDomainValidation(resource: IAcmeDomainValidationRef): string;
    /**
     * The ARN of the ACME endpoint this domain validation is associated with.
     */
    private _acmeEndpointArn;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAcmeDomainValidationProps);
    get acmeDomainValidationRef(): AcmeDomainValidationReference;
    /**
     * The ARN of the ACME endpoint this domain validation is associated with.
     */
    get acmeEndpointArn(): string;
    /**
     * The ARN of the ACME endpoint this domain validation is associated with.
     */
    set acmeEndpointArn(value: string);
    /**
     * The domain name to validate.
     */
    get domainName(): string;
     ...
     * Prevalidation method configuration.
     */
    get prevalidationOptions(): cdk.IResolvable | CfnAcmeDomainValidation.PrevalidationOptionsProperty;
    /**
     * Prevalidation method configuration.
     */
    set prevalidationOptions(value: cdk.IResolvable | CfnAcmeDomainValidation.PrevalidationOptionsProperty);
    /**
     * Tags associated with the domain validation.
     */
    get tags(): Array<CfnAcmeDomainValidation.TagsItemsProperty> | undefined;
    /**
     * Tags associated with the domain validation.
     */
    set tags(value: Array<CfnAcmeDomainValidation.TagsItemsProperty> | undefined);
    /**
...
export declare namespace CfnAcmeDomainValidation {
    /**
     * Prevalidation method configuration.
     *
     ...
     */
    interface PrevalidationOptionsProperty {
        /**
         ...
         */
        readonly dnsPrevalidation: CfnAcmeDomainValidation.DnsPrevalidationOptionsProperty | cdk.IResolvable;
    }
    /**
     * DNS-based prevalidation options for the domain validation.
     *
     ...
     */
    interface DnsPrevalidationOptionsProperty {
        /**
         ...
         */
        readonly domainScope?: CfnAcmeDomainValidation.DomainScopeProperty | cdk.IResolvable;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-certificatemanager-acmedomainvalidation.html
 */
export interface CfnAcmeDomainValidationProps {
    /**
     * The ARN of the ACME endpoint this domain validation is associated with.
     *
     ...
     */
    readonly prevalidationOptions: cdk.IResolvable | CfnAcmeDomainValidation.PrevalidationOptionsProperty;
    /**
     * Tags associated with the domain validation.
     *
     ...
     */
    readonly tags?: Array<CfnAcmeDomainValidation.TagsItemsProperty>;
}
/**
 ...
 */
export declare class CfnAcmeEndpoint extends cdk.CfnResource implements cdk.IInspectable, IAcmeEndpointRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAcmeEndpoint from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAcmeEndpoint;
    /**
     * Checks whether the given object is a CfnAcmeEndpoint
     */
    static isCfnAcmeEndpoint(x: any): x is CfnAcmeEndpoint;
    static arnForAcmeEndpoint(resource: IAcmeEndpointRef): string;
    /**
     * The authorization behavior for the ACME endpoint.
     */
    private _authorizationBehavior;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAcmeEndpointProps);
    get acmeEndpointRef(): AcmeEndpointReference;
    /**
     * The authorization behavior for the ACME endpoint.
     */
    get authorizationBehavior(): string;
    /**
     * The authorization behavior for the ACME endpoint.
     */
    set authorizationBehavior(value: string);
    /**
     * The certificate authority configuration for the ACME endpoint.
     */
    get certificateAuthority(): CfnAcmeEndpoint.CertificateAuthorityProperty | cdk.IResolvable;
    /**
     * The certificate authority configuration for the ACME endpoint.
     */
    set certificateAuthority(value: CfnAcmeEndpoint.CertificateAuthorityProperty | cdk.IResolvable);
    /**
     * Tags applied to certificates issued via this endpoint.
     */
    get certificateTags(): Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Tags applied to certificates issued via this endpoint.
     */
    set certificateTags(value: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Whether contact information is required for the ACME endpoint.
     */
     ...
     * Tags associated with the ACME endpoint.
     */
    get tags(): Array<CfnAcmeEndpoint.TagsItemsProperty> | undefined;
    /**
     * Tags associated with the ACME endpoint.
     */
    set tags(value: Array<CfnAcmeEndpoint.TagsItemsProperty> | undefined);
    /**
     * The Amazon Resource Name (ARN) of the ACME endpoint.
     *
     * @cloudformationAttribute AcmeEndpointArn
     */
    get attrAcmeEndpointArn(): string;
    /**
     * The ACME directory URL for the endpoint.
     *
     * @cloudformationAttribute EndpointUrl
     */
    get attrEndpointUrl(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnAcmeEndpoint {
    /**
     * The certificate authority configuration for the ACME endpoint.
     *
     * @struct
    ...
    interface CertificateAuthorityProperty {
         ...
         */
        readonly publicCertificateAuthority: cdk.IResolvable | CfnAcmeEndpoint.PublicCertificateAuthorityProperty;
    }
    /**
     * Configuration for the public certificate authority.
     *
    ...
    interface PublicCertificateAuthorityProperty {
         ...
         */
        readonly allowedKeyAlgorithms?: Array<string>;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-certificatemanager-acmeendpoint.html
 */
export interface CfnAcmeEndpointProps {
    /**
     * The authorization behavior for the ACME endpoint.
     *
     ...
     */
    readonly certificateAuthority: CfnAcmeEndpoint.CertificateAuthorityProperty | cdk.IResolvable;
    /**
     * Tags applied to certificates issued via this endpoint.
     *
     ...
     */
    readonly certificateTags?: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Whether contact information is required for the ACME endpoint.
     *
     ...
     */
    readonly tags?: Array<CfnAcmeEndpoint.TagsItemsProperty>;
}
/**
 ...
 */
export declare class CfnAcmeExternalAccountBinding extends cdk.CfnResource implements cdk.IInspectable, IAcmeExternalAccountBindingRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAcmeExternalAccountBinding from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAcmeExternalAccountBinding;
    /**
     * Checks whether the given object is a CfnAcmeExternalAccountBinding
     */
    static isCfnAcmeExternalAccountBinding(x: any): x is CfnAcmeExternalAccountBinding;
    static arnForAcmeExternalAccountBinding(resource: IAcmeExternalAccountBindingRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAcmeExternalAccountBindingProps);
    get acmeExternalAccountBindingRef(): AcmeExternalAccountBindingReference;
    /**
     * The ARN of the ACME endpoint this binding is associated with.
     */
    get acmeEndpointArn(): string;
     ...
     * The expiration configuration for the external account binding.
     */
    get expiration(): CfnAcmeExternalAccountBinding.ExpirationProperty | cdk.IResolvable | undefined;
    /**
     * The expiration configuration for the external account binding.
     */
    set expiration(value: CfnAcmeExternalAccountBinding.ExpirationProperty | cdk.IResolvable | undefined);
    /**
     * The IAM role ARN for cross-account access.
     */
    get roleArn(): string;
     ...
     * Tags associated with the external account binding.
     */
    get tags(): Array<CfnAcmeExternalAccountBinding.TagsItemsProperty> | undefined;
    /**
     * Tags associated with the external account binding.
     */
    set tags(value: Array<CfnAcmeExternalAccountBinding.TagsItemsProperty> | undefined);
    /**
     * The Amazon Resource Name (ARN) of the external account binding.
     *
     * @cloudformationAttribute AcmeExternalAccountBindingArn
     */
    get attrAcmeExternalAccountBindingArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnAcmeExternalAccountBinding {
    /**
     * The expiration configuration for the external account binding.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-certificatemanager-acmeexternalaccountbinding.html
 */
export interface CfnAcmeExternalAccountBindingProps {
    /**
     * The ARN of the ACME endpoint this binding is associated with.
     *
     ...
     */
    readonly expiration?: CfnAcmeExternalAccountBinding.ExpirationProperty | cdk.IResolvable;
    /**
     * The IAM role ARN for cross-account access.
     *
     ...
     */
    readonly tags?: Array<CfnAcmeExternalAccountBinding.TagsItemsProperty>;
}
export type { IAccountRef, AccountReference };
export type { ICertificateRef, CertificateReference };
export type { IAcmeDomainValidationRef, AcmeDomainValidationReference };
export type { IAcmeEndpointRef, AcmeEndpointReference };
export type { IAcmeExternalAccountBindingRef, AcmeExternalAccountBindingReference };
