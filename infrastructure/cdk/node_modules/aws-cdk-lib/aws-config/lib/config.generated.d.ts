...
import { AggregationAuthorizationReference, ConfigRuleReference, ConfigurationAggregatorReference, ConfigurationRecorderReference, ConformancePackReference, ConnectorReference, DeliveryChannelReference, IAggregationAuthorizationRef, IConfigRuleRef, IConfigurationAggregatorRef, IConfigurationRecorderRef, IConformancePackRef, IConnectorRef, IDeliveryChannelRef, IOrganizationConfigRuleRef, IOrganizationConformancePackRef, IRemediationConfigurationRef, IStoredQueryRef, OrganizationConfigRuleReference, OrganizationConformancePackReference, RemediationConfigurationReference, StoredQueryReference } from "../../interfaces/generated/aws-config-interfaces.generated";
...
export declare class CfnAggregationAuthorization extends cdk.CfnResource implements cdk.IInspectable, IAggregationAuthorizationRef, cdk.ITaggable {
     ...
     */
    static isCfnAggregationAuthorization(x: any): x is CfnAggregationAuthorization;
    static arnForAggregationAuthorization(resource: IAggregationAuthorizationRef): string;
    /**
     ...
     */
    get attrAggregationAuthorizationArn(): string;
...
export declare class CfnConfigRule extends cdk.CfnResource implements cdk.IInspectable, IConfigRuleRef {
     ...
     */
    static isCfnConfigRule(x: any): x is CfnConfigRule;
    static arnForConfigRule(resource: IConfigRuleRef): string;
    /**
     ...
     * Indicates whether an AWS resource or AWS Config rule is compliant and provides the number of contributors that affect the compliance.
     */
    get compliance(): CfnConfigRule.ComplianceProperty | cdk.IResolvable | undefined;
    /**
     * Indicates whether an AWS resource or AWS Config rule is compliant and provides the number of contributors that affect the compliance.
     */
    set compliance(value: CfnConfigRule.ComplianceProperty | cdk.IResolvable | undefined);
    /**
     * A name for the AWS Config rule.
     */
    get configRuleName(): string | undefined;
    /**
     * A name for the AWS Config rule.
     */
    set configRuleName(value: string | undefined);
    /**
     * The description that you provide for the AWS Config rule.
     */
     ...
     * The modes the AWS Config rule can be evaluated in.
     */
    get evaluationModes(): Array<CfnConfigRule.EvaluationModeConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The modes the AWS Config rule can be evaluated in.
     */
    set evaluationModes(value: Array<CfnConfigRule.EvaluationModeConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A string, in JSON format, that is passed to the AWS Config rule Lambda function.
     */
    get inputParameters(): any | cdk.IResolvable | undefined;
    /**
     * A string, in JSON format, that is passed to the AWS Config rule Lambda function.
     */
    set inputParameters(value: any | cdk.IResolvable | undefined);
    /**
     * The maximum frequency with which AWS Config runs evaluations for a rule.
     */
     ...
     * Defines which resources can trigger an evaluation for the rule.
     */
    get scope(): cdk.IResolvable | CfnConfigRule.ScopeProperty | undefined;
    /**
     * Defines which resources can trigger an evaluation for the rule.
     */
    set scope(value: cdk.IResolvable | CfnConfigRule.ScopeProperty | undefined);
    /**
     * Provides the rule owner ( `AWS` for managed rules, `CUSTOM_POLICY` for Custom Policy rules, and `CUSTOM_LAMBDA` for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your AWS resources.
     */
    get source(): cdk.IResolvable | CfnConfigRule.SourceProperty;
    /**
     * Provides the rule owner ( `AWS` for managed rules, `CUSTOM_POLICY` for Custom Policy rules, and `CUSTOM_LAMBDA` for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your AWS resources.
     */
    set source(value: cdk.IResolvable | CfnConfigRule.SourceProperty);
    /**
...
export declare class CfnConfigurationAggregator extends cdk.CfnResource implements cdk.IInspectable, IConfigurationAggregatorRef, cdk.ITaggable {
     ...
     */
    static isCfnConfigurationAggregator(x: any): x is CfnConfigurationAggregator;
    static arnForConfigurationAggregator(resource: IConfigurationAggregatorRef): string;
    /**
     ...
     * Provides a list of source accounts and regions to be aggregated.
     */
    get accountAggregationSources(): Array<CfnConfigurationAggregator.AccountAggregationSourceProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Provides a list of source accounts and regions to be aggregated.
     */
    set accountAggregationSources(value: Array<CfnConfigurationAggregator.AccountAggregationSourceProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the aggregator.
     */
    get configurationAggregatorName(): string | undefined;
    /**
     * The name of the aggregator.
     */
    set configurationAggregatorName(value: string | undefined);
    /**
     * Provides an organization and list of regions to be aggregated.
     */
    get organizationAggregationSource(): cdk.IResolvable | CfnConfigurationAggregator.OrganizationAggregationSourceProperty | undefined;
    /**
     * Provides an organization and list of regions to be aggregated.
     */
    set organizationAggregationSource(value: cdk.IResolvable | CfnConfigurationAggregator.OrganizationAggregationSourceProperty | undefined);
    /**
     * An array of tag object.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrConfigurationAggregatorArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnConfigurationRecorder extends cdk.CfnResource implements cdk.IInspectable, IConfigurationRecorderRef {
     ...
     */
    static isCfnConfigurationRecorder(x: any): x is CfnConfigurationRecorder;
    /**
     ...
     * Specifies which resource types AWS Config records for configuration changes.
     */
    get recordingGroup(): cdk.IResolvable | CfnConfigurationRecorder.RecordingGroupProperty | undefined;
    /**
     * Specifies which resource types AWS Config records for configuration changes.
     */
    set recordingGroup(value: cdk.IResolvable | CfnConfigurationRecorder.RecordingGroupProperty | undefined);
    /**
     * Specifies the default recording frequency for the configuration recorder. AWS Config supports *Continuous recording* and *Daily recording* .
     */
    get recordingMode(): cdk.IResolvable | CfnConfigurationRecorder.RecordingModeProperty | undefined;
    /**
     * Specifies the default recording frequency for the configuration recorder. AWS Config supports *Continuous recording* and *Daily recording* .
     */
    set recordingMode(value: cdk.IResolvable | CfnConfigurationRecorder.RecordingModeProperty | undefined);
    /**
     * Amazon Resource Name (ARN) of the IAM role assumed by AWS Config and used by the configuration recorder.
     */
    get roleArn(): string;
...
export declare class CfnConformancePack extends cdk.CfnResource implements cdk.IInspectable, IConformancePackRef {
     ...
     */
    static isCfnConformancePack(x: any): x is CfnConformancePack;
    /**
     ...
     */
    private _templateSsmDocumentDetails?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * A list of ConformancePackInputParameter objects.
     */
    get conformancePackInputParameters(): Array<CfnConformancePack.ConformancePackInputParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of ConformancePackInputParameter objects.
     */
    set conformancePackInputParameters(value: Array<CfnConformancePack.ConformancePackInputParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Name of the conformance pack you want to create.
     */
     ...
     * The name of the Amazon S3 bucket where AWS Config stores conformance pack templates.
     */
    get deliveryS3Bucket(): string | undefined;
    /**
     * The name of the Amazon S3 bucket where AWS Config stores conformance pack templates.
     */
    set deliveryS3Bucket(value: string | undefined);
    /**
     * The prefix for the Amazon S3 bucket.
     */
    get deliveryS3KeyPrefix(): string | undefined;
    /**
     * The prefix for the Amazon S3 bucket.
     */
    set deliveryS3KeyPrefix(value: string | undefined);
    /**
     * A string containing full conformance pack template body.
     */
     ...
     * Location of file containing the template body (s3://bucketname/prefix).
     */
    get templateS3Uri(): string | undefined;
    /**
     * Location of file containing the template body (s3://bucketname/prefix).
     */
    set templateS3Uri(value: string | undefined);
    /**
     * An object that contains the name or Amazon Resource Name (ARN) of the AWS Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.
     */
    get templateSsmDocumentDetails(): any | cdk.IResolvable | undefined;
    /**
     * An object that contains the name or Amazon Resource Name (ARN) of the AWS Systems Manager document (SSM document) and the version of the SSM document that is used to create a conformance pack.
     */
    set templateSsmDocumentDetails(value: any | cdk.IResolvable | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnConformancePackProps {
     ...
     */
    readonly deliveryS3Bucket?: s3Refs.IBucketRef | string;
    /**
     * The prefix for the Amazon S3 bucket.
     *
...
export declare class CfnDeliveryChannel extends cdk.CfnResource implements cdk.IInspectable, IDeliveryChannelRef {
     ...
     */
    static isCfnDeliveryChannel(x: any): x is CfnDeliveryChannel;
    /**
     * The options for how often AWS Config delivers configuration snapshots to the Amazon S3 bucket.
     */
    private _configSnapshotDeliveryProperties?;
    /**
     ...
     * The options for how often AWS Config delivers configuration snapshots to the Amazon S3 bucket.
     */
    get configSnapshotDeliveryProperties(): CfnDeliveryChannel.ConfigSnapshotDeliveryPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * The options for how often AWS Config delivers configuration snapshots to the Amazon S3 bucket.
     */
    set configSnapshotDeliveryProperties(value: CfnDeliveryChannel.ConfigSnapshotDeliveryPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * A name for the delivery channel.
     */
    get name(): string | undefined;
     ...
     * The Amazon Resource Name (ARN) of the AWS Key Management Service ( AWS  ) AWS KMS key (KMS key) used to encrypt objects delivered by AWS Config .
     */
    get s3KmsKeyArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the AWS Key Management Service ( AWS  ) AWS KMS key (KMS key) used to encrypt objects delivered by AWS Config .
     */
    set s3KmsKeyArn(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the Amazon SNS topic to which AWS Config sends notifications about configuration changes.
     */
...
export declare class CfnOrganizationConfigRule extends cdk.CfnResource implements cdk.IInspectable, IOrganizationConfigRuleRef {
     ...
     */
    static isCfnOrganizationConfigRule(x: any): x is CfnOrganizationConfigRule;
    /**
     * Creates a new IOrganizationConfigRuleRef from a organizationConfigRuleId
     */
    static fromOrganizationConfigRuleId(scope: constructs.Construct, id: string, organizationConfigRuleId: string): IOrganizationConfigRuleRef;
    static arnForOrganizationConfigRule(resource: IOrganizationConfigRuleRef): string;
    /**
     ...
     */
    private _organizationConfigRuleName;
    /**
     * An object that specifies metadata for your organization's AWS Config Custom Policy rule.
     */
    private _organizationCustomPolicyRuleMetadata?;
    /**
     * An `OrganizationCustomRuleMetadata` object.
     */
    private _organizationCustomRuleMetadata?;
    /**
     * An `OrganizationManagedRuleMetadata` object.
     */
    private _organizationManagedRuleMetadata?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * A comma-separated list of accounts excluded from organization AWS Config rule.
     */
    get excludedAccounts(): Array<string> | undefined;
    /**
     * A comma-separated list of accounts excluded from organization AWS Config rule.
     */
    set excludedAccounts(value: Array<string> | undefined);
    /**
     * The name that you assign to organization AWS Config rule.
     */
    get organizationConfigRuleName(): string;
    /**
     * The name that you assign to organization AWS Config rule.
     */
    set organizationConfigRuleName(value: string);
    /**
     * An object that specifies metadata for your organization's AWS Config Custom Policy rule.
     */
    get organizationCustomPolicyRuleMetadata(): cdk.IResolvable | CfnOrganizationConfigRule.OrganizationCustomPolicyRuleMetadataProperty | undefined;
    /**
     * An object that specifies metadata for your organization's AWS Config Custom Policy rule.
     */
    set organizationCustomPolicyRuleMetadata(value: cdk.IResolvable | CfnOrganizationConfigRule.OrganizationCustomPolicyRuleMetadataProperty | undefined);
    /**
     * An `OrganizationCustomRuleMetadata` object.
     */
    get organizationCustomRuleMetadata(): cdk.IResolvable | CfnOrganizationConfigRule.OrganizationCustomRuleMetadataProperty | undefined;
    /**
     * An `OrganizationCustomRuleMetadata` object.
     */
    set organizationCustomRuleMetadata(value: cdk.IResolvable | CfnOrganizationConfigRule.OrganizationCustomRuleMetadataProperty | undefined);
    /**
     * An `OrganizationManagedRuleMetadata` object.
     */
    get organizationManagedRuleMetadata(): cdk.IResolvable | CfnOrganizationConfigRule.OrganizationManagedRuleMetadataProperty | undefined;
    /**
     * An `OrganizationManagedRuleMetadata` object.
     */
    set organizationManagedRuleMetadata(value: cdk.IResolvable | CfnOrganizationConfigRule.OrganizationManagedRuleMetadataProperty | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnOrganizationConformancePack extends cdk.CfnResource implements cdk.IInspectable, IOrganizationConformancePackRef {
     ...
     */
    static isCfnOrganizationConformancePack(x: any): x is CfnOrganizationConformancePack;
    /**
     * A list of `ConformancePackInputParameter` objects.
     */
    private _conformancePackInputParameters?;
     ...
     * A list of `ConformancePackInputParameter` objects.
     */
    get conformancePackInputParameters(): Array<CfnOrganizationConformancePack.ConformancePackInputParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of `ConformancePackInputParameter` objects.
     */
    set conformancePackInputParameters(value: Array<CfnOrganizationConformancePack.ConformancePackInputParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the Amazon S3 bucket where AWS Config stores conformance pack templates.
     */
    get deliveryS3Bucket(): string | undefined;
...
export declare class CfnRemediationConfiguration extends cdk.CfnResource implements cdk.IInspectable, IRemediationConfigurationRef {
     ...
     */
    static isCfnRemediationConfiguration(x: any): x is CfnRemediationConfiguration;
    /**
     ...
     * The remediation is triggered automatically.
     */
    get automatic(): boolean | cdk.IResolvable | undefined;
    /**
     * The remediation is triggered automatically.
     */
    set automatic(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the AWS Config rule.
     */
     ...
     * An ExecutionControls object.
     */
    get executionControls(): CfnRemediationConfiguration.ExecutionControlsProperty | cdk.IResolvable | undefined;
    /**
     * An ExecutionControls object.
     */
    set executionControls(value: CfnRemediationConfiguration.ExecutionControlsProperty | cdk.IResolvable | undefined);
    /**
     * The maximum number of failed attempts for auto-remediation. If you do not select a number, the default is 5.
     */
    get maximumAutomaticAttempts(): number | undefined;
    /**
     * The maximum number of failed attempts for auto-remediation. If you do not select a number, the default is 5.
     */
    set maximumAutomaticAttempts(value: number | undefined);
    /**
     * An object of the RemediationParameterValue. For more information, see [RemediationParameterValue](https://docs.aws.amazon.com/config/latest/APIReference/API_RemediationParameterValue.html) .
     */
     ...
     * Time window to determine whether or not to add a remediation exception to prevent infinite remediation attempts.
     */
    get retryAttemptSeconds(): number | undefined;
    /**
     * Time window to determine whether or not to add a remediation exception to prevent infinite remediation attempts.
     */
    set retryAttemptSeconds(value: number | undefined);
    /**
     * Target ID is the name of the SSM document.
     */
    get targetId(): string;
     ...
     * Version of the target. For example, version of the SSM document.
     */
    set targetVersion(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnStoredQuery extends cdk.CfnResource implements cdk.IInspectable, IStoredQueryRef, cdk.ITaggable {
     ...
     */
    static isCfnStoredQuery(x: any): x is CfnStoredQuery;
    /**
     ...
     * A unique description for the query.
     */
    get queryDescription(): string | undefined;
    /**
     * A unique description for the query.
     */
    set queryDescription(value: string | undefined);
    /**
     * The expression of the query.
     */
     ...
     */
    get attrQueryArn(): string;
    /**
     * The ID of the query.
     *
     * @cloudformationAttribute QueryId
     */
    get attrQueryId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 *
 * @cloudformationResource AWS::Config::Connector
 * @stability external
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef, cdk.ITaggableV2 {
    ...
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     * Create a new `AWS::Config::Connector`.
     *
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
     ...
     * The configuration for the connector.
     */
    get connectorConfiguration(): CfnConnector.ConnectorConfigurationProperty | cdk.IResolvable;
    /**
     * The configuration for the connector.
     */
    set connectorConfiguration(value: CfnConnector.ConnectorConfigurationProperty | cdk.IResolvable);
    /**
     * The tags for the connector.
     */
...
export declare namespace CfnConnector {
    ...
    interface ConnectorConfigurationProperty {
         ...
         */
        readonly azure?: CfnConnector.AzureConnectorConfigurationProperty | cdk.IResolvable;
    }
    /**
     * Configuration for connecting to Microsoft Azure.
     *
...
export interface CfnConnectorProps {
     ...
     */
    readonly connectorConfiguration: CfnConnector.ConnectorConfigurationProperty | cdk.IResolvable;
    /**
     * The tags for the connector.
     *
...
export type { IAggregationAuthorizationRef, AggregationAuthorizationReference };
export type { IConfigRuleRef, ConfigRuleReference };
export type { IConfigurationAggregatorRef, ConfigurationAggregatorReference };
export type { IConfigurationRecorderRef, ConfigurationRecorderReference };
export type { IConformancePackRef, ConformancePackReference };
export type { IDeliveryChannelRef, DeliveryChannelReference };
export type { IOrganizationConfigRuleRef, OrganizationConfigRuleReference };
export type { IOrganizationConformancePackRef, OrganizationConformancePackReference };
export type { IRemediationConfigurationRef, RemediationConfigurationReference };
export type { IStoredQueryRef, StoredQueryReference };
