...
import type { IClusterRef, ClusterReference } from './ecs.generated';
...
export declare class Cluster extends Resource implements ICluster {
     ...
     */
    addExistingDefaultCloudMapNamespace(options: ExistingCloudMapNamespaceOptions): cloudmap.INamespace;
    /**
 ...
 */
export declare enum CapacityOptionType {
    /**
