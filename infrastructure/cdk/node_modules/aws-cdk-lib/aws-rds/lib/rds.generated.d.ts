...
export declare class CfnCustomDBEngineVersion extends cdk.CfnResource implements cdk.IInspectable, ICustomDBEngineVersionRef, cdk.ITaggableV2 {
    ...
    private _databaseInstallationFiles?;
    /**
    ...
    get databaseInstallationFiles(): Array<string> | undefined;
    set databaseInstallationFiles(value: Array<string> | undefined);
    /**
     * The name of an Amazon S3 bucket that contains database installation files for your CEV.
     */
...
export interface CfnCustomDBEngineVersionProps {
     ...
     */
    readonly databaseInstallationFiles?: Array<string>;
    /**
     * The name of an Amazon S3 bucket that contains database installation files for your CEV.
     *
...
export declare class CfnDBCluster extends cdk.CfnResource implements cdk.IInspectable, IDBClusterRef, cdk.ITaggable {
     ...
     */
    get attrEndpoint(): cdk.IResolvable;
    /**
     ...
     */
    get attrMasterUserSecretSecretArn(): string;
    /**
     ...
     */
    get attrReadEndpoint(): cdk.IResolvable;
    /**
     ...
     */
    get attrReadEndpointAddress(): string;
    /**
     * @cloudformationAttribute StorageEncryptionType
     */
    get attrStorageEncryptionType(): string;
    /**
     ...
     */
    get attrStorageThroughput(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDBInstance extends cdk.CfnResource implements cdk.IInspectable, IDBInstanceRef, cdk.ITaggable {
     ...
     */
    private _additionalStorageVolumes?;
    /**
     ...
     */
    private _automaticBackupReplicationKmsKeyId?;
    /**
     * The AWS Region associated with the automated backup.
     */
    private _automaticBackupReplicationRegion?;
    /**
     * The retention period for automated backups in a different AWS Region.
     */
    private _automaticBackupReplicationRetentionPeriod?;
    /**
     ...
     */
    private _tdeCredentialArn?;
    /**
     * @deprecated this property has been deprecated
     */
    private _tdeCredentialPassword?;
    /**
     ...
     */
    private _useDefaultProcessorFeatures?;
    /**
     ...
     * The additional storage volumes associated with the DB instance.
     */
    get additionalStorageVolumes(): Array<CfnDBInstance.AdditionalStorageVolumeProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The additional storage volumes associated with the DB instance.
     */
    set additionalStorageVolumes(value: Array<CfnDBInstance.AdditionalStorageVolumeProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The amount of storage in gibibytes (GiB) to be initially allocated for the database instance.
     */
    get allocatedStorage(): string | undefined;
    /**
     * The amount of storage in gibibytes (GiB) to be initially allocated for the database instance.
     */
    set allocatedStorage(value: string | undefined);
    /**
     * A value that indicates whether major version upgrades are allowed.
     */
    get allowMajorVersionUpgrade(): boolean | cdk.IResolvable | undefined;
    /**
     * A value that indicates whether major version upgrades are allowed.
     */
    set allowMajorVersionUpgrade(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether changes to the DB instance and any pending modifications are applied immediately, regardless of the `PreferredMaintenanceWindow` setting.
     */
    get applyImmediately(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether changes to the DB instance and any pending modifications are applied immediately, regardless of the `PreferredMaintenanceWindow` setting.
     */
    set applyImmediately(value: boolean | cdk.IResolvable | undefined);
    /**
     * The AWS Identity and Access Management (IAM) roles associated with the DB instance.
     */
    get associatedRoles(): Array<CfnDBInstance.DBInstanceRoleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The AWS Identity and Access Management (IAM) roles associated with the DB instance.
     */
    set associatedRoles(value: Array<CfnDBInstance.DBInstanceRoleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The AWS KMS key identifier for encryption of the replicated automated backups.
     */
    get automaticBackupReplicationKmsKeyId(): string | undefined;
    /**
     * The AWS KMS key identifier for encryption of the replicated automated backups.
     */
    set automaticBackupReplicationKmsKeyId(value: string | undefined);
    /**
     * The AWS Region associated with the automated backup.
     */
    get automaticBackupReplicationRegion(): string | undefined;
    /**
     * The AWS Region associated with the automated backup.
     */
    set automaticBackupReplicationRegion(value: string | undefined);
    /**
     * The retention period for automated backups in a different AWS Region.
     */
    get automaticBackupReplicationRetentionPeriod(): number | undefined;
    /**
     * The retention period for automated backups in a different AWS Region.
     */
    set automaticBackupReplicationRetentionPeriod(value: number | undefined);
    /**
     * A value that indicates whether minor engine upgrades are applied automatically to the DB instance during the maintenance window.
     */
    get autoMinorVersionUpgrade(): boolean | cdk.IResolvable | undefined;
     ...
     * The location for storing automated backups and manual snapshots.
     */
    get backupTarget(): string | undefined;
    /**
     * The location for storing automated backups and manual snapshots.
     */
    set backupTarget(value: string | undefined);
    /**
     * The identifier of the CA certificate for this DB instance.
     */
     ...
     * The instance profile associated with the underlying Amazon EC2 instance of an RDS Custom DB instance.
     */
    get customIamInstanceProfile(): string | undefined;
    /**
     * The instance profile associated with the underlying Amazon EC2 instance of an RDS Custom DB instance.
     */
    set customIamInstanceProfile(value: string | undefined);
    /**
     * The mode of Database Insights to enable for the DB instance.
     */
    get databaseInsightsMode(): string | undefined;
     ...
     * The compute and memory capacity of the DB instance, for example `db.m5.large` . Not all DB instance classes are available in all AWS Regions , or for all database engines. For the full list of DB instance classes, and availability for your engine, see [DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html) in the *Amazon RDS User Guide* or [Aurora DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.DBInstanceClass.html) in the *Amazon Aurora User Guide* .
     */
    get dbInstanceClass(): string | undefined;
    /**
     * The compute and memory capacity of the DB instance, for example `db.m5.large` . Not all DB instance classes are available in all AWS Regions , or for all database engines. For the full list of DB instance classes, and availability for your engine, see [DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html) in the *Amazon RDS User Guide* or [Aurora DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.DBInstanceClass.html) in the *Amazon Aurora User Guide* .
     */
    set dbInstanceClass(value: string | undefined);
    /**
     * A name for the DB instance.
     */
     ...
     * The meaning of this parameter differs according to the database engine you use.
     */
    set dbName(value: string | undefined);
    /**
     * The name of an existing DB parameter group or a reference to an [AWS::RDS::DBParameterGroup](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbparametergroup.html) resource created in the template.
     */
     ...
     * A list of the DB security groups to assign to the DB instance.
     */
    get dbSecurityGroups(): Array<string> | undefined;
    /**
     * A list of the DB security groups to assign to the DB instance.
     */
    set dbSecurityGroups(value: Array<string> | undefined);
    /**
     * The name or Amazon Resource Name (ARN) of the DB snapshot that's used to restore the DB instance.
     */
     ...
     * Indicates whether the DB instance has a dedicated log volume (DLV) enabled.
     */
    get dedicatedLogVolume(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the DB instance has a dedicated log volume (DLV) enabled.
     */
    set dedicatedLogVolume(value: boolean | cdk.IResolvable | undefined);
    /**
     * A value that indicates whether to remove automated backups immediately after the DB instance is deleted.
     */
    get deleteAutomatedBackups(): boolean | cdk.IResolvable | undefined;
     ...
     * The ARN for the Secrets Manager secret with the credentials for the user joining the domain.
     */
    get domainAuthSecretArn(): string | undefined;
    /**
     * The ARN for the Secrets Manager secret with the credentials for the user joining the domain.
     */
    set domainAuthSecretArn(value: string | undefined);
    /**
     * The IPv4 DNS IP addresses of your primary and secondary Active Directory domain controllers.
     */
    get domainDnsIps(): Array<string> | undefined;
    /**
     * The IPv4 DNS IP addresses of your primary and secondary Active Directory domain controllers.
     */
    set domainDnsIps(value: Array<string> | undefined);
    /**
     * The fully qualified domain name (FQDN) of an Active Directory domain.
     */
    get domainFqdn(): string | undefined;
    /**
     * The fully qualified domain name (FQDN) of an Active Directory domain.
     */
    set domainFqdn(value: string | undefined);
    /**
     * The name of the IAM role to use when making API calls to the Directory Service.
     */
    get domainIamRoleName(): string | undefined;
     ...
     * The Active Directory organizational unit for your DB instance to join.
     */
    get domainOu(): string | undefined;
    /**
     * The Active Directory organizational unit for your DB instance to join.
     */
    set domainOu(value: string | undefined);
    /**
     * The list of log types that need to be enabled for exporting to CloudWatch Logs.
     */
    get enableCloudwatchLogsExports(): Array<string> | undefined;
     ...
     * The secret managed by RDS in AWS Secrets Manager for the master user password.
     */
    get masterUserSecret(): cdk.IResolvable | CfnDBInstance.MasterUserSecretProperty | undefined;
    /**
     * The secret managed by RDS in AWS Secrets Manager for the master user password.
     */
    set masterUserSecret(value: cdk.IResolvable | CfnDBInstance.MasterUserSecretProperty | undefined);
    /**
     * The upper limit in gibibytes (GiB) to which Amazon RDS can automatically scale the storage of the DB instance.
     */
     ...
     * The name of the NCHAR character set for the Oracle DB instance.
     */
    get ncharCharacterSetName(): string | undefined;
    /**
     * The name of the NCHAR character set for the Oracle DB instance.
     */
    set ncharCharacterSetName(value: string | undefined);
    /**
     * The network type of the DB instance.
     */
    get networkType(): string | undefined;
     ...
     * The number of CPU cores and the number of threads per core for the DB instance class of the DB instance.
     */
    get processorFeatures(): Array<cdk.IResolvable | CfnDBInstance.ProcessorFeatureProperty> | cdk.IResolvable | undefined;
    /**
     * The number of CPU cores and the number of threads per core for the DB instance class of the DB instance.
     */
    set processorFeatures(value: Array<cdk.IResolvable | CfnDBInstance.ProcessorFeatureProperty> | cdk.IResolvable | undefined);
    /**
     * The order of priority in which an Aurora Replica is promoted to the primary instance after a failure of the existing primary instance.
     */
     ...
     * The open mode of an Oracle read replica.
     */
    get replicaMode(): string | undefined;
    /**
     * The open mode of an Oracle read replica.
     */
    set replicaMode(value: string | undefined);
    /**
     * The date and time to restore from.
     */
    get restoreTime(): string | undefined;
    /**
     * The date and time to restore from.
     */
    set restoreTime(value: string | undefined);
    /**
     * The identifier of the Multi-AZ DB cluster that will act as the source for the read replica.
     */
    get sourceDbClusterIdentifier(): string | undefined;
     ...
     * The Amazon Resource Name (ARN) of the replicated automated backups from which to restore, for example, `arn:aws:rds:us-east-1:123456789012:auto-backup:ab-L2IJCEXJP7XQ7HOJ4SIEXAMPLE` .
     */
    get sourceDbInstanceAutomatedBackupsArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the replicated automated backups from which to restore, for example, `arn:aws:rds:us-east-1:123456789012:auto-backup:ab-L2IJCEXJP7XQ7HOJ4SIEXAMPLE` .
     */
    set sourceDbInstanceAutomatedBackupsArn(value: string | undefined);
    /**
     * If you want to create a read replica DB instance, specify the ID of the source DB instance.
     */
    get sourceDbInstanceIdentifier(): string | undefined;
    /**
     * If you want to create a read replica DB instance, specify the ID of the source DB instance.
     */
    set sourceDbInstanceIdentifier(value: string | undefined);
    /**
     * The resource ID of the source DB instance from which to restore.
     */
    get sourceDbiResourceId(): string | undefined;
    /**
     * The resource ID of the source DB instance from which to restore.
     */
    set sourceDbiResourceId(value: string | undefined);
    /**
     * The ID of the region that contains the source DB instance for the read replica.
     */
    get sourceRegion(): string | undefined;
     ...
     * Specifies the storage throughput value, in mebibyte per second (MiBps), for the DB instance.
     */
    get storageThroughput(): number | undefined;
    /**
     * Specifies the storage throughput value, in mebibyte per second (MiBps), for the DB instance.
     */
    set storageThroughput(value: number | undefined);
    /**
     * The storage type to associate with the DB instance.
     */
    get storageType(): string | undefined;
     ...
     * @deprecated this property has been deprecated
     */
    get tdeCredentialArn(): string | undefined;
    /**
     * @deprecated this property has been deprecated
     */
    set tdeCredentialArn(value: string | undefined);
    /**
     * @deprecated this property has been deprecated
     */
    get tdeCredentialPassword(): string | undefined;
    /**
     * @deprecated this property has been deprecated
     */
    set tdeCredentialPassword(value: string | undefined);
    /**
     * The time zone of the DB instance.
     */
     ...
     * Specifies whether the DB instance class of the DB instance uses its default processor features.
     */
    get useDefaultProcessorFeatures(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the DB instance class of the DB instance uses its default processor features.
     */
    set useDefaultProcessorFeatures(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether the DB instance is restored from the latest backup time.
     */
    get useLatestRestorableTime(): boolean | cdk.IResolvable | undefined;
     ...
     * A list of the VPC security group IDs to assign to the DB instance.
     */
    get vpcSecurityGroups(): Array<string> | undefined;
    /**
     * A list of the VPC security group IDs to assign to the DB instance.
     */
    set vpcSecurityGroups(value: Array<string> | undefined);
    /**
     * The time when a stopped DB instance is restarted automatically.
     *
     * @cloudformationAttribute AutomaticRestartTime
     */
    get attrAutomaticRestartTime(): string;
    /**
     ...
     */
    get attrEndpointHostedZoneId(): string;
    /**
     ...
     */
    get attrInstanceCreateTime(): string;
    /**
     ...
     */
    get attrIsStorageConfigUpgradeAvailable(): cdk.IResolvable;
    /**
     * The latest time to which a database in this DB instance can be restored with point-in-time restore.
     *
     * @cloudformationAttribute LatestRestorableTime
     */
    get attrLatestRestorableTime(): string;
    /**
     * This data type represents the information you need to connect to an Amazon RDS DB instance. This data type is used as a response element in the following actions:
     *   +   ``CreateDBInstance``
     *   +   ``DescribeDBInstances``
     ...
     */
    get attrPercentProgress(): string;
    /**
...
export declare class CfnDBParameterGroup extends cdk.CfnResource implements cdk.IInspectable, IDBParameterGroupRef, cdk.ITaggable {
     ...
     */
    static fromDBParameterGroupName(scope: constructs.Construct, id: string, dbParameterGroupName: string): IDBParameterGroupRef;
    static arnForDBParameterGroup(resource: IDBParameterGroupRef): string;
    /**
     ...
     */
    get attrDbParameterGroupName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDBProxy extends cdk.CfnResource implements cdk.IInspectable, IDBProxyRef, cdk.ITaggableV2 {
     ...
     * The authorization mechanism that the proxy uses.
     */
    get auth(): Array<CfnDBProxy.AuthFormatProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The authorization mechanism that the proxy uses.
     */
    set auth(value: Array<CfnDBProxy.AuthFormatProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The identifier for the proxy.
     */
     ...
     * Specifies whether the proxy logs detailed connection and query information.
     */
    get debugLogging(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the proxy logs detailed connection and query information.
     */
    set debugLogging(value: boolean | cdk.IResolvable | undefined);
    /**
     * The default authentication scheme that the proxy uses for client connections to the proxy and connections from the proxy to the underlying database.
     */
    get defaultAuthScheme(): string | undefined;
    /**
     * The default authentication scheme that the proxy uses for client connections to the proxy and connections from the proxy to the underlying database.
     */
    set defaultAuthScheme(value: string | undefined);
    /**
     * The network type of the DB proxy endpoint.
     */
    get endpointNetworkType(): string | undefined;
    /**
     * The network type of the DB proxy endpoint.
     */
    set endpointNetworkType(value: string | undefined);
    /**
     * The kinds of databases that the proxy can connect to.
     */
     ...
     * The number of seconds that a connection to the proxy can be inactive before the proxy disconnects it.
     */
    get idleClientTimeout(): number | undefined;
    /**
     * The number of seconds that a connection to the proxy can be inactive before the proxy disconnects it.
     */
    set idleClientTimeout(value: number | undefined);
    /**
     * Specifies whether Transport Layer Security (TLS) encryption is required for connections to the proxy.
     */
    get requireTls(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether Transport Layer Security (TLS) encryption is required for connections to the proxy.
     */
    set requireTls(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role that the proxy uses to access secrets in AWS Secrets Manager.
     */
    get roleArn(): string;
     ...
     * An optional set of key-value pairs to associate arbitrary data of your choosing with the proxy.
     */
    get tags(): Array<CfnDBProxy.TagFormatProperty> | undefined;
    /**
     * An optional set of key-value pairs to associate arbitrary data of your choosing with the proxy.
     */
    set tags(value: Array<CfnDBProxy.TagFormatProperty> | undefined);
    /**
     * The network type that the proxy uses to connect to the target database.
     */
    get targetConnectionNetworkType(): string | undefined;
    /**
     * The network type that the proxy uses to connect to the target database.
     */
    set targetConnectionNetworkType(value: string | undefined);
    /**
     * One or more VPC security group IDs to associate with the new proxy.
     */
    get vpcSecurityGroupIds(): Array<string> | undefined;
     ...
     * One or more VPC subnet IDs to associate with the new proxy.
     */
    get vpcSubnetIds(): Array<string>;
    /**
     * One or more VPC subnet IDs to associate with the new proxy.
     */
    set vpcSubnetIds(value: Array<string>);
    /**
     * The Amazon Resource Name (ARN) for the proxy.
     *
     * @cloudformationAttribute DBProxyArn
     */
    get attrDbProxyArn(): string;
    /**
...
export declare class CfnDBProxyEndpoint extends cdk.CfnResource implements cdk.IInspectable, IDBProxyEndpointRef, cdk.ITaggableV2 {
     ...
     * An optional set of key-value pairs to associate arbitrary data of your choosing with the proxy.
     */
    get tags(): Array<CfnDBProxyEndpoint.TagFormatProperty> | undefined;
    /**
     * An optional set of key-value pairs to associate arbitrary data of your choosing with the proxy.
     */
    set tags(value: Array<CfnDBProxyEndpoint.TagFormatProperty> | undefined);
    /**
     * A value that indicates whether the DB proxy endpoint can be used for read/write or read-only operations.
     */
    get targetRole(): string | undefined;
    /**
     * A value that indicates whether the DB proxy endpoint can be used for read/write or read-only operations.
     */
    set targetRole(value: string | undefined);
    /**
     * The VPC security group IDs for the DB proxy endpoint that you create.
     */
    get vpcSecurityGroupIds(): Array<string> | undefined;
     ...
     */
    get attrDbProxyEndpointArn(): string;
    /**
     * The endpoint that you can use to connect to the DB proxy. You include the endpoint value in the connection string for a database client application.
     *
     * @cloudformationAttribute Endpoint
...
export declare class CfnDBProxyTargetGroup extends cdk.CfnResource implements cdk.IInspectable, IDBProxyTargetGroupRef {
     ...
     * Displays the settings that control the size and behavior of the connection pool associated with a `DBProxyTarget` .
     */
    get connectionPoolConfigurationInfo(): CfnDBProxyTargetGroup.ConnectionPoolConfigurationInfoFormatProperty | cdk.IResolvable | undefined;
    /**
     * Displays the settings that control the size and behavior of the connection pool associated with a `DBProxyTarget` .
     */
    set connectionPoolConfigurationInfo(value: CfnDBProxyTargetGroup.ConnectionPoolConfigurationInfoFormatProperty | cdk.IResolvable | undefined);
    /**
     * One or more DB cluster identifiers.
     */
    get dbClusterIdentifiers(): Array<string> | undefined;
    /**
     * One or more DB cluster identifiers.
     */
    set dbClusterIdentifiers(value: Array<string> | undefined);
    /**
     * One or more DB instance identifiers.
     */
    get dbInstanceIdentifiers(): Array<string> | undefined;
    /**
     * One or more DB instance identifiers.
     */
    set dbInstanceIdentifiers(value: Array<string> | undefined);
    /**
     * The identifier of the `DBProxy` that is associated with the `DBProxyTargetGroup` .
     */
    get dbProxyName(): string;
...
export declare class CfnDBSecurityGroup extends cdk.CfnResource implements cdk.IInspectable, IDBSecurityGroupRef, cdk.ITaggable {
     ...
     */
    private _dbSecurityGroupIngress;
    /**
     ...
     * Ingress rules to be applied to the DB security group.
     */
    get dbSecurityGroupIngress(): Array<CfnDBSecurityGroup.IngressProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Ingress rules to be applied to the DB security group.
     */
    set dbSecurityGroupIngress(value: Array<CfnDBSecurityGroup.IngressProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The identifier of an Amazon virtual private cloud (VPC).
     */
    get ec2VpcId(): string | undefined;
    /**
     * The identifier of an Amazon virtual private cloud (VPC).
     */
    set ec2VpcId(value: string | undefined);
    /**
     * Provides the description of the DB security group.
     */
...
export declare class CfnDBSecurityGroupIngress extends cdk.CfnResource implements cdk.IInspectable, IDBSecurityGroupIngressRef {
     ...
     */
    private _dbSecurityGroupName;
    /**
     * Id of the EC2 security group to authorize.
     */
    private _ec2SecurityGroupId?;
    /**
     * Name of the EC2 security group to authorize.
     */
    private _ec2SecurityGroupName?;
    /**
     * AWS account number of the owner of the EC2 security group specified in the `EC2SecurityGroupName` parameter.
     */
    private _ec2SecurityGroupOwnerId?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * The IP range to authorize.
     */
    get cidrip(): string | undefined;
    /**
     * The IP range to authorize.
     */
    set cidrip(value: string | undefined);
    /**
     * The name of the DB security group to add authorization to.
     */
    get dbSecurityGroupName(): string;
    /**
     * The name of the DB security group to add authorization to.
     */
    set dbSecurityGroupName(value: string);
    /**
     * Id of the EC2 security group to authorize.
     */
    get ec2SecurityGroupId(): string | undefined;
    /**
     * Id of the EC2 security group to authorize.
     */
    set ec2SecurityGroupId(value: string | undefined);
    /**
     * Name of the EC2 security group to authorize.
     */
    get ec2SecurityGroupName(): string | undefined;
    /**
     * Name of the EC2 security group to authorize.
     */
    set ec2SecurityGroupName(value: string | undefined);
    /**
     * AWS account number of the owner of the EC2 security group specified in the `EC2SecurityGroupName` parameter.
     */
    get ec2SecurityGroupOwnerId(): string | undefined;
    /**
     * AWS account number of the owner of the EC2 security group specified in the `EC2SecurityGroupName` parameter.
     */
    set ec2SecurityGroupOwnerId(value: string | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnGlobalCluster extends cdk.CfnResource implements cdk.IInspectable, IGlobalClusterRef, cdk.ITaggableV2 {
     ...
     */
    get attrGlobalEndpoint(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnOptionGroup extends cdk.CfnResource implements cdk.IInspectable, IOptionGroupRef, cdk.ITaggable {
     ...
     * A list of all available options for an option group.
     */
    get optionConfigurations(): Array<cdk.IResolvable | CfnOptionGroup.OptionConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of all available options for an option group.
     */
    set optionConfigurations(value: Array<cdk.IResolvable | CfnOptionGroup.OptionConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The description of the option group.
     */
...
export declare class CfnDBShardGroup extends cdk.CfnResource implements cdk.IInspectable, IDBShardGroupRef, cdk.ITaggableV2 {
     ...
     * Specifies whether to create standby standby DB data access shard for the DB shard group.
     */
    get computeRedundancy(): number | undefined;
    /**
     * Specifies whether to create standby standby DB data access shard for the DB shard group.
     */
    set computeRedundancy(value: number | undefined);
    /**
     * The name of the primary DB cluster for the DB shard group.
     */
     ...
     * The name of the DB shard group.
     */
    get dbShardGroupIdentifier(): string | undefined;
    /**
     * The name of the DB shard group.
     */
    set dbShardGroupIdentifier(value: string | undefined);
    /**
     * The maximum capacity of the DB shard group in Aurora capacity units (ACUs).
     */
    get maxAcu(): number;
     ...
     * The minimum capacity of the DB shard group in Aurora capacity units (ACUs).
     */
    get minAcu(): number | undefined;
    /**
     * The minimum capacity of the DB shard group in Aurora capacity units (ACUs).
     */
    set minAcu(value: number | undefined);
    /**
     * Specifies whether the DB shard group is publicly accessible.
     */
    get publiclyAccessible(): boolean | cdk.IResolvable | undefined;
     ...
     */
    get attrDbShardGroupResourceId(): string;
    /**
     * This data type represents the information you need to connect to an Amazon RDS DB instance. This data type is used as a response element in the following actions:
     *
     * - `CreateDBInstance`
...
export declare class CfnIntegration extends cdk.CfnResource implements cdk.IInspectable, IIntegrationRef, cdk.ITaggableV2 {
     ...
     * The name of the integration.
     */
    get integrationName(): string | undefined;
    /**
     * The name of the integration.
     */
    set integrationName(value: string | undefined);
    /**
     * The AWS Key Management System ( AWS KMS) key identifier for the key to use to encrypt the integration.
     */
    get kmsKeyId(): string | undefined;
 ...
 */
export declare class CfnReservedDBInstance extends cdk.CfnResource implements cdk.IInspectable, IReservedDBInstanceRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnReservedDBInstance from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnReservedDBInstance;
    /**
     * Checks whether the given object is a CfnReservedDBInstance
     */
    static isCfnReservedDBInstance(x: any): x is CfnReservedDBInstance;
    static arnForReservedDBInstance(resource: IReservedDBInstanceRef): string;
    private _dbInstanceCount?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnReservedDBInstanceProps);
    get reservedDbInstanceRef(): ReservedDBInstanceReference;
    get dbInstanceCount(): number | undefined;
    set dbInstanceCount(value: number | undefined);
    /**
     ...
     */
    get attrTags(): cdk.IResolvable;
    /**
     * @cloudformationAttribute UsagePrice
     */
    get attrUsagePrice(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnReservedDBInstance {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-reserveddbinstance.html
 */
export interface CfnReservedDBInstanceProps {
    /**
...
export type { IReservedDBInstanceRef, ReservedDBInstanceReference };
