...
import { AlarmMuteRuleReference, AlarmReference, AnomalyDetectorReference, CompositeAlarmReference, DashboardReference, IAlarmMuteRuleRef, IAlarmRef, IAnomalyDetectorRef, ICompositeAlarmRef, IDashboardRef, IInsightRuleRef, ILogAlarmRef, IMetricStreamRef, InsightRuleReference, IOTelEnrichmentRef, LogAlarmReference, MetricStreamReference, OTelEnrichmentReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
/**
...
export declare class CfnCompositeAlarm extends cdk.CfnResource implements cdk.IInspectable, ICompositeAlarmRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCompositeAlarm(x: any): x is CfnCompositeAlarm;
    /**
     * Creates a new ICompositeAlarmRef from an ARN
     */
    static fromCompositeAlarmArn(scope: constructs.Construct, id: string, arn: string): ICompositeAlarmRef;
    /**
     * Creates a new ICompositeAlarmRef from a alarmName
     */
    static fromAlarmName(scope: constructs.Construct, id: string, alarmName: string): ICompositeAlarmRef;
    static arnForCompositeAlarm(resource: ICompositeAlarmRef): string;
    /**
     ...
     * Actions will be suppressed if the suppressor alarm is in the `ALARM` state.
     */
    get actionsSuppressor(): string | undefined;
    /**
     * Actions will be suppressed if the suppressor alarm is in the `ALARM` state.
     */
    set actionsSuppressor(value: string | undefined);
    /**
     * The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state.
     */
    get actionsSuppressorExtensionPeriod(): number | undefined;
    /**
     * The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state.
     */
    set actionsSuppressorExtensionPeriod(value: number | undefined);
    /**
     * The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the `ALARM` state.
     */
    get actionsSuppressorWaitPeriod(): number | undefined;
    /**
     * The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the `ALARM` state.
     */
    set actionsSuppressorWaitPeriod(value: number | undefined);
    /**
     * The actions to execute when this alarm transitions to the ALARM state from any other state.
     */
    get alarmActions(): Array<string> | undefined;
...
export interface CfnCompositeAlarmProps {
     ...
     */
    readonly actionsSuppressor?: cloudWatchRefs.IAlarmRef | cloudWatchRefs.ICompositeAlarmRef | string;
    /**
     * The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state.
     *
     ...
     */
    readonly alarmActions?: Array<snsRefs.ITopicRef | string>;
    /**
     * The description for the composite alarm.
     *
...
export declare class CfnDashboard extends cdk.CfnResource implements cdk.IInspectable, IDashboardRef, cdk.ITaggableV2 {
     ...
     */
    static fromDashboardName(scope: constructs.Construct, id: string, dashboardName: string): IDashboardRef;
     ...
     * The name of the dashboard.
     */
    get dashboardName(): string | undefined;
    /**
     * The name of the dashboard.
     */
    set dashboardName(value: string | undefined);
    /**
     * A list of key-value pairs to associate with the cloudwatch dashboard.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnInsightRule extends cdk.CfnResource implements cdk.IInspectable, IInsightRuleRef, cdk.ITaggable {
     ...
     */
    static isCfnInsightRule(x: any): x is CfnInsightRule;
    static arnForInsightRule(resource: IInsightRuleRef): string;
    /**
     ...
     * Determines whether the rules is evaluated on transformed versions of logs.
     */
    get applyOnTransformedLogs(): boolean | cdk.IResolvable | undefined;
    /**
     * Determines whether the rules is evaluated on transformed versions of logs.
     */
    set applyOnTransformedLogs(value: boolean | cdk.IResolvable | undefined);
    /**
     * The definition of the rule, as a JSON object.
     */
    get ruleBody(): string;
...
export declare class CfnMetricStream extends cdk.CfnResource implements cdk.IInspectable, IMetricStreamRef, cdk.ITaggable {
     ...
     */
    static isCfnMetricStream(x: any): x is CfnMetricStream;
    /**
     * Creates a new IMetricStreamRef from an ARN
     */
    static fromMetricStreamArn(scope: constructs.Construct, id: string, arn: string): IMetricStreamRef;
    /**
     * Creates a new IMetricStreamRef from a metricStreamName
     */
    static fromMetricStreamName(scope: constructs.Construct, id: string, metricStreamName: string): IMetricStreamRef;
    static arnForMetricStream(resource: IMetricStreamRef): string;
    /**
     ...
     */
    private _statisticsConfigurations?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * If you specify this parameter, the stream sends metrics from all metric namespaces except for the namespaces that you specify here.
     */
    get excludeFilters(): Array<cdk.IResolvable | CfnMetricStream.MetricStreamFilterProperty> | cdk.IResolvable | undefined;
    /**
     * If you specify this parameter, the stream sends metrics from all metric namespaces except for the namespaces that you specify here.
     */
    set excludeFilters(value: Array<cdk.IResolvable | CfnMetricStream.MetricStreamFilterProperty> | cdk.IResolvable | undefined);
    /**
     * The ARN of the Amazon Kinesis Firehose delivery stream to use for this metric stream.
     */
     ...
     * If you specify this parameter, the stream sends only the metrics from the metric namespaces that you specify here.
     */
    get includeFilters(): Array<cdk.IResolvable | CfnMetricStream.MetricStreamFilterProperty> | cdk.IResolvable | undefined;
    /**
     * If you specify this parameter, the stream sends only the metrics from the metric namespaces that you specify here.
     */
    set includeFilters(value: Array<cdk.IResolvable | CfnMetricStream.MetricStreamFilterProperty> | cdk.IResolvable | undefined);
    /**
     * If you are creating a metric stream in a monitoring account, specify `true` to include metrics from source accounts that are linked to this monitoring account, in the metric stream.
     */
    get includeLinkedAccountsMetrics(): boolean | cdk.IResolvable | undefined;
    /**
     * If you are creating a metric stream in a monitoring account, specify `true` to include metrics from source accounts that are linked to this monitoring account, in the metric stream.
     */
    set includeLinkedAccountsMetrics(value: boolean | cdk.IResolvable | undefined);
    /**
     * If you are creating a new metric stream, this is the name for the new stream.
     */
     ...
     * By default, a metric stream always sends the MAX, MIN, SUM, and SAMPLECOUNT statistics for each metric that is streamed.
     */
    get statisticsConfigurations(): Array<cdk.IResolvable | CfnMetricStream.MetricStreamStatisticsConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * By default, a metric stream always sends the MAX, MIN, SUM, and SAMPLECOUNT statistics for each metric that is streamed.
     */
    set statisticsConfigurations(value: Array<cdk.IResolvable | CfnMetricStream.MetricStreamStatisticsConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to the metric stream.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export interface CfnMetricStreamProps {
     ...
     */
    readonly firehoseArn: kinesisFirehoseRefs.IDeliveryStreamRef | string;
    /**
     * If you specify this parameter, the stream sends only the metrics from the metric namespaces that you specify here.
     *
     * You cannot specify both `IncludeFilters` and `ExcludeFilters` in the same metric stream.
 ...
 */
export declare class CfnAlarmMuteRule extends cdk.CfnResource implements cdk.IInspectable, IAlarmMuteRuleRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAlarmMuteRule from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAlarmMuteRule;
    /**
     * Checks whether the given object is a CfnAlarmMuteRule
     */
    static isCfnAlarmMuteRule(x: any): x is CfnAlarmMuteRule;
    static arnForAlarmMuteRule(resource: IAlarmMuteRuleRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAlarmMuteRuleProps);
     ...
     * The date, with the same timezone offset as "ScheduleTimezone" after which the alarm mute rule will be expired.
     */
    get expireDate(): string | undefined;
    /**
     * The date, with the same timezone offset as "ScheduleTimezone" after which the alarm mute rule will be expired.
     */
    set expireDate(value: string | undefined);
    /**
     * Targets to be muted.
     */
    get muteTargets(): cdk.IResolvable | CfnAlarmMuteRule.MuteTargetsProperty | undefined;
    /**
     * Targets to be muted.
     */
    set muteTargets(value: cdk.IResolvable | CfnAlarmMuteRule.MuteTargetsProperty | undefined);
    /**
     * The name of the AlarmMuteRule.
     */
    get name(): string | undefined;
     ...
     * The rule for the mute.
     */
    get rule(): cdk.IResolvable | CfnAlarmMuteRule.RuleProperty;
    /**
     * The rule for the mute.
     */
    set rule(value: cdk.IResolvable | CfnAlarmMuteRule.RuleProperty);
    /**
     * The date, with the same timezone offset as "ScheduleTimezone", after which the alarm mute rule will become active.
     */
...
export declare namespace CfnAlarmMuteRule {
    /**
     * The rule for the mute.
     *
     * @struct
    ...
    interface RuleProperty {
         ...
         */
        readonly schedule: cdk.IResolvable | CfnAlarmMuteRule.ScheduleProperty;
    }
    /**
     * Schedule for the mute to be active.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-alarmmuterule.html
 */
export interface CfnAlarmMuteRuleProps {
    /**
     * The description of the AlarmMuteRule.
     *
     ...
     */
    readonly muteTargets?: cdk.IResolvable | CfnAlarmMuteRule.MuteTargetsProperty;
    /**
     * The name of the AlarmMuteRule.
     *
     ...
     */
    readonly rule: cdk.IResolvable | CfnAlarmMuteRule.RuleProperty;
    /**
     * The date, with the same timezone offset as "ScheduleTimezone", after which the alarm mute rule will become active.
     *
 ...
 */
export declare class CfnLogAlarm extends cdk.CfnResource implements cdk.IInspectable, ILogAlarmRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLogAlarm from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLogAlarm;
    /**
     * Checks whether the given object is a CfnLogAlarm
     */
    static isCfnLogAlarm(x: any): x is CfnLogAlarm;
    static arnForLogAlarm(resource: ILogAlarmRef): string;
    /**
     * The number of log lines to include in alarm notifications.
     */
    private _actionLogLineCount?;
    /**
     * The ARN of the IAM role that grants CloudWatch permissions to fetch log lines for alarm notifications.
     */
    private _actionLogLineRoleArn?;
    /**
     * Indicates whether actions should be executed during any changes to the alarm state.
     */
    private _actionsEnabled?;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLogAlarmProps);
    get logAlarmRef(): LogAlarmReference;
    /**
     * The number of log lines to include in alarm notifications.
     */
    get actionLogLineCount(): number | undefined;
    /**
     * The number of log lines to include in alarm notifications.
     */
    set actionLogLineCount(value: number | undefined);
    /**
     * The ARN of the IAM role that grants CloudWatch permissions to fetch log lines for alarm notifications.
     */
    get actionLogLineRoleArn(): string | undefined;
    /**
     * The ARN of the IAM role that grants CloudWatch permissions to fetch log lines for alarm notifications.
     */
    set actionLogLineRoleArn(value: string | undefined);
    /**
     * Indicates whether actions should be executed during any changes to the alarm state.
     */
    get actionsEnabled(): boolean | cdk.IResolvable | undefined;
     ...
     * The number of query results that must be breaching to trigger the alarm.
     */
    get queryResultsToAlarm(): number;
    /**
     * The number of query results that must be breaching to trigger the alarm.
     */
    set queryResultsToAlarm(value: number);
    /**
     * The number of query results over which data is compared to the specified threshold.
     */
    get queryResultsToEvaluate(): number;
    /**
     * The number of query results over which data is compared to the specified threshold.
     */
    set queryResultsToEvaluate(value: number);
    /**
     * The scheduled query configuration for the log alarm.
     */
    get scheduledQueryConfiguration(): cdk.IResolvable | CfnLogAlarm.ScheduledQueryConfigurationProperty;
    /**
     * The scheduled query configuration for the log alarm.
     */
    set scheduledQueryConfiguration(value: cdk.IResolvable | CfnLogAlarm.ScheduledQueryConfigurationProperty);
    /**
     * A list of key-value pairs to associate with the log alarm.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnLogAlarm {
    /**
     * The scheduled query configuration for the log alarm.
     *
     * @struct
    ...
    interface ScheduledQueryConfigurationProperty {
         ...
         */
        readonly logGroupIdentifiers: Array<string>;
        /**
         ...
         */
        readonly scheduleConfiguration: cdk.IResolvable | CfnLogAlarm.ScheduleConfigurationProperty;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-logalarm.html
 */
export interface CfnLogAlarmProps {
    /**
     * The number of log lines to include in alarm notifications.
     *
     ...
     */
    readonly scheduledQueryConfiguration: cdk.IResolvable | CfnLogAlarm.ScheduledQueryConfigurationProperty;
    /**
     * A list of key-value pairs to associate with the log alarm.
     *
 ...
 */
export declare class CfnOTelEnrichment extends cdk.CfnResource implements cdk.IInspectable, IOTelEnrichmentRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnOTelEnrichment from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnOTelEnrichment;
    /**
     * Checks whether the given object is a CfnOTelEnrichment
     */
    static isCfnOTelEnrichment(x: any): x is CfnOTelEnrichment;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnOTelEnrichmentProps);
    get oTelEnrichmentRef(): OTelEnrichmentReference;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-otelenrichment.html
 */
export interface CfnOTelEnrichmentProps {
}
export type { IAlarmRef, AlarmReference };
export type { IAnomalyDetectorRef, AnomalyDetectorReference };
export type { ICompositeAlarmRef, CompositeAlarmReference };
export type { IDashboardRef, DashboardReference };
export type { IInsightRuleRef, InsightRuleReference };
export type { IMetricStreamRef, MetricStreamReference };
export type { IAlarmMuteRuleRef, AlarmMuteRuleReference };
export type { ILogAlarmRef, LogAlarmReference };
export type { IOTelEnrichmentRef, OTelEnrichmentReference };
