...
import { BrokerReference, ConfigurationAssociationReference, ConfigurationReference, IBrokerRef, IConfigurationAssociationRef, IConfigurationRef } from "../../interfaces/generated/aws-amazonmq-interfaces.generated";
/**
...
export declare class CfnBroker extends cdk.CfnResource implements cdk.IInspectable, IBrokerRef, cdk.ITaggable {
     ...
     */
    static isCfnBroker(x: any): x is CfnBroker;
    static arnForBroker(resource: IBrokerRef): string;
    /**
     * Optional.
     */
     ...
     * Optional.
     */
    get authenticationStrategy(): string | undefined;
    /**
     * Optional.
     */
    set authenticationStrategy(value: string | undefined);
    /**
     * Enables automatic upgrades to new patch versions for brokers as new versions are released and supported by Amazon MQ.
     */
     ...
     * A list of information about the configuration.
     */
    get configuration(): CfnBroker.ConfigurationIdProperty | cdk.IResolvable | undefined;
    /**
     * A list of information about the configuration.
     */
    set configuration(value: CfnBroker.ConfigurationIdProperty | cdk.IResolvable | undefined);
    /**
     * Defines whether this broker is a part of a data replication pair.
     */
    get dataReplicationMode(): string | undefined;
    /**
     * Defines whether this broker is a part of a data replication pair.
     */
    set dataReplicationMode(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the primary broker that is used to replicate data from in a data replication pair, and is applied to the replica broker.
     */
    get dataReplicationPrimaryBrokerArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the primary broker that is used to replicate data from in a data replication pair, and is applied to the replica broker.
     */
    set dataReplicationPrimaryBrokerArn(value: string | undefined);
    /**
     * Required.
     */
     ...
     * Encryption options for the broker.
     */
    get encryptionOptions(): CfnBroker.EncryptionOptionsProperty | cdk.IResolvable | undefined;
    /**
     * Encryption options for the broker.
     */
    set encryptionOptions(value: CfnBroker.EncryptionOptionsProperty | cdk.IResolvable | undefined);
    /**
     * Required.
     */
     ...
     * Optional.
     */
    get ldapServerMetadata(): cdk.IResolvable | CfnBroker.LdapServerMetadataProperty | undefined;
    /**
     * Optional.
     */
    set ldapServerMetadata(value: cdk.IResolvable | CfnBroker.LdapServerMetadataProperty | undefined);
    /**
     * Enables Amazon CloudWatch logging for brokers.
     */
    get logs(): cdk.IResolvable | CfnBroker.LogListProperty | undefined;
    /**
     * Enables Amazon CloudWatch logging for brokers.
     */
    set logs(value: cdk.IResolvable | CfnBroker.LogListProperty | undefined);
    /**
     * The parameters that determine the WeeklyStartTime.
     */
    get maintenanceWindowStartTime(): cdk.IResolvable | CfnBroker.MaintenanceWindowProperty | undefined;
    /**
     * The parameters that determine the WeeklyStartTime.
     */
    set maintenanceWindowStartTime(value: cdk.IResolvable | CfnBroker.MaintenanceWindowProperty | undefined);
    /**
     * Enables connections from applications outside of the VPC that hosts the broker's subnets.
     */
    get publiclyAccessible(): boolean | cdk.IResolvable;
    /**
     * Enables connections from applications outside of the VPC that hosts the broker's subnets.
     */
    set publiclyAccessible(value: boolean | cdk.IResolvable);
    /**
     * The ARNs of the resource shares to be associated with the broker.
     */
    get resourceShareArns(): Array<string> | undefined;
    /**
     * The ARNs of the resource shares to be associated with the broker.
     */
    set resourceShareArns(value: Array<string> | undefined);
    /**
     * The list of rules (1 minimum, 125 maximum) that authorize connections to brokers.
     */
     ...
     * Create tags when creating the broker.
     */
    get tagsRaw(): Array<CfnBroker.TagsEntryProperty> | undefined;
    /**
     * Create tags when creating the broker.
     */
    set tagsRaw(value: Array<CfnBroker.TagsEntryProperty> | undefined);
    /**
     * The list of broker users (persons or applications) who can access queues and topics.
     */
    get users(): Array<cdk.IResolvable | CfnBroker.UserProperty> | cdk.IResolvable | undefined;
    /**
     * The list of broker users (persons or applications) who can access queues and topics.
     */
    set users(value: Array<cdk.IResolvable | CfnBroker.UserProperty> | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrAmqpEndpoints(): Array<string>;
    /**
     ...
     */
    get attrConfigurationId(): string;
    /**
     ...
     */
    get attrConfigurationRevision(): number;
    /**
     * @cloudformationAttribute ConsoleURLs
     */
    get attrConsoleUrLs(): Array<string>;
    /**
     ...
     */
    get attrEngineVersionCurrent(): string;
    /**
     ...
     */
    get attrIpAddresses(): Array<string>;
    /**
     ...
     */
    get attrMqttEndpoints(): Array<string>;
    /**
     ...
     */
    get attrOpenWireEndpoints(): Array<string>;
    /**
     ...
     */
    get attrStompEndpoints(): Array<string>;
    /**
     ...
     */
    get attrWssEndpoints(): Array<string>;
...
export interface CfnBrokerProps {
     ...
     */
    readonly resourceShareArns?: Array<string>;
    /**
     * The list of rules (1 minimum, 125 maximum) that authorize connections to brokers.
     *
...
export declare class CfnConfiguration extends cdk.CfnResource implements cdk.IInspectable, IConfigurationRef, cdk.ITaggable {
     ...
     */
    static fromConfigurationArn(scope: constructs.Construct, id: string, arn: string): IConfigurationRef;
    /**
     * Creates a new IConfigurationRef from a configurationId
     */
    static fromConfigurationId(scope: constructs.Construct, id: string, configurationId: string): IConfigurationRef;
     ...
     * Create tags when creating the configuration.
     */
    get tagsRaw(): Array<CfnConfiguration.TagsEntryProperty> | undefined;
    /**
     * Create tags when creating the configuration.
     */
    set tagsRaw(value: Array<CfnConfiguration.TagsEntryProperty> | undefined);
    /**
...
export declare class CfnConfigurationAssociation extends cdk.CfnResource implements cdk.IInspectable, IConfigurationAssociationRef {
     ...
     */
    static isCfnConfigurationAssociation(x: any): x is CfnConfigurationAssociation;
    /**
     ...
     * Returns information about all configurations.
     */
    get configuration(): CfnConfigurationAssociation.ConfigurationIdProperty | cdk.IResolvable;
    /**
     * Returns information about all configurations.
     */
    set configuration(value: CfnConfigurationAssociation.ConfigurationIdProperty | cdk.IResolvable);
    /**
...
export type { IBrokerRef, BrokerReference };
export type { IConfigurationRef, ConfigurationReference };
export type { IConfigurationAssociationRef, ConfigurationAssociationReference };
