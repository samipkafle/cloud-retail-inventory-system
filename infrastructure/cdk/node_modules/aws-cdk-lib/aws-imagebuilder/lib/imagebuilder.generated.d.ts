...
export declare class CfnComponent extends cdk.CfnResource implements cdk.IInspectable, IComponentRef, cdk.ITaggable {
    ...
    static arnForComponent(resource: IComponentRef): string;
    /**
     ...
     * The change description of the component.
     */
    set changeDescription(value: string | undefined);
    /**
     * Component `data` contains inline YAML document content for the component.
     */
     ...
     * The operating system (OS) version supported by the component.
     */
    get supportedOsVersions(): Array<string> | undefined;
    /**
     * The operating system (OS) version supported by the component.
     */
    set supportedOsVersions(value: Array<string> | undefined);
    /**
     * The tags that apply to the component.
     */
     ...
     */
    get attrEncrypted(): cdk.IResolvable;
    /**
     ...
     */
    get attrLatestVersionMajor(): string;
    /**
     ...
     */
    get attrLatestVersionMinor(): string;
    /**
     ...
     */
    get attrLatestVersionPatch(): string;
    /**
...
export declare class CfnContainerRecipe extends cdk.CfnResource implements cdk.IInspectable, IContainerRecipeRef, cdk.ITaggable {
    ...
    static arnForContainerRecipe(resource: IContainerRecipeRef): string;
    /**
     ...
     * Build and test components that are included in the container recipe.
     */
    get components(): Array<CfnContainerRecipe.ComponentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Build and test components that are included in the container recipe.
     */
    set components(value: Array<CfnContainerRecipe.ComponentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the type of container, such as Docker.
     */
     ...
     * Dockerfiles are text documents that are used to build Docker containers, and ensure that they contain all of the elements required by the application running inside.
     */
    get dockerfileTemplateData(): string | undefined;
    /**
     * Dockerfiles are text documents that are used to build Docker containers, and ensure that they contain all of the elements required by the application running inside.
     */
    set dockerfileTemplateData(value: string | undefined);
    /**
     * The S3 URI for the Dockerfile that will be used to build your container image.
     */
    get dockerfileTemplateUri(): string | undefined;
    /**
     * The S3 URI for the Dockerfile that will be used to build your container image.
     */
    set dockerfileTemplateUri(value: string | undefined);
    /**
     * Specifies the operating system version for the base image.
     */
    get imageOsVersionOverride(): string | undefined;
    /**
     * Specifies the operating system version for the base image.
     */
    set imageOsVersionOverride(value: string | undefined);
    /**
     * A group of options that can be used to configure an instance for building and testing container images.
     */
    get instanceConfiguration(): CfnContainerRecipe.InstanceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * A group of options that can be used to configure an instance for building and testing container images.
     */
    set instanceConfiguration(value: CfnContainerRecipe.InstanceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) that uniquely identifies which KMS key is used to encrypt the container image for distribution to the target Region.
     */
    get kmsKeyId(): string | undefined;
     ...
     * Specifies the operating system platform when you use a custom base image.
     */
    get platformOverride(): string | undefined;
    /**
     * Specifies the operating system platform when you use a custom base image.
     */
    set platformOverride(value: string | undefined);
    /**
     * Tags that are attached to the container recipe.
     */
    get tagsRaw(): Record<string, string> | undefined;
     ...
     * The destination repository for the container image.
     */
    get targetRepository(): cdk.IResolvable | CfnContainerRecipe.TargetContainerRepositoryProperty;
    /**
     * The destination repository for the container image.
     */
    set targetRepository(value: cdk.IResolvable | CfnContainerRecipe.TargetContainerRepositoryProperty);
    /**
     * The semantic version of the container recipe. This version follows the semantic version syntax.
     */
    get version(): string;
...
export declare class CfnDistributionConfiguration extends cdk.CfnResource implements cdk.IInspectable, IDistributionConfigurationRef, cdk.ITaggable {
     ...
     */
    static isCfnDistributionConfiguration(x: any): x is CfnDistributionConfiguration;
    static arnForDistributionConfiguration(resource: IDistributionConfigurationRef): string;
    /**
     ...
     * The distributions of this distribution configuration formatted as an array of Distribution objects.
     */
    get distributions(): Array<CfnDistributionConfiguration.DistributionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The distributions of this distribution configuration formatted as an array of Distribution objects.
     */
    set distributions(value: Array<CfnDistributionConfiguration.DistributionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of this distribution configuration.
     */
    get name(): string;
...
export declare class CfnImage extends cdk.CfnResource implements cdk.IInspectable, IImageRef, cdk.ITaggable {
     ...
     */
    private _imagePipelineExecutionSettings?;
    /**
     ...
     * The Amazon Resource Name (ARN) of the container recipe that defines how images are configured and tested.
     */
    get containerRecipeArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the container recipe that defines how images are configured and tested.
     */
    set containerRecipeArn(value: string | undefined);
    /**
     * Enables deletion of underlying resources of an image when it is replaced or deleted, including its Amazon Machine Images (AMIs), snapshots, or containers.
     */
    get deletionSettings(): CfnImage.DeletionSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Enables deletion of underlying resources of an image when it is replaced or deleted, including its Amazon Machine Images (AMIs), snapshots, or containers.
     */
    set deletionSettings(value: CfnImage.DeletionSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the distribution configuration that defines and configures the outputs of your pipeline.
     */
    get distributionConfigurationArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the distribution configuration that defines and configures the outputs of your pipeline.
     */
    set distributionConfigurationArn(value: string | undefined);
    /**
     * Collects additional information about the image being created, including the operating system (OS) version and package list.
     */
    get enhancedImageMetadataEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Collects additional information about the image being created, including the operating system (OS) version and package list.
     */
    set enhancedImageMetadataEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name or Amazon Resource Name (ARN) for the IAM role you create that grants Image Builder access to perform workflow actions.
     */
    get executionRole(): string | undefined;
    /**
     * The name or Amazon Resource Name (ARN) for the IAM role you create that grants Image Builder access to perform workflow actions.
     */
    set executionRole(value: string | undefined);
    /**
     * The image pipeline execution settings of the image.
     */
    get imagePipelineExecutionSettings(): CfnImage.ImagePipelineExecutionSettingsProperty | cdk.IResolvable | undefined;
    /**
     * The image pipeline execution settings of the image.
     */
    set imagePipelineExecutionSettings(value: CfnImage.ImagePipelineExecutionSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the image recipe that defines how images are configured, tested, and assessed.
     */
    get imageRecipeArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the image recipe that defines how images are configured, tested, and assessed.
     */
    set imageRecipeArn(value: string | undefined);
    /**
     * Contains settings for vulnerability scans.
     */
    get imageScanningConfiguration(): CfnImage.ImageScanningConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Contains settings for vulnerability scans.
     */
    set imageScanningConfiguration(value: CfnImage.ImageScanningConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The image tests configuration of the image.
     */
    get imageTestsConfiguration(): CfnImage.ImageTestsConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The image tests configuration of the image.
     */
    set imageTestsConfiguration(value: CfnImage.ImageTestsConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the infrastructure configuration that defines the environment in which your image will be built and tested.
     */
    get infrastructureConfigurationArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the infrastructure configuration that defines the environment in which your image will be built and tested.
     */
    set infrastructureConfigurationArn(value: string | undefined);
    /**
     * The logging configuration that's defined for the image.
     */
    get loggingConfiguration(): CfnImage.ImageLoggingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The logging configuration that's defined for the image.
     */
    set loggingConfiguration(value: CfnImage.ImageLoggingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The tags of the image.
     */
    get tagsRaw(): Record<string, string> | undefined;
     ...
     * Contains an array of workflow configuration objects.
     */
    get workflows(): Array<cdk.IResolvable | CfnImage.WorkflowConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * Contains an array of workflow configuration objects.
     */
    set workflows(value: Array<cdk.IResolvable | CfnImage.WorkflowConfigurationProperty> | cdk.IResolvable | undefined);
    /**
...
export declare namespace CfnImage {
    ...
    interface ImagePipelineExecutionSettingsProperty {
         ...
         */
        readonly onUpdate?: boolean | cdk.IResolvable;
    }
    /**
...
export interface CfnImageProps {
     ...
     */
    readonly deletionSettings?: CfnImage.DeletionSettingsProperty | cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the distribution configuration that defines and configures the outputs of your pipeline.
     *
     ...
     */
    readonly distributionConfigurationArn?: imageBuilderRefs.IDistributionConfigurationRef | string;
    /**
     * Collects additional information about the image being created, including the operating system (OS) version and package list.
     *
     ...
     */
    readonly imagePipelineExecutionSettings?: CfnImage.ImagePipelineExecutionSettingsProperty | cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the image recipe that defines how images are configured, tested, and assessed.
     *
     ...
     */
    readonly imageRecipeArn?: imageBuilderRefs.IImageRecipeRef | string;
    /**
     * Contains settings for vulnerability scans.
     *
     ...
     */
    readonly infrastructureConfigurationArn?: imageBuilderRefs.IInfrastructureConfigurationRef | string;
    /**
     * The logging configuration that's defined for the image.
     *
     * Image Builder uses the defined settings to direct execution log output during image creation.
     ...
     */
    readonly loggingConfiguration?: CfnImage.ImageLoggingConfigurationProperty | cdk.IResolvable;
    /**
     * The tags of the image.
     *
...
export declare class CfnImagePipeline extends cdk.CfnResource implements cdk.IInspectable, IImagePipelineRef, cdk.ITaggable {
     ...
     */
    static isCfnImagePipeline(x: any): x is CfnImagePipeline;
    static arnForImagePipeline(resource: IImagePipelineRef): string;
    /**
     ...
     * Contains settings for vulnerability scans.
     */
    get imageScanningConfiguration(): CfnImagePipeline.ImageScanningConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Contains settings for vulnerability scans.
     */
    set imageScanningConfiguration(value: CfnImagePipeline.ImageScanningConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The tags to be applied to images created by this pipeline.
     */
    get imageTags(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * The tags to be applied to images created by this pipeline.
     */
    set imageTags(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The configuration of the image tests that run after image creation to ensure the quality of the image that was created.
     */
    get imageTestsConfiguration(): CfnImagePipeline.ImageTestsConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration of the image tests that run after image creation to ensure the quality of the image that was created.
     */
    set imageTestsConfiguration(value: CfnImagePipeline.ImageTestsConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the infrastructure configuration associated with this image pipeline.
     */
     ...
     * Defines logging configuration for the output image.
     */
    get loggingConfiguration(): cdk.IResolvable | CfnImagePipeline.PipelineLoggingConfigurationProperty | undefined;
    /**
     * Defines logging configuration for the output image.
     */
    set loggingConfiguration(value: cdk.IResolvable | CfnImagePipeline.PipelineLoggingConfigurationProperty | undefined);
    /**
     * The name of the image pipeline.
     */
    get name(): string;
     ...
     * The schedule of the image pipeline.
     */
    get schedule(): cdk.IResolvable | CfnImagePipeline.ScheduleProperty | undefined;
    /**
     * The schedule of the image pipeline.
     */
    set schedule(value: cdk.IResolvable | CfnImagePipeline.ScheduleProperty | undefined);
    /**
     * The status of the image pipeline.
     */
     ...
     * Contains the workflows that run for the image pipeline.
     */
    get workflows(): Array<cdk.IResolvable | CfnImagePipeline.WorkflowConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * Contains the workflows that run for the image pipeline.
     */
    set workflows(value: Array<cdk.IResolvable | CfnImagePipeline.WorkflowConfigurationProperty> | cdk.IResolvable | undefined);
    /**
...
export declare namespace CfnImagePipeline {
    ...
    interface ScheduleProperty {
         ...
         */
        readonly autoDisablePolicy?: CfnImagePipeline.AutoDisablePolicyProperty | cdk.IResolvable;
        /**
...
export interface CfnImagePipelineProps {
     ...
     */
    readonly containerRecipeArn?: imageBuilderRefs.IContainerRecipeRef | string;
    /**
     * The description of this image pipeline.
     *
     ...
     */
    readonly imageTags?: cdk.IResolvable | Record<string, string>;
    /**
     * The configuration of the image tests that run after image creation to ensure the quality of the image that was created.
     *
     ...
     */
    readonly loggingConfiguration?: cdk.IResolvable | CfnImagePipeline.PipelineLoggingConfigurationProperty;
    /**
     * The name of the image pipeline.
     *
...
export declare class CfnImageRecipe extends cdk.CfnResource implements cdk.IInspectable, IImageRecipeRef, cdk.ITaggable {
     ...
     */
    static isCfnImageRecipe(x: any): x is CfnImageRecipe;
    static arnForImageRecipe(resource: IImageRecipeRef): string;
    /**
     ...
     * Before you create a new AMI, Image Builder launches temporary Amazon EC2 instances to build and test your image configuration.
     */
    get additionalInstanceConfiguration(): CfnImageRecipe.AdditionalInstanceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Before you create a new AMI, Image Builder launches temporary Amazon EC2 instances to build and test your image configuration.
     */
    set additionalInstanceConfiguration(value: CfnImageRecipe.AdditionalInstanceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Tags that are applied to the AMI that Image Builder creates during the Build phase prior to image distribution.
     */
    get amiTags(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Tags that are applied to the AMI that Image Builder creates during the Build phase prior to image distribution.
     */
    set amiTags(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The AMI watermark names to attach to the output AMI from this recipe.
     */
    get amiWatermarks(): Array<string> | undefined;
    /**
     * The AMI watermark names to attach to the output AMI from this recipe.
     */
    set amiWatermarks(value: Array<string> | undefined);
    /**
     * The block device mappings to apply when creating images from this recipe.
     */
    get blockDeviceMappings(): Array<CfnImageRecipe.InstanceBlockDeviceMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The block device mappings to apply when creating images from this recipe.
     */
    set blockDeviceMappings(value: Array<CfnImageRecipe.InstanceBlockDeviceMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The components that are included in the image recipe.
     */
    get components(): Array<CfnImageRecipe.ComponentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The components that are included in the image recipe.
     */
    set components(value: Array<CfnImageRecipe.ComponentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of the image recipe.
     */
    get description(): string | undefined;
...
export interface CfnImageRecipeProps {
     ...
     */
    readonly amiWatermarks?: Array<string>;
    /**
     * The block device mappings to apply when creating images from this recipe.
     *
...
export declare class CfnInfrastructureConfiguration extends cdk.CfnResource implements cdk.IInspectable, IInfrastructureConfigurationRef, cdk.ITaggable {
     ...
     */
    static isCfnInfrastructureConfiguration(x: any): x is CfnInfrastructureConfiguration;
    static arnForInfrastructureConfiguration(resource: IInfrastructureConfigurationRef): string;
    /**
     ...
     * The instance metadata options that you can set for the HTTP requests that pipeline builds use to launch EC2 build and test instances.
     */
    get instanceMetadataOptions(): CfnInfrastructureConfiguration.InstanceMetadataOptionsProperty | cdk.IResolvable | undefined;
    /**
     * The instance metadata options that you can set for the HTTP requests that pipeline builds use to launch EC2 build and test instances.
     */
    set instanceMetadataOptions(value: CfnInfrastructureConfiguration.InstanceMetadataOptionsProperty | cdk.IResolvable | undefined);
    /**
     * The instance profile to associate with the instance used to customize your Amazon EC2 AMI.
     */
     ...
     * The instance types of the infrastructure configuration.
     */
    get instanceTypes(): Array<string> | undefined;
    /**
     * The instance types of the infrastructure configuration.
     */
    set instanceTypes(value: Array<string> | undefined);
    /**
     * The key pair of the infrastructure configuration.
     */
     ...
     * The logging configuration of the infrastructure configuration.
     */
    get logging(): cdk.IResolvable | CfnInfrastructureConfiguration.LoggingProperty | undefined;
    /**
     * The logging configuration of the infrastructure configuration.
     */
    set logging(value: cdk.IResolvable | CfnInfrastructureConfiguration.LoggingProperty | undefined);
    /**
     * The name of the infrastructure configuration.
     */
    get name(): string;
     ...
     * The instance placement settings that define where the instances that are launched from your image will run.
     */
    get placement(): cdk.IResolvable | CfnInfrastructureConfiguration.PlacementProperty | undefined;
    /**
     * The instance placement settings that define where the instances that are launched from your image will run.
     */
    set placement(value: cdk.IResolvable | CfnInfrastructureConfiguration.PlacementProperty | undefined);
    /**
     * The metadata tags to assign to the Amazon EC2 instance that Image Builder launches during the build process.
     */
    get resourceTags(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * The metadata tags to assign to the Amazon EC2 instance that Image Builder launches during the build process.
     */
    set resourceTags(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The security group IDs to associate with the instance used to customize your Amazon EC2 AMI.
     */
     ...
     * The terminate instance on failure setting of the infrastructure configuration.
     */
    get terminateInstanceOnFailure(): boolean | cdk.IResolvable | undefined;
    /**
     * The terminate instance on failure setting of the infrastructure configuration.
     */
    set terminateInstanceOnFailure(value: boolean | cdk.IResolvable | undefined);
    /**
...
export interface CfnInfrastructureConfigurationProps {
     ...
     */
    readonly instanceProfileName: iamRefs.IInstanceProfileRef | string;
    /**
     * The instance types of the infrastructure configuration.
     *
...
export declare class CfnLifecyclePolicy extends cdk.CfnResource implements cdk.IInspectable, ILifecyclePolicyRef, cdk.ITaggableV2 {
    ...
    static arnForLifecyclePolicy(resource: ILifecyclePolicyRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * Configuration details for the lifecycle policy rules.
     */
    get policyDetails(): Array<cdk.IResolvable | CfnLifecyclePolicy.PolicyDetailProperty> | cdk.IResolvable;
    /**
     * Configuration details for the lifecycle policy rules.
     */
    set policyDetails(value: Array<cdk.IResolvable | CfnLifecyclePolicy.PolicyDetailProperty> | cdk.IResolvable);
    /**
     * Selection criteria for the resources that the lifecycle policy applies to.
     */
    get resourceSelection(): cdk.IResolvable | CfnLifecyclePolicy.ResourceSelectionProperty;
    /**
     * Selection criteria for the resources that the lifecycle policy applies to.
     */
    set resourceSelection(value: cdk.IResolvable | CfnLifecyclePolicy.ResourceSelectionProperty);
    /**
     * The type of Image Builder resource that the lifecycle policy applies to.
     */
...
export type { IContainerRecipeRef, ContainerRecipeReference };
export type { IDistributionConfigurationRef, DistributionConfigurationReference };
export type { IImageRef, ImageReference };
export type { IImagePipelineRef, ImagePipelineReference };
export type { IImageRecipeRef, ImageRecipeReference };
export type { IInfrastructureConfigurationRef, InfrastructureConfigurationReference };
