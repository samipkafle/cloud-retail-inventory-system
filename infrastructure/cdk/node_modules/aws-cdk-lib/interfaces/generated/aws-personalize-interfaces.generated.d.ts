 ...
 * @stability experimental
 */
export interface IDataDeletionJobRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a DataDeletionJob resource.
     */
    readonly dataDeletionJobRef: DataDeletionJobReference;
}
/**
 * A reference to a DataDeletionJob resource.
 *
 ...
 * @stability external
 */
export interface DataDeletionJobReference {
    /**
     * The Id of the DataDeletionJob resource.
     */
    readonly dataDeletionJobId: string;
    /**
