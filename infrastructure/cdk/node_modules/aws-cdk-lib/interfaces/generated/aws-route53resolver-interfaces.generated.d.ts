 ...
 * @stability experimental
 */
export interface IFirewallConfigRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a FirewallConfig resource.
     */
    readonly firewallConfigRef: FirewallConfigReference;
}
/**
 * A reference to a FirewallConfig resource.
 *
 ...
 * @stability external
 */
export interface FirewallConfigReference {
    /**
     * The Id of the FirewallConfig resource.
     */
    readonly firewallConfigId: string;
    /**
     * The ARN of the FirewallConfig resource.
     */
    readonly firewallConfigArn: string;
}
