 ...
 * @stability experimental
 */
export interface IReservedDBInstanceRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ReservedDBInstance resource.
     */
    readonly reservedDbInstanceRef: ReservedDBInstanceReference;
}
/**
 * A reference to a ReservedDBInstance resource.
 *
 ...
 * @stability external
 */
export interface ReservedDBInstanceReference {
    /**
