 ...
 * @stability experimental
 */
export interface IBrowserRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a Browser resource.
     */
    readonly browserRef: BrowserReference;
}
/**
 * A reference to a Browser resource.
 *
 ...
 * @stability experimental
 */
export interface IConfigurationBundleRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ConfigurationBundle resource.
     */
    readonly configurationBundleRef: ConfigurationBundleReference;
}
/**
 * A reference to a ConfigurationBundle resource.
 *
 ...
 * @stability experimental
 */
export interface IHarnessRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a Harness resource.
     */
    readonly harnessRef: HarnessReference;
}
/**
 * A reference to a Harness resource.
 *
 ...
 * @stability experimental
 */
export interface IPaymentConnectorRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PaymentConnector resource.
     */
    readonly paymentConnectorRef: PaymentConnectorReference;
}
/**
 * A reference to a PaymentConnector resource.
 *
 ...
 * @stability external
 */
export interface PaymentConnectorReference {
    /**
...
/**
 * Indicates that this resource can be referenced as a PaymentCredentialProvider.
 *
 * @stability experimental
 */
export interface IPaymentCredentialProviderRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PaymentCredentialProvider resource.
     */
    readonly paymentCredentialProviderRef: PaymentCredentialProviderReference;
}
/**
 * A reference to a PaymentCredentialProvider resource.
 *
 ...
 * @stability external
 */
export interface PaymentCredentialProviderReference {
    /**
...
/**
 * Indicates that this resource can be referenced as a PaymentManager.
 *
 * @stability experimental
 */
export interface IPaymentManagerRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PaymentManager resource.
     */
    readonly paymentManagerRef: PaymentManagerReference;
}
/**
 * A reference to a PaymentManager resource.
 *
 ...
 * @stability external
 */
export interface PaymentManagerReference {
    /**
