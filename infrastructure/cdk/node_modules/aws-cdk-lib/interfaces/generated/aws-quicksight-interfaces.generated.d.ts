 ...
 * @stability experimental
 */
export interface IOAuthClientApplicationRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a OAuthClientApplication resource.
     */
    readonly oAuthClientApplicationRef: OAuthClientApplicationReference;
}
/**
 * A reference to a OAuthClientApplication resource.
 *
 ...
 * @stability external
 */
export interface OAuthClientApplicationReference {
    /**
     * The Arn of the OAuthClientApplication resource.
     */
    readonly oAuthClientApplicationArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IAssetBundleExportJobRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a AssetBundleExportJob resource.
     */
    readonly assetBundleExportJobRef: AssetBundleExportJobReference;
}
/**
 * A reference to a AssetBundleExportJob resource.
 *
 ...
 * @stability external
 */
export interface AssetBundleExportJobReference {
    /**
     * The AssetBundleExportJobId of the AssetBundleExportJob resource.
     */
    readonly assetBundleExportJobId: string;
    /**
     * The ARN of the AssetBundleExportJob resource.
     */
    readonly assetBundleExportJobArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IAssetBundleImportJobRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a AssetBundleImportJob resource.
     */
    readonly assetBundleImportJobRef: AssetBundleImportJobReference;
}
/**
 * A reference to a AssetBundleImportJob resource.
 *
 ...
 * @stability external
 */
export interface AssetBundleImportJobReference {
    /**
     * The AssetBundleImportJobId of the AssetBundleImportJob resource.
     */
    readonly assetBundleImportJobId: string;
    /**
     * The ARN of the AssetBundleImportJob resource.
     */
    readonly assetBundleImportJobArn: string;
}
