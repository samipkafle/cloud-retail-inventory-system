...
import { FirewallConfigReference, FirewallDomainListReference, FirewallRuleGroupAssociationReference, FirewallRuleGroupReference, IFirewallConfigRef, IFirewallDomainListRef, IFirewallRuleGroupAssociationRef, IFirewallRuleGroupRef, IOutpostResolverRef, IResolverConfigRef, IResolverDNSSECConfigRef, IResolverEndpointRef, IResolverQueryLoggingConfigAssociationRef, IResolverQueryLoggingConfigRef, IResolverRuleAssociationRef, IResolverRuleRef, OutpostResolverReference, ResolverConfigReference, ResolverDNSSECConfigReference, ResolverEndpointReference, ResolverQueryLoggingConfigAssociationReference, ResolverQueryLoggingConfigReference, ResolverRuleAssociationReference, ResolverRuleReference } from "../../interfaces/generated/aws-route53resolver-interfaces.generated";
import { aws_ec2 as ec2Refs, aws_logs as logsRefs, aws_route53resolver as route53ResolverRefs, aws_s3 as s3Refs } from "../../interfaces";
/**
...
export declare class CfnFirewallDomainList extends cdk.CfnResource implements cdk.IInspectable, IFirewallDomainListRef, cdk.ITaggable {
     ...
     */
    get attrCreatorRequestId(): string;
    /**
     ...
     */
    get attrManagedOwnerName(): string;
    /**
     * The date and time that the domain list was last modified, in Unix time format and Coordinated Universal Time (UTC).
     *
     * @cloudformationAttribute ModificationTime
     */
    get attrModificationTime(): string;
    /**
...
export declare class CfnFirewallRuleGroup extends cdk.CfnResource implements cdk.IInspectable, IFirewallRuleGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnFirewallRuleGroup(x: any): x is CfnFirewallRuleGroup;
    static arnForFirewallRuleGroup(resource: IFirewallRuleGroupRef): string;
    /**
     ...
     * A list of the rules that you have defined.
     */
    get firewallRules(): Array<CfnFirewallRuleGroup.FirewallRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of the rules that you have defined.
     */
    set firewallRules(value: Array<CfnFirewallRuleGroup.FirewallRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the rule group.
     */
    get name(): string | undefined;
...
export declare namespace CfnFirewallRuleGroup {
    ...
    interface FirewallRuleProperty {
         ...
         */
        readonly firewallRuleType?: CfnFirewallRuleGroup.FirewallRuleTypeProperty | cdk.IResolvable;
        /**
    ...
    interface FirewallRuleTypeProperty {
         ...
         */
        readonly firewallAdvancedContentCategory?: CfnFirewallRuleGroup.FirewallAdvancedContentCategoryConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly firewallAdvancedThreatCategory?: CfnFirewallRuleGroup.FirewallAdvancedThreatCategoryConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly partnerThreatProtection?: cdk.IResolvable | CfnFirewallRuleGroup.PartnerThreatProtectionConfigProperty;
    }
    /**
     * Configuration for a partner threat protection rule type.
     *
     ...
     */
    interface FirewallAdvancedThreatCategoryConfigProperty {
        /**
...
export declare class CfnFirewallRuleGroupAssociation extends cdk.CfnResource implements cdk.IInspectable, IFirewallRuleGroupAssociationRef, cdk.ITaggable {
     ...
     */
    static isCfnFirewallRuleGroupAssociation(x: any): x is CfnFirewallRuleGroupAssociation;
    static arnForFirewallRuleGroupAssociation(resource: IFirewallRuleGroupAssociationRef): string;
    /**
     ...
     * If enabled, this setting disallows modification or removal of the association, to help prevent against accidentally altering DNS firewall protections.
     */
    get mutationProtection(): string | undefined;
    /**
     * If enabled, this setting disallows modification or removal of the association, to help prevent against accidentally altering DNS firewall protections.
     */
    set mutationProtection(value: string | undefined);
    /**
     * The name of the association.
     */
    get name(): string | undefined;
...
export interface CfnFirewallRuleGroupAssociationProps {
     ...
     */
    readonly firewallRuleGroupId: route53ResolverRefs.IFirewallRuleGroupRef | string;
    /**
     * If enabled, this setting disallows modification or removal of the association, to help prevent against accidentally altering DNS firewall protections.
     *
...
export declare class CfnOutpostResolver extends cdk.CfnResource implements cdk.IInspectable, IOutpostResolverRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnOutpostResolver(x: any): x is CfnOutpostResolver;
    static arnForOutpostResolver(resource: IOutpostResolverRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     */
    private _preferredInstanceType;
    /**
     ...
     * The Amazon EC2 instance type.
     */
    get preferredInstanceType(): string;
    /**
     * The Amazon EC2 instance type.
     */
    set preferredInstanceType(value: string);
    /**
     * A key value pair that helps you identify a Route 53 Resolver .
     */
...
export declare class CfnResolverConfig extends cdk.CfnResource implements cdk.IInspectable, IResolverConfigRef {
     ...
     */
    static isCfnResolverConfig(x: any): x is CfnResolverConfig;
    /**
     * Creates a new IResolverConfigRef from a resourceId
     */
    static fromResourceId(scope: constructs.Construct, id: string, resourceId: string): IResolverConfigRef;
    static arnForResolverConfig(resource: IResolverConfigRef): string;
    /**
     ...
     */
    get attrAutodefinedReverse(): string;
    /**
...
export declare class CfnResolverDNSSECConfig extends cdk.CfnResource implements cdk.IInspectable, IResolverDNSSECConfigRef {
     ...
     */
    static isCfnResolverDNSSECConfig(x: any): x is CfnResolverDNSSECConfig;
    /**
     ...
     */
    get attrValidationStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnResolverEndpoint extends cdk.CfnResource implements cdk.IInspectable, IResolverEndpointRef, cdk.ITaggable {
     ...
     */
    static isCfnResolverEndpoint(x: any): x is CfnResolverEndpoint;
    static arnForResolverEndpoint(resource: IResolverEndpointRef): string;
    /**
     ...
     */
    private _ipv6InternetAccessEnabled?;
    /**
     ...
     * Specifies whether DNS64 is enabled for the Inbound Resolver Endpoint.
     */
    get dns64Enabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether DNS64 is enabled for the Inbound Resolver Endpoint.
     */
    set dns64Enabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints).
     */
    get ipAddresses(): Array<CfnResolverEndpoint.IpAddressRequestProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints).
     */
    set ipAddresses(value: Array<CfnResolverEndpoint.IpAddressRequestProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Specifies whether IPv6 Internet Gateway access is enabled through the Outbound Resolver Endpoint.
     */
    get ipv6InternetAccessEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether IPv6 Internet Gateway access is enabled through the Outbound Resolver Endpoint.
     */
    set ipv6InternetAccessEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * A friendly name that lets you easily find a configuration in the Resolver dashboard in the Route 53 console.
     */
    get name(): string | undefined;
     ...
     * The Amazon EC2 instance type.
     */
    get preferredInstanceType(): string | undefined;
    /**
     * The Amazon EC2 instance type.
     */
    set preferredInstanceType(value: string | undefined);
    /**
     * Protocols used for the endpoint. DoH-FIPS is applicable for a default inbound endpoints only.
     */
    get protocols(): Array<string> | undefined;
    /**
     * Protocols used for the endpoint. DoH-FIPS is applicable for a default inbound endpoints only.
     */
    set protocols(value: Array<string> | undefined);
    /**
     * The Resolver endpoint IP address type.
     */
    get resolverEndpointType(): string | undefined;
    /**
     * The Resolver endpoint IP address type.
     */
    set resolverEndpointType(value: string | undefined);
    /**
     * Indicates whether RNI enhanced metrics are enabled for the Resolver endpoint.
     */
    get rniEnhancedMetricsEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether RNI enhanced metrics are enabled for the Resolver endpoint.
     */
    set rniEnhancedMetricsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ID of one or more security groups that control access to this VPC.
     */
    get securityGroupIds(): Array<string>;
    /**
     * The ID of one or more security groups that control access to this VPC.
     */
    set securityGroupIds(value: Array<string>);
    /**
     * Route 53 Resolver doesn't support updating tags through CloudFormation.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Indicates whether target name server metrics are enabled for the outbound Resolver endpoint.
     */
    get targetNameServerMetricsEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether target name server metrics are enabled for the outbound Resolver endpoint.
     */
    set targetNameServerMetricsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
...
export interface CfnResolverEndpointProps {
     ...
     */
    readonly dns64Enabled?: boolean | cdk.IResolvable;
    /**
     * The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints).
     *
     ...
     */
    readonly ipv6InternetAccessEnabled?: boolean | cdk.IResolvable;
    /**
     * A friendly name that lets you easily find a configuration in the Resolver dashboard in the Route 53 console.
     *
     ...
     */
    readonly rniEnhancedMetricsEnabled?: boolean | cdk.IResolvable;
    /**
     * The ID of one or more security groups that control access to this VPC.
     *
     ...
     */
    readonly targetNameServerMetricsEnabled?: boolean | cdk.IResolvable;
}
/**
...
export declare class CfnResolverQueryLoggingConfig extends cdk.CfnResource implements cdk.IInspectable, IResolverQueryLoggingConfigRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnResolverQueryLoggingConfig(x: any): x is CfnResolverQueryLoggingConfig;
    static arnForResolverQueryLoggingConfig(resource: IResolverQueryLoggingConfigRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The ARN of the resource that you want Resolver to send query logs: an Amazon S3 bucket, a CloudWatch Logs log group, or a Kinesis Data Firehose delivery stream.
     */
    get destinationArn(): string | undefined;
    /**
     * The ARN of the resource that you want Resolver to send query logs: an Amazon S3 bucket, a CloudWatch Logs log group, or a Kinesis Data Firehose delivery stream.
     */
    set destinationArn(value: string | undefined);
    /**
     * The name of the query logging configuration.
     */
    get name(): string | undefined;
     ...
     */
    get attrAssociationCount(): number;
    /**
...
export interface CfnResolverQueryLoggingConfigProps {
     ...
     */
    readonly destinationArn?: logsRefs.ILogGroupRef | s3Refs.IBucketRef | string;
    /**
     * The name of the query logging configuration.
     *
...
export declare class CfnResolverQueryLoggingConfigAssociation extends cdk.CfnResource implements cdk.IInspectable, IResolverQueryLoggingConfigAssociationRef {
     ...
     */
    static isCfnResolverQueryLoggingConfigAssociation(x: any): x is CfnResolverQueryLoggingConfigAssociation;
    /**
     ...
     * The ID of the query logging configuration that a VPC is associated with.
     */
    get resolverQueryLogConfigId(): string | undefined;
    /**
     * The ID of the query logging configuration that a VPC is associated with.
     */
    set resolverQueryLogConfigId(value: string | undefined);
    /**
     * The ID of the Amazon VPC that is associated with the query logging configuration.
     */
    get resourceId(): string | undefined;
...
export interface CfnResolverQueryLoggingConfigAssociationProps {
     ...
     */
    readonly resolverQueryLogConfigId?: route53ResolverRefs.IResolverQueryLoggingConfigRef | string;
    /**
     * The ID of the Amazon VPC that is associated with the query logging configuration.
     *
     ...
     */
    readonly resourceId?: ec2Refs.IVPCRef | string;
}
/**
...
export declare class CfnResolverRule extends cdk.CfnResource implements cdk.IInspectable, IResolverRuleRef, cdk.ITaggable {
     ...
     */
    static isCfnResolverRule(x: any): x is CfnResolverRule;
    static arnForResolverRule(resource: IResolverRuleRef): string;
    /**
     * DNS queries with delegation records that point to this domain name are forwarded to resolvers on your network.
     */
    private _delegationRecord?;
    /**
     ...
     * DNS queries with delegation records that point to this domain name are forwarded to resolvers on your network.
     */
    get delegationRecord(): string | undefined;
    /**
     * DNS queries with delegation records that point to this domain name are forwarded to resolvers on your network.
     */
    set delegationRecord(value: string | undefined);
    /**
     * DNS queries for this domain name are forwarded to the IP addresses that are specified in `TargetIps` .
     */
     ...
     * An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to.
     */
    get targetIps(): Array<cdk.IResolvable | CfnResolverRule.TargetAddressProperty> | cdk.IResolvable | undefined;
    /**
     * An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to.
     */
    set targetIps(value: Array<cdk.IResolvable | CfnResolverRule.TargetAddressProperty> | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrTargetIps(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnResolverRuleAssociation extends cdk.CfnResource implements cdk.IInspectable, IResolverRuleAssociationRef {
     ...
     */
    static isCfnResolverRuleAssociation(x: any): x is CfnResolverRuleAssociation;
    /**
     ...
     */
    get attrResolverRuleAssociationId(): string;
    /**
...
export interface CfnResolverRuleAssociationProps {
     ...
     */
    readonly resolverRuleId: route53ResolverRefs.IResolverRuleRef | string;
    /**
     * The ID of the VPC that you associated the Resolver rule with.
     *
 ...
 */
export declare class CfnFirewallConfig extends cdk.CfnResource implements cdk.IInspectable, IFirewallConfigRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnFirewallConfig from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnFirewallConfig;
    /**
     * Checks whether the given object is a CfnFirewallConfig
     */
    static isCfnFirewallConfig(x: any): x is CfnFirewallConfig;
    static arnForFirewallConfig(resource: IFirewallConfigRef): string;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnFirewallConfigProps);
    get firewallConfigRef(): FirewallConfigReference;
    get firewallFailOpen(): string | undefined;
    set firewallFailOpen(value: string | undefined);
    get resourceId(): string | undefined;
    set resourceId(value: string | undefined);
    /**
     * @cloudformationAttribute Arn
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-firewallconfig.html
 */
export interface CfnFirewallConfigProps {
    /**
...
export type { IFirewallRuleGroupRef, FirewallRuleGroupReference };
export type { IFirewallRuleGroupAssociationRef, FirewallRuleGroupAssociationReference };
export type { IOutpostResolverRef, OutpostResolverReference };
export type { IResolverConfigRef, ResolverConfigReference };
export type { IResolverDNSSECConfigRef, ResolverDNSSECConfigReference };
export type { IResolverEndpointRef, ResolverEndpointReference };
export type { IResolverQueryLoggingConfigRef, ResolverQueryLoggingConfigReference };
export type { IResolverQueryLoggingConfigAssociationRef, ResolverQueryLoggingConfigAssociationReference };
export type { IResolverRuleRef, ResolverRuleReference };
export type { IResolverRuleAssociationRef, ResolverRuleAssociationReference };
export type { IFirewallConfigRef, FirewallConfigReference };
