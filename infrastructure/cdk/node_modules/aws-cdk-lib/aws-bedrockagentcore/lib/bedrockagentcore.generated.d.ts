...
import { ApiKeyCredentialProviderReference, BrowserCustomReference, BrowserProfileReference, BrowserReference, CodeInterpreterCustomReference, ConfigurationBundleReference, DatasetReference, EvaluatorReference, GatewayReference, GatewayTargetReference, HarnessReference, IApiKeyCredentialProviderRef, IBrowserCustomRef, IBrowserProfileRef, IBrowserRef, ICodeInterpreterCustomRef, IConfigurationBundleRef, IDatasetRef, IEvaluatorRef, IGatewayRef, IGatewayTargetRef, IHarnessRef, IMemoryRef, IOAuth2CredentialProviderRef, IOnlineEvaluationConfigRef, IPaymentConnectorRef, IPaymentCredentialProviderRef, IPaymentManagerRef, IPolicyEngineRef, IPolicyRef, IResourcePolicyRef, IRuntimeEndpointRef, IRuntimeRef, IWorkloadIdentityRef, MemoryReference, OAuth2CredentialProviderReference, OnlineEvaluationConfigReference, PaymentConnectorReference, PaymentCredentialProviderReference, PaymentManagerReference, PolicyEngineReference, PolicyReference, ResourcePolicyReference, RuntimeEndpointReference, RuntimeReference, WorkloadIdentityReference } from "../../interfaces/generated/aws-bedrockagentcore-interfaces.generated";
/**
...
export declare class CfnApiKeyCredentialProvider extends cdk.CfnResource implements cdk.IInspectable, IApiKeyCredentialProviderRef, cdk.ITaggableV2 {
     ...
     */
    private _apiKeySecretConfig?;
    /**
     * The source of the API key secret.
     */
    private _apiKeySecretSource?;
    /**
     ...
     * A reference to a customer-provided secret stored in AWS Secrets Manager.
     */
    get apiKeySecretConfig(): cdk.IResolvable | CfnApiKeyCredentialProvider.SecretReferenceProperty | undefined;
    /**
     * A reference to a customer-provided secret stored in AWS Secrets Manager.
     */
    set apiKeySecretConfig(value: cdk.IResolvable | CfnApiKeyCredentialProvider.SecretReferenceProperty | undefined);
    /**
     * The source of the API key secret.
     */
    get apiKeySecretSource(): string | undefined;
    /**
     * The source of the API key secret.
     */
    set apiKeySecretSource(value: string | undefined);
    /**
     * The name of the API key credential provider.
     */
    get name(): string;
     ...
     */
    get attrApiKeySecretJsonKey(): string;
    /**
...
export interface CfnApiKeyCredentialProviderProps {
     ...
     */
    readonly apiKeySecretConfig?: cdk.IResolvable | CfnApiKeyCredentialProvider.SecretReferenceProperty;
    /**
     * The source of the API key secret.
     *
 ...
 */
export declare class CfnConfigurationBundle extends cdk.CfnResource implements cdk.IInspectable, IConfigurationBundleRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnConfigurationBundle from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnConfigurationBundle;
    /**
     * Checks whether the given object is a CfnConfigurationBundle
     */
    static isCfnConfigurationBundle(x: any): x is CfnConfigurationBundle;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnConfigurationBundleProps);
    get configurationBundleRef(): ConfigurationBundleReference;
    /**
     * The branch name for version tracking.
     */
     ...
     * A commit message describing the version of the configuration bundle.
     */
    set commitMessage(value: string | undefined);
    /**
     * A map of component identifiers to their configurations.
     */
    get components(): cdk.IResolvable | Record<string, CfnConfigurationBundle.ComponentConfigurationProperty | cdk.IResolvable>;
    /**
     * A map of component identifiers to their configurations.
     */
    set components(value: cdk.IResolvable | Record<string, CfnConfigurationBundle.ComponentConfigurationProperty | cdk.IResolvable>);
    /**
     * The source that created a configuration bundle version.
     */
    get createdBy(): cdk.IResolvable | CfnConfigurationBundle.VersionCreatedBySourceProperty | undefined;
    /**
     * The source that created a configuration bundle version.
     */
    set createdBy(value: cdk.IResolvable | CfnConfigurationBundle.VersionCreatedBySourceProperty | undefined);
    /**
     * The description for the configuration bundle.
     */
    get description(): string | undefined;
     ...
     */
    get attrBundleArn(): string;
    /**
     * The unique identifier of the configuration bundle.
     *
     * @cloudformationAttribute BundleId
     */
    get attrBundleId(): string;
    /**
     ...
     */
    get attrLineageMetadata(): cdk.IResolvable;
    /**
...
export declare namespace CfnConfigurationBundle {
    /**
    ...
    interface VersionLineageMetadataProperty {
         ...
         */
        readonly createdBy?: cdk.IResolvable | CfnConfigurationBundle.VersionCreatedBySourceProperty;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-configurationbundle.html
 */
export interface CfnConfigurationBundleProps {
    /**
     * The branch name for version tracking.
     *
     ...
     */
    readonly components: cdk.IResolvable | Record<string, CfnConfigurationBundle.ComponentConfigurationProperty | cdk.IResolvable>;
    /**
     * The source that created a configuration bundle version.
     *
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggableV2 {
     ...
     * Source of initial examples.
     */
    get source(): CfnDataset.DataSourceTypeProperty | cdk.IResolvable | undefined;
    /**
     * Source of initial examples.
     */
    set source(value: CfnDataset.DataSourceTypeProperty | cdk.IResolvable | undefined);
    /**
     * A list of tags to assign to the dataset.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnDataset {
    ...
    interface DataSourceTypeProperty {
         ...
         */
        readonly inlineExamples?: CfnDataset.InlineExamplesSourceProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly s3Source?: cdk.IResolvable | CfnDataset.S3SourceProperty;
    }
    /**
     * Inline examples provided directly in the request body.
     *
...
export interface CfnDatasetProps {
     ...
     */
    readonly source?: CfnDataset.DataSourceTypeProperty | cdk.IResolvable;
    /**
     * A list of tags to assign to the dataset.
     *
...
export declare class CfnGateway extends cdk.CfnResource implements cdk.IInspectable, IGatewayRef, cdk.ITaggableV2 {
    ...
    private _interceptorConfigurations?;
    /**
    ...
    get authorizerConfiguration(): CfnGateway.AuthorizerConfigurationProperty | cdk.IResolvable | undefined;
    set authorizerConfiguration(value: CfnGateway.AuthorizerConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The authorizer type for the gateway.
     */
     ...
     * The exception level for the gateway.
     */
    get exceptionLevel(): string | undefined;
    /**
     * The exception level for the gateway.
     */
    set exceptionLevel(value: string | undefined);
    get interceptorConfigurations(): Array<CfnGateway.GatewayInterceptorConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    set interceptorConfigurations(value: Array<CfnGateway.GatewayInterceptorConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The KMS key ARN for the gateway.
     */
    get kmsKeyArn(): string | undefined;
     ...
     * The configuration for a policy engine associated with a gateway.
     */
    get policyEngineConfiguration(): CfnGateway.GatewayPolicyEngineConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration for a policy engine associated with a gateway.
     */
    set policyEngineConfiguration(value: CfnGateway.GatewayPolicyEngineConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The protocol configuration for the gateway target.
     */
    get protocolConfiguration(): CfnGateway.GatewayProtocolConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The protocol configuration for the gateway target.
     */
    set protocolConfiguration(value: CfnGateway.GatewayProtocolConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The protocol type for the gateway target.
     */
...
export declare namespace CfnGateway {
    ...
    interface MCPGatewayConfigurationProperty {
         ...
         */
        readonly sessionConfiguration?: cdk.IResolvable | CfnGateway.SessionConfigurationProperty;
        /**
         ...
         */
        readonly streamingConfiguration?: cdk.IResolvable | CfnGateway.StreamingConfigurationProperty;
        /**
...
export declare class CfnGatewayTarget extends cdk.CfnResource implements cdk.IInspectable, IGatewayTargetRef {
     ...
     */
    private _credentialProviderConfigurations?;
    /**
     ...
     * The OAuth credential provider configuration.
     */
    get credentialProviderConfigurations(): Array<CfnGatewayTarget.CredentialProviderConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The OAuth credential provider configuration.
     */
    set credentialProviderConfigurations(value: Array<CfnGatewayTarget.CredentialProviderConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description for the gateway target.
     */
    get description(): string | undefined;
     ...
     * The gateway ID for the gateway target.
     */
    get gatewayIdentifier(): string | undefined;
    /**
     * The gateway ID for the gateway target.
     */
    set gatewayIdentifier(value: string | undefined);
    get metadataConfiguration(): cdk.IResolvable | CfnGatewayTarget.MetadataConfigurationProperty | undefined;
    set metadataConfiguration(value: cdk.IResolvable | CfnGatewayTarget.MetadataConfigurationProperty | undefined);
    /**
     * The name for the gateway target.
     */
    ...
    get privateEndpoint(): cdk.IResolvable | CfnGatewayTarget.PrivateEndpointProperty | undefined;
    set privateEndpoint(value: cdk.IResolvable | CfnGatewayTarget.PrivateEndpointProperty | undefined);
    /**
     * The target configuration for the Smithy model target.
     */
    get targetConfiguration(): cdk.IResolvable | CfnGatewayTarget.TargetConfigurationProperty;
    /**
     * The target configuration for the Smithy model target.
     */
    set targetConfiguration(value: cdk.IResolvable | CfnGatewayTarget.TargetConfigurationProperty);
    /**
     * @cloudformationAttribute AuthorizationData
     */
    get attrAuthorizationData(): cdk.IResolvable;
    /**
     ...
     */
    get attrPrivateEndpointManagedResources(): cdk.IResolvable;
    /**
     * @cloudformationAttribute ProtocolType
     */
    get attrProtocolType(): string;
    /**
...
export declare namespace CfnGatewayTarget {
    ...
    interface CredentialProviderProperty {
         ...
         */
        readonly iamCredentialProvider?: CfnGatewayTarget.IamCredentialProviderProperty | cdk.IResolvable;
        /**
    ...
    interface PrivateEndpointProperty {
         ...
         */
        readonly managedVpcResource?: cdk.IResolvable | CfnGatewayTarget.ManagedVpcResourceProperty;
        /**
         ...
         */
        readonly selfManagedLatticeResource?: cdk.IResolvable | CfnGatewayTarget.SelfManagedLatticeResourceProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface TargetConfigurationProperty {
         ...
         */
        readonly http?: CfnGatewayTarget.HttpTargetConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface McpTargetConfigurationProperty {
         ...
         */
        readonly connector?: CfnGatewayTarget.ConnectorTargetConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface McpServerTargetConfigurationProperty {
         ...
         */
        readonly mcpToolSchema?: cdk.IResolvable | CfnGatewayTarget.McpToolSchemaConfigurationProperty;
        /**
    ...
    interface ConnectorTargetConfigurationProperty {
         ...
         */
        readonly configurations?: Array<CfnGatewayTarget.ConnectorConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly source: CfnGatewayTarget.ConnectorSourceProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface ConnectorConfigurationProperty {
         ...
         */
        readonly parameterOverrides?: Array<CfnGatewayTarget.ConnectorParameterOverrideProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface HttpTargetConfigurationProperty {
         ...
         */
        readonly agentcoreRuntime?: cdk.IResolvable | CfnGatewayTarget.RuntimeTargetConfigurationProperty;
        /**
         ...
         */
        readonly passthrough?: cdk.IResolvable | CfnGatewayTarget.PassthroughTargetConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface RuntimeTargetConfigurationProperty {
         ...
         */
        readonly schema?: CfnGatewayTarget.HttpApiSchemaConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HttpApiSchemaConfigurationProperty {
         ...
         */
        readonly source: CfnGatewayTarget.ApiSchemaConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface PassthroughTargetConfigurationProperty {
         ...
         */
        readonly stickinessConfiguration?: cdk.IResolvable | CfnGatewayTarget.StickinessConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface AuthorizationDataProperty {
         ...
         */
        readonly oauth2: cdk.IResolvable | CfnGatewayTarget.OAuth2AuthorizationDataProperty;
    }
    /**
     * @struct
     * @stability external
...
export interface CfnGatewayTargetProps {
     ...
     */
    readonly privateEndpoint?: cdk.IResolvable | CfnGatewayTarget.PrivateEndpointProperty;
    /**
     * The target configuration for the Smithy model target.
     *
 ...
 */
export declare class CfnHarness extends cdk.CfnResource implements cdk.IInspectable, IHarnessRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnHarness from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnHarness;
    /**
     * Checks whether the given object is a CfnHarness
     */
    static isCfnHarness(x: any): x is CfnHarness;
    static arnForHarness(resource: IHarnessRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnHarnessProps);
    get harnessRef(): HarnessReference;
    /**
     * The tools that the agent is allowed to use.
     */
    get allowedTools(): Array<string> | undefined;
    /**
     * The tools that the agent is allowed to use.
     */
    set allowedTools(value: Array<string> | undefined);
    get authorizerConfiguration(): CfnHarness.AuthorizerConfigurationProperty | cdk.IResolvable | undefined;
    set authorizerConfiguration(value: CfnHarness.AuthorizerConfigurationProperty | cdk.IResolvable | undefined);
    get environment(): CfnHarness.HarnessEnvironmentProviderProperty | cdk.IResolvable | undefined;
    set environment(value: CfnHarness.HarnessEnvironmentProviderProperty | cdk.IResolvable | undefined);
    get environmentArtifact(): CfnHarness.HarnessEnvironmentArtifactProperty | cdk.IResolvable | undefined;
    set environmentArtifact(value: CfnHarness.HarnessEnvironmentArtifactProperty | cdk.IResolvable | undefined);
    /**
     * Environment variables to set in the harness runtime environment.
     */
    get environmentVariables(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Environment variables to set in the harness runtime environment.
     */
    set environmentVariables(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The ARN of the IAM role that the harness assumes when running.
     */
    ...
    get memory(): CfnHarness.HarnessMemoryConfigurationProperty | cdk.IResolvable | undefined;
    set memory(value: CfnHarness.HarnessMemoryConfigurationProperty | cdk.IResolvable | undefined);
    get model(): CfnHarness.HarnessModelConfigurationProperty | cdk.IResolvable;
    set model(value: CfnHarness.HarnessModelConfigurationProperty | cdk.IResolvable);
    /**
     * The skills available to the agent.
     */
    get skills(): Array<CfnHarness.HarnessSkillProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The skills available to the agent.
     */
    set skills(value: Array<CfnHarness.HarnessSkillProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The system prompt that defines the agent's behavior.
     */
    get systemPrompt(): Array<CfnHarness.HarnessSystemContentBlockProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The system prompt that defines the agent's behavior.
     */
    set systemPrompt(value: Array<CfnHarness.HarnessSystemContentBlockProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Tags to apply to the harness resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * The tools available to the agent.
     */
    get tools(): Array<CfnHarness.HarnessToolProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The tools available to the agent.
     */
    set tools(value: Array<CfnHarness.HarnessToolProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get truncation(): CfnHarness.HarnessTruncationConfigurationProperty | cdk.IResolvable | undefined;
    set truncation(value: CfnHarness.HarnessTruncationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrEnvironmentAgentCoreRuntimeEnvironmentAgentRuntimeArn(): string;
    /**
     * The ID of the underlying AgentCore Runtime.
     *
     * @cloudformationAttribute Environment.AgentCoreRuntimeEnvironment.AgentRuntimeId
     */
    get attrEnvironmentAgentCoreRuntimeEnvironmentAgentRuntimeId(): string;
    /**
     ...
     */
    get attrEnvironmentAgentCoreRuntimeEnvironmentAgentRuntimeName(): string;
    /**
     * The unique identifier of the harness.
     *
     * @cloudformationAttribute HarnessId
     */
    get attrHarnessId(): string;
    /**
     * The ARN of the managed memory resource. Read-only, populated by the service.
     *
     * @cloudformationAttribute Memory.ManagedMemoryConfiguration.Arn
     */
    get attrMemoryManagedMemoryConfigurationArn(): string;
    /**
     * @cloudformationAttribute Status
     */
    get attrStatus(): string;
...
export declare namespace CfnHarness {
    /**
     * @struct
     * @stability external
    ...
    interface HarnessEnvironmentProviderProperty {
         ...
         */
        readonly agentCoreRuntimeEnvironment?: CfnHarness.HarnessAgentCoreRuntimeEnvironmentProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessAgentCoreRuntimeEnvironmentProperty {
         ...
         */
        readonly filesystemConfigurations?: Array<CfnHarness.FilesystemConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly lifecycleConfiguration?: cdk.IResolvable | CfnHarness.LifecycleConfigurationProperty;
        /**
         ...
         */
        readonly networkConfiguration?: cdk.IResolvable | CfnHarness.NetworkConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface NetworkConfigurationProperty {
         ...
         */
        readonly networkModeConfig?: cdk.IResolvable | CfnHarness.VpcConfigProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface FilesystemConfigurationProperty {
         ...
         */
        readonly efsAccessPoint?: CfnHarness.EfsAccessPointConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly s3FilesAccessPoint?: cdk.IResolvable | CfnHarness.S3FilesAccessPointConfigurationProperty;
        /**
         ...
         */
        readonly sessionStorage?: cdk.IResolvable | CfnHarness.SessionStorageConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessEnvironmentArtifactProperty {
         ...
         */
        readonly containerConfiguration?: CfnHarness.ContainerConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface AuthorizerConfigurationProperty {
         ...
         */
        readonly customJwtAuthorizer?: CfnHarness.CustomJWTAuthorizerConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CustomJWTAuthorizerConfigurationProperty {
         ...
         */
        readonly customClaims?: Array<CfnHarness.CustomClaimValidationTypeProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly privateEndpoint?: cdk.IResolvable | CfnHarness.PrivateEndpointProperty;
        /**
         ...
         */
        readonly privateEndpointOverrides?: Array<cdk.IResolvable | CfnHarness.PrivateEndpointOverrideProperty> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CustomClaimValidationTypeProperty {
         ...
         */
        readonly authorizingClaimMatchValue: CfnHarness.AuthorizingClaimMatchValueTypeProperty | cdk.IResolvable;
        /**
    ...
    interface AuthorizingClaimMatchValueTypeProperty {
         ...
         */
        readonly claimMatchValue: CfnHarness.ClaimMatchValueTypeProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface PrivateEndpointProperty {
         ...
         */
        readonly managedVpcResource?: cdk.IResolvable | CfnHarness.ManagedVpcResourceProperty;
        /**
         ...
         */
        readonly selfManagedLatticeResource?: cdk.IResolvable | CfnHarness.SelfManagedLatticeResourceProperty;
    }
    /**
     * Configuration for connecting to a private resource using a self-managed VPC Lattice resource configuration.
     *
    ...
    interface HarnessModelConfigurationProperty {
         ...
         */
        readonly bedrockModelConfig?: CfnHarness.HarnessBedrockModelConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly geminiModelConfig?: CfnHarness.HarnessGeminiModelConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly liteLlmModelConfig?: CfnHarness.HarnessLiteLlmModelConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly openAiModelConfig?: CfnHarness.HarnessOpenAiModelConfigProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessToolProperty {
         ...
         */
        readonly config?: CfnHarness.HarnessToolConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface HarnessToolConfigurationProperty {
         ...
         */
        readonly agentCoreBrowser?: CfnHarness.HarnessAgentCoreBrowserConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly agentCoreCodeInterpreter?: CfnHarness.HarnessAgentCoreCodeInterpreterConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly agentCoreGateway?: CfnHarness.HarnessAgentCoreGatewayConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly inlineFunction?: CfnHarness.HarnessInlineFunctionConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly remoteMcp?: CfnHarness.HarnessRemoteMcpConfigProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessAgentCoreGatewayConfigProperty {
         ...
         */
        readonly outboundAuth?: CfnHarness.HarnessGatewayOutboundAuthProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessGatewayOutboundAuthProperty {
         ...
         */
        readonly oauth?: cdk.IResolvable | CfnHarness.OAuthCredentialProviderProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessSkillProperty {
         ...
         */
        readonly awsSkills?: CfnHarness.HarnessSkillAwsSkillsSourceProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly git?: CfnHarness.HarnessSkillGitSourceProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly s3?: CfnHarness.HarnessSkillS3SourceProperty | cdk.IResolvable;
    }
    /**
     * An S3 source containing the skill.
     *
    ...
    interface HarnessSkillGitSourceProperty {
         ...
         */
        readonly auth?: CfnHarness.HarnessSkillGitAuthProperty | cdk.IResolvable;
        /**
    ...
    interface HarnessMemoryConfigurationProperty {
         ...
         */
        readonly agentCoreMemoryConfiguration?: CfnHarness.HarnessAgentCoreMemoryConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly managedMemoryConfiguration?: CfnHarness.HarnessManagedMemoryConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessAgentCoreMemoryConfigurationProperty {
         ...
         */
        readonly retrievalConfig?: cdk.IResolvable | Record<string, CfnHarness.HarnessAgentCoreMemoryRetrievalConfigProperty | cdk.IResolvable>;
    }
    /**
     * @struct
     * @stability external
    ...
    interface HarnessTruncationConfigurationProperty {
         ...
         */
        readonly config?: CfnHarness.HarnessTruncationStrategyConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface HarnessTruncationStrategyConfigurationProperty {
         ...
         */
        readonly slidingWindow?: CfnHarness.HarnessSlidingWindowConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly summarization?: CfnHarness.HarnessSummarizationConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-harness.html
 */
export interface CfnHarnessProps {
    /**
     * The tools that the agent is allowed to use.
     *
     ...
     */
    readonly authorizerConfiguration?: CfnHarness.AuthorizerConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly environment?: CfnHarness.HarnessEnvironmentProviderProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly environmentArtifact?: CfnHarness.HarnessEnvironmentArtifactProperty | cdk.IResolvable;
    /**
     * Environment variables to set in the harness runtime environment.
     *
     ...
     */
    readonly memory?: CfnHarness.HarnessMemoryConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly model: CfnHarness.HarnessModelConfigurationProperty | cdk.IResolvable;
    /**
     * The skills available to the agent.
     *
     ...
     */
    readonly skills?: Array<CfnHarness.HarnessSkillProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The system prompt that defines the agent's behavior.
     *
     ...
     */
    readonly systemPrompt?: Array<CfnHarness.HarnessSystemContentBlockProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Tags to apply to the harness resource.
     *
     ...
     */
    readonly tools?: Array<CfnHarness.HarnessToolProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     ...
     */
    readonly truncation?: CfnHarness.HarnessTruncationConfigurationProperty | cdk.IResolvable;
}
/**
...
export declare class CfnMemory extends cdk.CfnResource implements cdk.IInspectable, IMemoryRef, cdk.ITaggableV2 {
     ...
     * List of indexed keys for the memory.
     */
    get indexedKeys(): Array<CfnMemory.IndexedKeyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * List of indexed keys for the memory.
     */
    set indexedKeys(value: Array<CfnMemory.IndexedKeyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The memory role ARN.
     */
    get memoryExecutionRoleArn(): string | undefined;
    /**
     * The memory role ARN.
     */
    set memoryExecutionRoleArn(value: string | undefined);
    /**
     * The memory strategies.
     */
    get memoryStrategies(): Array<cdk.IResolvable | CfnMemory.MemoryStrategyProperty> | cdk.IResolvable | undefined;
    /**
     * The memory strategies.
     */
    set memoryStrategies(value: Array<cdk.IResolvable | CfnMemory.MemoryStrategyProperty> | cdk.IResolvable | undefined);
    /**
     * The memory name.
     */
    get name(): string;
     ...
     */
    set name(value: string);
    get streamDeliveryResources(): cdk.IResolvable | CfnMemory.StreamDeliveryResourcesProperty | undefined;
    set streamDeliveryResources(value: cdk.IResolvable | CfnMemory.StreamDeliveryResourcesProperty | undefined);
    /**
     * The tags for the resources.
     */
    get tags(): Record<string, string> | undefined;
...
export declare namespace CfnMemory {
    ...
    interface SemanticMemoryStrategyProperty {
         ...
         */
        readonly memoryRecordSchema?: cdk.IResolvable | CfnMemory.MemoryRecordSchemaProperty;
        /**
    ...
    interface MemoryRecordSchemaProperty {
         ...
         */
        readonly metadataSchema?: Array<cdk.IResolvable | CfnMemory.MetadataSchemaEntryProperty> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface MetadataSchemaEntryProperty {
         ...
         */
        readonly extractionConfig?: CfnMemory.ExtractionConfigProperty | cdk.IResolvable;
        /**
    ...
    interface ExtractionConfigProperty {
         ...
         */
        readonly llmExtractionConfig?: cdk.IResolvable | CfnMemory.LlmExtractionConfigProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface LlmExtractionConfigProperty {
         ...
         */
        readonly validation?: cdk.IResolvable | CfnMemory.ValidationProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface ValidationProperty {
         ...
         */
        readonly numberValidation?: cdk.IResolvable | CfnMemory.NumberValidationProperty;
        /**
         ...
         */
        readonly stringListValidation?: cdk.IResolvable | CfnMemory.StringListValidationProperty;
        /**
         ...
         */
        readonly stringValidation?: cdk.IResolvable | CfnMemory.StringValidationProperty;
    }
    /**
     * @struct
     * @stability external
...
export interface CfnMemoryProps {
     ...
     */
    readonly indexedKeys?: Array<CfnMemory.IndexedKeyProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The memory role ARN.
     *
 ...
 */
export declare class CfnOAuth2CredentialProvider extends cdk.CfnResource implements cdk.IInspectable, IOAuth2CredentialProviderRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnOAuth2CredentialProvider from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnOAuth2CredentialProvider;
    /**
     * Checks whether the given object is a CfnOAuth2CredentialProvider
     */
    static isCfnOAuth2CredentialProvider(x: any): x is CfnOAuth2CredentialProvider;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _oauth2ProviderConfigInput?;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnOAuth2CredentialProviderProps);
    get oAuth2CredentialProviderRef(): OAuth2CredentialProviderReference;
    /**
     * The vendor of the OAuth2 credential provider.
     */
     ...
     * Input configuration for an OAuth2 provider.
     */
    get oauth2ProviderConfigInput(): cdk.IResolvable | CfnOAuth2CredentialProvider.Oauth2ProviderConfigInputProperty | undefined;
    /**
     * Input configuration for an OAuth2 provider.
     */
    set oauth2ProviderConfigInput(value: cdk.IResolvable | CfnOAuth2CredentialProvider.Oauth2ProviderConfigInputProperty | undefined);
    /**
     * Tags to assign to the OAuth2 credential provider.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrOauth2ProviderConfigOutput(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnOAuth2CredentialProvider {
    /**
     * Input configuration for an OAuth2 provider.
     *
     * @struct
    ...
    interface Oauth2ProviderConfigInputProperty {
         ...
         */
        readonly atlassianOauth2ProviderConfig?: CfnOAuth2CredentialProvider.AtlassianOauth2ProviderConfigInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly customOauth2ProviderConfig?: CfnOAuth2CredentialProvider.CustomOauth2ProviderConfigInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly githubOauth2ProviderConfig?: CfnOAuth2CredentialProvider.GithubOauth2ProviderConfigInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly googleOauth2ProviderConfig?: CfnOAuth2CredentialProvider.GoogleOauth2ProviderConfigInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly includedOauth2ProviderConfig?: CfnOAuth2CredentialProvider.IncludedOauth2ProviderConfigInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly linkedinOauth2ProviderConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.LinkedinOauth2ProviderConfigInputProperty;
        /**
         ...
         */
        readonly microsoftOauth2ProviderConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.MicrosoftOauth2ProviderConfigInputProperty;
        /**
         ...
         */
        readonly salesforceOauth2ProviderConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.SalesforceOauth2ProviderConfigInputProperty;
        /**
         ...
         */
        readonly slackOauth2ProviderConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.SlackOauth2ProviderConfigInputProperty;
    }
    /**
     * Input configuration for a custom OAuth2 provider.
     *
    ...
    interface CustomOauth2ProviderConfigInputProperty {
         ...
         */
        readonly clientSecretConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.SecretReferenceProperty;
        /**
         * The source of the client secret.
         *
         ...
         */
        readonly oauthDiscovery: cdk.IResolvable | CfnOAuth2CredentialProvider.Oauth2DiscoveryProperty;
        /**
         ...
         */
        readonly onBehalfOfTokenExchangeConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.OnBehalfOfTokenExchangeConfigProperty;
    }
    /**
     * Discovery information for an OAuth2 provider.
     *
    ...
    interface Oauth2DiscoveryProperty {
         ...
         */
        readonly authorizationServerMetadata?: cdk.IResolvable | CfnOAuth2CredentialProvider.Oauth2AuthorizationServerMetadataProperty;
        /**
    ...
    interface OnBehalfOfTokenExchangeConfigProperty {
         ...
         */
        readonly tokenExchangeGrantTypeConfig?: cdk.IResolvable | CfnOAuth2CredentialProvider.TokenExchangeGrantTypeConfigProperty;
    }
    /**
     * Configuration for RFC 8693 Token Exchange.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-oauth2credentialprovider.html
 */
export interface CfnOAuth2CredentialProviderProps {
    /**
     * The vendor of the OAuth2 credential provider.
     *
     ...
     */
    readonly oauth2ProviderConfigInput?: cdk.IResolvable | CfnOAuth2CredentialProvider.Oauth2ProviderConfigInputProperty;
    /**
     * Tags to assign to the OAuth2 credential provider.
     *
...
export declare class CfnOnlineEvaluationConfig extends cdk.CfnResource implements cdk.IInspectable, IOnlineEvaluationConfigRef, cdk.ITaggableV2 {
     ...
     * The configuration for clustering analysis of evaluation results.
     */
    get clusteringConfig(): CfnOnlineEvaluationConfig.ClusteringConfigProperty | cdk.IResolvable | undefined;
    /**
     * The configuration for clustering analysis of evaluation results.
     */
    set clusteringConfig(value: CfnOnlineEvaluationConfig.ClusteringConfigProperty | cdk.IResolvable | undefined);
    /**
     * The configuration that specifies where to read agent traces for online evaluation.
     */
    get dataSourceConfig(): CfnOnlineEvaluationConfig.DataSourceConfigProperty | cdk.IResolvable;
    /**
     * The configuration that specifies where to read agent traces for online evaluation.
     */
    set dataSourceConfig(value: CfnOnlineEvaluationConfig.DataSourceConfigProperty | cdk.IResolvable);
    /**
     * The description of the online evaluation configuration.
     */
    get description(): string | undefined;
     ...
     * The list of evaluators to apply during online evaluation.
     */
    get evaluators(): Array<CfnOnlineEvaluationConfig.EvaluatorReferenceProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of evaluators to apply during online evaluation.
     */
    set evaluators(value: Array<CfnOnlineEvaluationConfig.EvaluatorReferenceProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get executionStatus(): string | undefined;
    set executionStatus(value: string | undefined);
    /**
     * The list of insights to enable for failure analysis.
     */
    get insights(): Array<CfnOnlineEvaluationConfig.InsightProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of insights to enable for failure analysis.
     */
    set insights(value: Array<CfnOnlineEvaluationConfig.InsightProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the online evaluation configuration.
     */
     ...
     * The evaluation rule that defines sampling configuration, filtering criteria, and session detection settings.
     */
    get rule(): cdk.IResolvable | CfnOnlineEvaluationConfig.RuleProperty;
    /**
     * The evaluation rule that defines sampling configuration, filtering criteria, and session detection settings.
     */
    set rule(value: cdk.IResolvable | CfnOnlineEvaluationConfig.RuleProperty);
    /**
     * A list of tags to assign to the online evaluation configuration.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export interface CfnOnlineEvaluationConfigProps {
     ...
     */
    readonly clusteringConfig?: CfnOnlineEvaluationConfig.ClusteringConfigProperty | cdk.IResolvable;
    /**
     * The configuration that specifies where to read agent traces for online evaluation.
     *
     ...
     */
    readonly insights?: Array<CfnOnlineEvaluationConfig.InsightProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The name of the online evaluation configuration.
     *
     * Must be unique within your account.
 ...
 */
export declare class CfnPaymentConnector extends cdk.CfnResource implements cdk.IInspectable, IPaymentConnectorRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPaymentConnector from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPaymentConnector;
    /**
     * Checks whether the given object is a CfnPaymentConnector
     */
    static isCfnPaymentConnector(x: any): x is CfnPaymentConnector;
    static arnForPaymentConnector(resource: IPaymentConnectorRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnPaymentConnectorProps);
    get paymentConnectorRef(): PaymentConnectorReference;
    /**
     * The name of the payment connector.
     */
     ...
     * The credential provider configurations for the connector.
     */
    get credentialProviderConfigurations(): Array<CfnPaymentConnector.CredentialsProviderConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The credential provider configurations for the connector.
     */
    set credentialProviderConfigurations(value: Array<CfnPaymentConnector.CredentialsProviderConfigurationProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * A description of the payment connector.
     */
    get description(): string | undefined;
...
export declare namespace CfnPaymentConnector {
    /**
     * @struct
     * @stability external
    ...
    interface CredentialsProviderConfigurationProperty {
         ...
         */
        readonly coinbaseCdp?: cdk.IResolvable | CfnPaymentConnector.PaymentCredentialProviderConfigurationProperty;
        /**
         ...
         */
        readonly stripePrivy?: cdk.IResolvable | CfnPaymentConnector.PaymentCredentialProviderConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-paymentconnector.html
 */
export interface CfnPaymentConnectorProps {
    /**
     * The name of the payment connector.
     *
     ...
     */
    readonly credentialProviderConfigurations: Array<CfnPaymentConnector.CredentialsProviderConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A description of the payment connector.
     *
 ...
 */
export declare class CfnPaymentCredentialProvider extends cdk.CfnResource implements cdk.IInspectable, IPaymentCredentialProviderRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPaymentCredentialProvider from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPaymentCredentialProvider;
    /**
     * Checks whether the given object is a CfnPaymentCredentialProvider
     */
    static isCfnPaymentCredentialProvider(x: any): x is CfnPaymentCredentialProvider;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _providerConfigurationInput?;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnPaymentCredentialProviderProps);
    get paymentCredentialProviderRef(): PaymentCredentialProviderReference;
    /**
     * Supported vendor types for payment providers.
     */
    get credentialProviderVendor(): string;
     ...
     * Provider configuration input containing secrets for creation/update.
     */
    get providerConfigurationInput(): cdk.IResolvable | CfnPaymentCredentialProvider.PaymentProviderConfigurationInputProperty | undefined;
    /**
     * Provider configuration input containing secrets for creation/update.
     */
    set providerConfigurationInput(value: cdk.IResolvable | CfnPaymentCredentialProvider.PaymentProviderConfigurationInputProperty | undefined);
    /**
     * Tags for the payment credential provider.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     *
     * @cloudformationAttribute ProviderConfigurationOutput
     */
    get attrProviderConfigurationOutput(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnPaymentCredentialProvider {
    /**
     * Provider configuration input containing secrets for creation/update.
     *
     * @struct
    ...
    interface PaymentProviderConfigurationInputProperty {
         ...
         */
        readonly coinbaseCdpConfiguration?: CfnPaymentCredentialProvider.CoinbaseCdpConfigurationInputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly stripePrivyConfiguration?: cdk.IResolvable | CfnPaymentCredentialProvider.StripePrivyConfigurationInputProperty;
    }
    /**
     * Coinbase CDP configuration with API credentials.
     *
    ...
    interface CoinbaseCdpConfigurationInputProperty {
         ...
         */
        readonly apiKeySecretConfig?: cdk.IResolvable | CfnPaymentCredentialProvider.SecretReferenceProperty;
        /**
         ...
         */
        readonly walletSecretConfig?: cdk.IResolvable | CfnPaymentCredentialProvider.SecretReferenceProperty;
        /**
         * The source of the secret.
         *
         * Use MANAGED for service-managed secrets or EXTERNAL for customer-provided secrets.
    ...
    interface StripePrivyConfigurationInputProperty {
         ...
         */
        readonly appSecretConfig?: cdk.IResolvable | CfnPaymentCredentialProvider.SecretReferenceProperty;
        /**
         * The source of the secret.
         *
         * Use MANAGED for service-managed secrets or EXTERNAL for customer-provided secrets.
         ...
         */
        readonly authorizationPrivateKeyConfig?: cdk.IResolvable | CfnPaymentCredentialProvider.SecretReferenceProperty;
        /**
         * The source of the secret.
         *
         * Use MANAGED for service-managed secrets or EXTERNAL for customer-provided secrets.
    ...
    interface PaymentProviderConfigurationOutputProperty {
         ...
         */
        readonly coinbaseCdpConfiguration?: CfnPaymentCredentialProvider.CoinbaseCdpConfigurationOutputProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly stripePrivyConfiguration?: cdk.IResolvable | CfnPaymentCredentialProvider.StripePrivyConfigurationOutputProperty;
    }
    /**
     * Coinbase CDP configuration output with secret ARNs.
     *
    ...
    interface CoinbaseCdpConfigurationOutputProperty {
         ...
         */
        readonly apiKeySecretArn: cdk.IResolvable | CfnPaymentCredentialProvider.SecretInfoProperty;
        /**
         ...
         */
        readonly walletSecretArn?: cdk.IResolvable | CfnPaymentCredentialProvider.SecretInfoProperty;
        /**
    ...
    interface StripePrivyConfigurationOutputProperty {
         ...
         */
        readonly appSecretArn: cdk.IResolvable | CfnPaymentCredentialProvider.SecretInfoProperty;
        /**
         ...
         */
        readonly authorizationPrivateKeyArn: cdk.IResolvable | CfnPaymentCredentialProvider.SecretInfoProperty;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-paymentcredentialprovider.html
 */
export interface CfnPaymentCredentialProviderProps {
    /**
     * Supported vendor types for payment providers.
     *
     ...
     */
    readonly providerConfigurationInput?: cdk.IResolvable | CfnPaymentCredentialProvider.PaymentProviderConfigurationInputProperty;
    /**
     * Tags for the payment credential provider.
     *
 ...
 */
export declare class CfnPaymentManager extends cdk.CfnResource implements cdk.IInspectable, IPaymentManagerRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPaymentManager from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPaymentManager;
    /**
     * Checks whether the given object is a CfnPaymentManager
     */
    static isCfnPaymentManager(x: any): x is CfnPaymentManager;
    static arnForPaymentManager(resource: IPaymentManagerRef): string;
    private _authorizerConfiguration?;
    private _authorizerType;
    /**
     * Tag Manager which manages the tags for this resource
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnPaymentManagerProps);
    get paymentManagerRef(): PaymentManagerReference;
    get authorizerConfiguration(): CfnPaymentManager.AuthorizerConfigurationProperty | cdk.IResolvable | undefined;
    set authorizerConfiguration(value: CfnPaymentManager.AuthorizerConfigurationProperty | cdk.IResolvable | undefined);
    get authorizerType(): string;
    set authorizerType(value: string);
    /**
     * A description of the payment manager.
...
export declare namespace CfnPaymentManager {
    /**
     * @struct
     * @stability external
    ...
    interface AuthorizerConfigurationProperty {
         ...
         */
        readonly customJwtAuthorizer: CfnPaymentManager.CustomJWTAuthorizerConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CustomJWTAuthorizerConfigurationProperty {
         ...
         */
        readonly customClaims?: Array<CfnPaymentManager.CustomClaimValidationTypeProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface CustomClaimValidationTypeProperty {
         ...
         */
        readonly authorizingClaimMatchValue: CfnPaymentManager.AuthorizingClaimMatchValueTypeProperty | cdk.IResolvable;
        /**
    ...
    interface AuthorizingClaimMatchValueTypeProperty {
         ...
         */
        readonly claimMatchValue: CfnPaymentManager.ClaimMatchValueTypeProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-paymentmanager.html
 */
export interface CfnPaymentManagerProps {
    /**
     ...
     */
    readonly authorizerConfiguration?: CfnPaymentManager.AuthorizerConfigurationProperty | cdk.IResolvable;
    /**
...
export declare class CfnPolicy extends cdk.CfnResource implements cdk.IInspectable, IPolicyRef {
     ...
     * The definition structure for policies.
     */
    get definition(): cdk.IResolvable | CfnPolicy.PolicyDefinitionProperty;
    /**
     * The definition structure for policies.
     */
    set definition(value: cdk.IResolvable | CfnPolicy.PolicyDefinitionProperty);
    /**
     * A human-readable description of the policy's purpose and functionality.
     */
    get description(): string | undefined;
     ...
     * Whether the policy contributes to the enforce decision returned to Gateway.
     */
    get enforcementMode(): string | undefined;
    /**
     * Whether the policy contributes to the enforce decision returned to Gateway.
     */
    set enforcementMode(value: string | undefined);
    /**
     * The customer-assigned immutable name for the policy.
     */
    get name(): string;
     ...
     * The validation mode for the policy.
     */
    get validationMode(): string | undefined;
    /**
     * The validation mode for the policy.
     */
    set validationMode(value: string | undefined);
    /**
...
export declare namespace CfnPolicy {
    ...
    interface PolicyDefinitionProperty {
         ...
         */
        readonly policy?: cdk.IResolvable | CfnPolicy.PolicyStatementProperty;
    }
    /**
     * A Cedar policy statement within the AgentCore Policy system.
     *
...
export declare class CfnRuntime extends cdk.CfnResource implements cdk.IInspectable, IRuntimeRef, cdk.ITaggableV2 {
     ...
     */
    private _filesystemConfigurations?;
    /**
     ...
     * The artifact of the agent.
     */
    get agentRuntimeArtifact(): CfnRuntime.AgentRuntimeArtifactProperty | cdk.IResolvable;
    /**
     * The artifact of the agent.
     */
    set agentRuntimeArtifact(value: CfnRuntime.AgentRuntimeArtifactProperty | cdk.IResolvable);
    /**
     * The name of the AgentCore Runtime endpoint.
     */
     ...
     * Represents inbound authorization configuration options used to authenticate incoming requests.
     */
    get authorizerConfiguration(): CfnRuntime.AuthorizerConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Represents inbound authorization configuration options used to authenticate incoming requests.
     */
    set authorizerConfiguration(value: CfnRuntime.AuthorizerConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The agent runtime description.
     */
    get description(): string | undefined;
     ...
     * List of filesystem configurations.
     */
    get filesystemConfigurations(): Array<CfnRuntime.FilesystemConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * List of filesystem configurations.
     */
    set filesystemConfigurations(value: Array<CfnRuntime.FilesystemConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Configuration for managing the lifecycle of runtime sessions and resources.
     */
    get lifecycleConfiguration(): cdk.IResolvable | CfnRuntime.LifecycleConfigurationProperty | undefined;
    /**
     * Configuration for managing the lifecycle of runtime sessions and resources.
     */
    set lifecycleConfiguration(value: cdk.IResolvable | CfnRuntime.LifecycleConfigurationProperty | undefined);
    /**
     * The network configuration.
     */
    get networkConfiguration(): cdk.IResolvable | CfnRuntime.NetworkConfigurationProperty;
    /**
     * The network configuration.
     */
    set networkConfiguration(value: cdk.IResolvable | CfnRuntime.NetworkConfigurationProperty);
    /**
     * The protocol configuration for an agent runtime.
     */
    get protocolConfiguration(): string | undefined;
    /**
     * The protocol configuration for an agent runtime.
     */
    set protocolConfiguration(value: string | undefined);
    /**
     * Configuration for HTTP request headers.
     */
    get requestHeaderConfiguration(): cdk.IResolvable | CfnRuntime.RequestHeaderConfigurationProperty | undefined;
    /**
     * Configuration for HTTP request headers.
     */
    set requestHeaderConfiguration(value: cdk.IResolvable | CfnRuntime.RequestHeaderConfigurationProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) for for the role.
     */
    get roleArn(): string;
...
export declare namespace CfnRuntime {
    ...
    interface FilesystemConfigurationProperty {
         ...
         */
        readonly efsAccessPoint?: CfnRuntime.EfsAccessPointConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly s3FilesAccessPoint?: cdk.IResolvable | CfnRuntime.S3FilesAccessPointConfigurationProperty;
        /**
         ...
         */
        readonly sessionStorage?: cdk.IResolvable | CfnRuntime.SessionStorageConfigurationProperty;
    }
    /**
     * Configuration for session storage.
     *
...
export interface CfnRuntimeProps {
     ...
     */
    readonly filesystemConfigurations?: Array<CfnRuntime.FilesystemConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Configuration for managing the lifecycle of runtime sessions and resources.
     *
...
export declare class CfnRuntimeEndpoint extends cdk.CfnResource implements cdk.IInspectable, IRuntimeEndpointRef, cdk.ITaggableV2 {
     ...
     */
    private _agentRuntimeId;
    /**
     * The version of the agent.
     */
    private _agentRuntimeVersion?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The agent runtime ID.
     */
    set agentRuntimeId(value: string);
    /**
     * The version of the agent.
     */
    get agentRuntimeVersion(): string | undefined;
    /**
     * The version of the agent.
     */
    set agentRuntimeVersion(value: string | undefined);
    /**
     * Contains information about an agent runtime endpoint.
     */
    get description(): string | undefined;
...
export declare class CfnWorkloadIdentity extends cdk.CfnResource implements cdk.IInspectable, IWorkloadIdentityRef, cdk.ITaggableV2 {
     ...
     * The list of allowed OAuth2 return URLs for resources associated with this workload identity.
     */
    get allowedResourceOauth2ReturnUrls(): Array<string> | undefined;
    /**
     * The list of allowed OAuth2 return URLs for resources associated with this workload identity.
     */
    set allowedResourceOauth2ReturnUrls(value: Array<string> | undefined);
    /**
     * The name of the workload identity.
     */
    get name(): string;
...
export type { IApiKeyCredentialProviderRef, ApiKeyCredentialProviderReference };
export type { IBrowserRef, BrowserReference };
...
export type { IConfigurationBundleRef, ConfigurationBundleReference };
...
export type { IHarnessRef, HarnessReference };
export type { IMemoryRef, MemoryReference };
export type { IOAuth2CredentialProviderRef, OAuth2CredentialProviderReference };
export type { IOnlineEvaluationConfigRef, OnlineEvaluationConfigReference };
export type { IPaymentConnectorRef, PaymentConnectorReference };
export type { IPaymentCredentialProviderRef, PaymentCredentialProviderReference };
export type { IPaymentManagerRef, PaymentManagerReference };
