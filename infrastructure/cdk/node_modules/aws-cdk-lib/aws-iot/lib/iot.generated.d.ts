...
import { AccountAuditConfigurationReference, AuthorizerReference, BillingGroupReference, CACertificateReference, CertificateProviderReference, CertificateReference, CommandReference, CustomMetricReference, DimensionReference, DomainConfigurationReference, EncryptionConfigurationReference, FleetMetricReference, IAccountAuditConfigurationRef, IAuthorizerRef, IBillingGroupRef, ICACertificateRef, ICertificateProviderRef, ICertificateRef, ICommandRef, ICustomMetricRef, IDimensionRef, IDomainConfigurationRef, IEncryptionConfigurationRef, IFleetMetricRef, IIndexRef, IJobTemplateRef, ILoggingRef, IMitigationActionRef, IndexReference, IPolicyPrincipalAttachmentRef, IPolicyRef, IProvisioningTemplateRef, IResourceSpecificLoggingRef, IRoleAliasRef, IScheduledAuditRef, ISecurityProfileRef, ISoftwarePackageRef, ISoftwarePackageVersionRef, IThingGroupRef, IThingPrincipalAttachmentRef, IThingRef, IThingTypeRef, ITopicRuleDestinationRef, ITopicRuleRef, JobTemplateReference, LoggingReference, MitigationActionReference, PolicyPrincipalAttachmentReference, PolicyReference, ProvisioningTemplateReference, ResourceSpecificLoggingReference, RoleAliasReference, ScheduledAuditReference, SecurityProfileReference, SoftwarePackageReference, SoftwarePackageVersionReference, ThingGroupReference, ThingPrincipalAttachmentReference, ThingReference, ThingTypeReference, TopicRuleDestinationReference, TopicRuleReference } from "../../interfaces/generated/aws-iot-interfaces.generated";
...
export declare class CfnAccountAuditConfiguration extends cdk.CfnResource implements cdk.IInspectable, IAccountAuditConfigurationRef {
     ...
     */
    static isCfnAccountAuditConfiguration(x: any): x is CfnAccountAuditConfiguration;
    /**
     ...
     * Specifies which audit checks are enabled and disabled for this account.
     */
    get auditCheckConfigurations(): CfnAccountAuditConfiguration.AuditCheckConfigurationsProperty | cdk.IResolvable;
    /**
     * Specifies which audit checks are enabled and disabled for this account.
     */
    set auditCheckConfigurations(value: CfnAccountAuditConfiguration.AuditCheckConfigurationsProperty | cdk.IResolvable);
    /**
     * Information about the targets to which audit notifications are sent.
     */
    get auditNotificationTargetConfigurations(): CfnAccountAuditConfiguration.AuditNotificationTargetConfigurationsProperty | cdk.IResolvable | undefined;
    /**
     * Information about the targets to which audit notifications are sent.
     */
    set auditNotificationTargetConfigurations(value: CfnAccountAuditConfiguration.AuditNotificationTargetConfigurationsProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the role that grants permission to AWS IoT to access information about your devices, policies, certificates, and other items as required when performing an audit.
     */
    get roleArn(): string;
...
export declare class CfnAuthorizer extends cdk.CfnResource implements cdk.IInspectable, IAuthorizerRef, cdk.ITaggable {
     ...
     */
    static fromAuthorizerArn(scope: constructs.Construct, id: string, arn: string): IAuthorizerRef;
    /**
     * Creates a new IAuthorizerRef from a authorizerName
     */
    static fromAuthorizerName(scope: constructs.Construct, id: string, authorizerName: string): IAuthorizerRef;
    static arnForAuthorizer(resource: IAuthorizerRef): string;
    /**
     ...
     * The authorizer name.
     */
    get authorizerName(): string | undefined;
    /**
     * The authorizer name.
     */
    set authorizerName(value: string | undefined);
    /**
     * When `true` , the result from the authorizer's Lambda function is cached for clients that use persistent HTTP connections.
     */
    get enableCachingForHttp(): boolean | cdk.IResolvable | undefined;
    /**
     * When `true` , the result from the authorizer's Lambda function is cached for clients that use persistent HTTP connections.
     */
    set enableCachingForHttp(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether AWS IoT validates the token signature in an authorization request.
     */
    get signingDisabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether AWS IoT validates the token signature in an authorization request.
     */
    set signingDisabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The status of the authorizer.
     */
     ...
     * The key used to extract the token from the HTTP headers.
     */
    get tokenKeyName(): string | undefined;
    /**
     * The key used to extract the token from the HTTP headers.
     */
    set tokenKeyName(value: string | undefined);
    /**
     * The public keys used to validate the token signature returned by your custom authentication service.
     */
    get tokenSigningPublicKeys(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * The public keys used to validate the token signature returned by your custom authentication service.
     */
    set tokenSigningPublicKeys(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
...
export declare class CfnBillingGroup extends cdk.CfnResource implements cdk.IInspectable, IBillingGroupRef, cdk.ITaggable {
     ...
     */
    static fromBillingGroupArn(scope: constructs.Construct, id: string, arn: string): IBillingGroupRef;
    /**
     * Creates a new IBillingGroupRef from a billingGroupName
     */
    static fromBillingGroupName(scope: constructs.Construct, id: string, billingGroupName: string): IBillingGroupRef;
     ...
     */
    private _billingGroupProperties?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * The name of the billing group.
     */
    get billingGroupName(): string | undefined;
    /**
     * The name of the billing group.
     */
    set billingGroupName(value: string | undefined);
    /**
     * The properties of the billing group.
     */
    get billingGroupProperties(): CfnBillingGroup.BillingGroupPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * The properties of the billing group.
     */
    set billingGroupProperties(value: CfnBillingGroup.BillingGroupPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * Metadata which can be used to manage the billing group.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnCACertificate extends cdk.CfnResource implements cdk.IInspectable, ICACertificateRef, cdk.ITaggable {
    ...
    /**
     * Checks whether the given object is a CfnCACertificate
     */
    static isCfnCACertificate(x: any): x is CfnCACertificate;
    static arnForCACertificate(resource: ICACertificateRef): string;
    /**
     * Whether the CA certificate is configured for auto registration of device certificates.
     */
    private _autoRegistrationStatus?;
    /**
     ...
     */
    private _removeAutoRegistration?;
    /**
     ...
     * Whether the CA certificate is configured for auto registration of device certificates.
     */
    get autoRegistrationStatus(): string | undefined;
    /**
     * Whether the CA certificate is configured for auto registration of device certificates.
     */
    set autoRegistrationStatus(value: string | undefined);
    /**
     * The certificate data in PEM format.
     */
     ...
     * Information about the registration configuration.
     */
    get registrationConfig(): cdk.IResolvable | CfnCACertificate.RegistrationConfigProperty | undefined;
    /**
     * Information about the registration configuration.
     */
    set registrationConfig(value: cdk.IResolvable | CfnCACertificate.RegistrationConfigProperty | undefined);
    /**
     * If true, removes auto registration.
     */
    get removeAutoRegistration(): boolean | cdk.IResolvable | undefined;
    /**
     * If true, removes auto registration.
     */
    set removeAutoRegistration(value: boolean | cdk.IResolvable | undefined);
    /**
     * The status of the CA certificate.
     */
    get status(): string;
     ...
     * The private key verification certificate.
     */
    get verificationCertificatePem(): string | undefined;
    /**
     * The private key verification certificate.
     */
    set verificationCertificatePem(value: string | undefined);
    /**
...
export declare class CfnCertificate extends cdk.CfnResource implements cdk.IInspectable, ICertificateRef {
     ...
     * The CA certificate used to sign the device certificate being registered, not available when CertificateMode is SNI_ONLY.
     */
    get caCertificatePem(): string | undefined;
    /**
     * The CA certificate used to sign the device certificate being registered, not available when CertificateMode is SNI_ONLY.
     */
    set caCertificatePem(value: string | undefined);
    /**
     * Specifies which mode of certificate registration to use with this resource.
     */
    get certificateMode(): string | undefined;
     ...
     * The certificate data in PEM format.
     */
    get certificatePem(): string | undefined;
    /**
     * The certificate data in PEM format.
     */
    set certificatePem(value: string | undefined);
    /**
     * The certificate signing request (CSR).
     */
    get certificateSigningRequest(): string | undefined;
    /**
     * The certificate signing request (CSR).
     */
    set certificateSigningRequest(value: string | undefined);
    /**
     * The status of the certificate.
     */
    get status(): string;
...
export declare class CfnCustomMetric extends cdk.CfnResource implements cdk.IInspectable, ICustomMetricRef, cdk.ITaggable {
     ...
     */
    static isCfnCustomMetric(x: any): x is CfnCustomMetric;
    /**
     * Creates a new ICustomMetricRef from a metricName
     */
    static fromMetricName(scope: constructs.Construct, id: string, metricName: string): ICustomMetricRef;
    static arnForCustomMetric(resource: ICustomMetricRef): string;
    /**
...
export declare class CfnDimension extends cdk.CfnResource implements cdk.IInspectable, IDimensionRef, cdk.ITaggable {
     ...
     */
    static isCfnDimension(x: any): x is CfnDimension;
    /**
     * Creates a new IDimensionRef from an ARN
     */
    static fromDimensionArn(scope: constructs.Construct, id: string, arn: string): IDimensionRef;
    /**
     * Creates a new IDimensionRef from a dimensionName
     */
    static fromDimensionName(scope: constructs.Construct, id: string, dimensionName: string): IDimensionRef;
    static arnForDimension(resource: IDimensionRef): string;
    /**
     ...
     * Specifies the value or list of values for the dimension.
     */
    set stringValues(value: Array<string>);
    /**
     * Metadata that can be used to manage the dimension.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnDomainConfiguration extends cdk.CfnResource implements cdk.IInspectable, IDomainConfigurationRef, cdk.ITaggable {
    ...
    /**
     * Checks whether the given object is a CfnDomainConfiguration
     */
    static isCfnDomainConfiguration(x: any): x is CfnDomainConfiguration;
    /**
     * Creates a new IDomainConfigurationRef from an ARN
     */
    static fromDomainConfigurationArn(scope: constructs.Construct, id: string, arn: string): IDomainConfigurationRef;
    /**
     * Creates a new IDomainConfigurationRef from a domainConfigurationName
     */
    static fromDomainConfigurationName(scope: constructs.Construct, id: string, domainConfigurationName: string): IDomainConfigurationRef;
    static arnForDomainConfiguration(resource: IDomainConfigurationRef): string;
    /**
     ...
     */
    private _serverCertificateConfig?;
    /**
     ...
     * An enumerated string that speciﬁes the application-layer protocol.
     */
    set applicationProtocol(value: string | undefined);
    /**
     * An enumerated string that speciﬁes the authentication type.
     */
     ...
     * An enumerated string that speciﬁes the authentication type.
     */
    set authenticationType(value: string | undefined);
    /**
     * An object that specifies the authorization service for a domain.
     */
    get authorizerConfig(): CfnDomainConfiguration.AuthorizerConfigProperty | cdk.IResolvable | undefined;
    /**
     * An object that specifies the authorization service for a domain.
     */
    set authorizerConfig(value: CfnDomainConfiguration.AuthorizerConfigProperty | cdk.IResolvable | undefined);
    /**
     * An object that speciﬁes the client certificate conﬁguration for a domain.
     */
    get clientCertificateConfig(): CfnDomainConfiguration.ClientCertificateConfigProperty | cdk.IResolvable | undefined;
    /**
     * An object that speciﬁes the client certificate conﬁguration for a domain.
     */
    set clientCertificateConfig(value: CfnDomainConfiguration.ClientCertificateConfigProperty | cdk.IResolvable | undefined);
    /**
     * The name of the domain configuration.
     */
    get domainConfigurationName(): string | undefined;
    /**
     * The name of the domain configuration.
     */
    set domainConfigurationName(value: string | undefined);
    /**
     * The status to which the domain configuration should be updated.
     */
    get domainConfigurationStatus(): string | undefined;
    /**
     * The status to which the domain configuration should be updated.
     */
    set domainConfigurationStatus(value: string | undefined);
    /**
     * The name of the domain.
     */
     ...
     * The ARNs of the certificates that AWS IoT passes to the device during the TLS handshake.
     */
    get serverCertificateArns(): Array<string> | undefined;
    /**
     * The ARNs of the certificates that AWS IoT passes to the device during the TLS handshake.
     */
    set serverCertificateArns(value: Array<string> | undefined);
    /**
     * The server certificate configuration.
     */
    get serverCertificateConfig(): cdk.IResolvable | CfnDomainConfiguration.ServerCertificateConfigProperty | undefined;
    /**
     * The server certificate configuration.
     */
    set serverCertificateConfig(value: cdk.IResolvable | CfnDomainConfiguration.ServerCertificateConfigProperty | undefined);
    /**
     * The type of service delivered by the endpoint.
     */
     ...
     * An object that specifies the TLS configuration for a domain.
     */
    get tlsConfig(): cdk.IResolvable | CfnDomainConfiguration.TlsConfigProperty | undefined;
    /**
     * An object that specifies the TLS configuration for a domain.
     */
    set tlsConfig(value: cdk.IResolvable | CfnDomainConfiguration.TlsConfigProperty | undefined);
    /**
     * The certificate used to validate the server certificate and prove domain name ownership.
     */
    get validationCertificateArn(): string | undefined;
    /**
     * The certificate used to validate the server certificate and prove domain name ownership.
     */
    set validationCertificateArn(value: string | undefined);
    /**
...
export declare class CfnFleetMetric extends cdk.CfnResource implements cdk.IInspectable, IFleetMetricRef, cdk.ITaggable {
     ...
     */
    static isCfnFleetMetric(x: any): x is CfnFleetMetric;
    /**
     ...
     * The field to aggregate.
     */
    get aggregationField(): string | undefined;
    /**
     * The field to aggregate.
     */
    set aggregationField(value: string | undefined);
    /**
     * The type of the aggregation query.
     */
    get aggregationType(): CfnFleetMetric.AggregationTypeProperty | cdk.IResolvable | undefined;
    /**
     * The type of the aggregation query.
     */
    set aggregationType(value: CfnFleetMetric.AggregationTypeProperty | cdk.IResolvable | undefined);
    /**
     * The fleet metric description.
     */
     ...
     * The name of the index to search.
     */
    set indexName(value: string | undefined);
    /**
     * The name of the fleet metric to create.
     */
     ...
     * The query version.
     */
    get queryVersion(): string | undefined;
    /**
     * The query version.
     */
    set queryVersion(value: string | undefined);
    /**
     * Metadata which can be used to manage the fleet metric.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrVersion(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnJobTemplate extends cdk.CfnResource implements cdk.IInspectable, IJobTemplateRef, cdk.ITaggable {
     ...
     */
    static fromJobTemplateId(scope: constructs.Construct, id: string, jobTemplateId: string): IJobTemplateRef;
    static arnForJobTemplate(resource: IJobTemplateRef): string;
    /**
     * The criteria that determine when and how a job abort takes place.
     */
    private _abortConfig?;
    /**
     ...
     */
    private _destinationPackageVersions?;
    /**
     * The job document.
     */
    private _document?;
     ...
     */
    private _jobExecutionsRetryConfig?;
    /**
     * Allows you to create a staged rollout of a job.
     */
    private _jobExecutionsRolloutConfig?;
    /**
     ...
     * The criteria that determine when and how a job abort takes place.
     */
    get abortConfig(): any | cdk.IResolvable | undefined;
    /**
     * The criteria that determine when and how a job abort takes place.
     */
    set abortConfig(value: any | cdk.IResolvable | undefined);
    /**
     * A description of the job template.
     */
     ...
     * The package version Amazon Resource Names (ARNs) that are installed on the device’s reserved named shadow ( `$package` ) when the job successfully completes.
     */
    get destinationPackageVersions(): Array<string> | undefined;
    /**
     * The package version Amazon Resource Names (ARNs) that are installed on the device’s reserved named shadow ( `$package` ) when the job successfully completes.
     */
    set destinationPackageVersions(value: Array<string> | undefined);
    /**
     * The job document.
     */
     ...
     * An S3 link, or S3 object URL, to the job document.
     */
    get documentSource(): string | undefined;
    /**
     * An S3 link, or S3 object URL, to the job document.
     */
    set documentSource(value: string | undefined);
    /**
     * The ARN of the job to use as the basis for the job template.
     */
    get jobArn(): string | undefined;
    /**
     * The ARN of the job to use as the basis for the job template.
     */
    set jobArn(value: string | undefined);
    /**
     * Allows you to create the criteria to retry a job.
     */
    get jobExecutionsRetryConfig(): cdk.IResolvable | CfnJobTemplate.JobExecutionsRetryConfigProperty | undefined;
    /**
     * Allows you to create the criteria to retry a job.
     */
    set jobExecutionsRetryConfig(value: cdk.IResolvable | CfnJobTemplate.JobExecutionsRetryConfigProperty | undefined);
    /**
     * Allows you to create a staged rollout of a job.
     */
    get jobExecutionsRolloutConfig(): any | cdk.IResolvable | undefined;
    /**
     * Allows you to create a staged rollout of a job.
     */
    set jobExecutionsRolloutConfig(value: any | cdk.IResolvable | undefined);
    /**
     * A unique identifier for the job template.
     */
     ...
     * An optional configuration within the SchedulingConfig to setup a recurring maintenance window with a predetermined start time and duration for the rollout of a job document to all devices in a target group for a job.
     */
    get maintenanceWindows(): Array<cdk.IResolvable | CfnJobTemplate.MaintenanceWindowProperty> | cdk.IResolvable | undefined;
    /**
     * An optional configuration within the SchedulingConfig to setup a recurring maintenance window with a predetermined start time and duration for the rollout of a job document to all devices in a target group for a job.
     */
    set maintenanceWindows(value: Array<cdk.IResolvable | CfnJobTemplate.MaintenanceWindowProperty> | cdk.IResolvable | undefined);
    /**
     * Configuration for pre-signed S3 URLs.
     */
    get presignedUrlConfig(): any | cdk.IResolvable | undefined;
    /**
     * Configuration for pre-signed S3 URLs.
     */
    set presignedUrlConfig(value: any | cdk.IResolvable | undefined);
    /**
     * Metadata that can be used to manage the job template.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Specifies the amount of time each device has to finish its execution of the job.
     */
    get timeoutConfig(): any | cdk.IResolvable | undefined;
    /**
     * Specifies the amount of time each device has to finish its execution of the job.
     */
    set timeoutConfig(value: any | cdk.IResolvable | undefined);
    /**
     * The ARN of the job to use as the basis for the job template.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnLogging extends cdk.CfnResource implements cdk.IInspectable, ILoggingRef {
     ...
     */
    static isCfnLogging(x: any): x is CfnLogging;
    /**
     * The account ID.
     */
    private _accountId;
     ...
     * Configurations for event-based logging that specifies which event types to log and their logging settings.
     */
    get eventConfigurations(): Array<CfnLogging.EventConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Configurations for event-based logging that specifies which event types to log and their logging settings.
     */
    set eventConfigurations(value: Array<CfnLogging.EventConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The role ARN used for the log.
     */
    get roleArn(): string;
...
export declare namespace CfnLogging {
    /**
...
export interface CfnLoggingProps {
     ...
     */
    readonly eventConfigurations?: Array<CfnLogging.EventConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The role ARN used for the log.
     *
...
export declare class CfnMitigationAction extends cdk.CfnResource implements cdk.IInspectable, IMitigationActionRef, cdk.ITaggable {
     ...
     */
    static isCfnMitigationAction(x: any): x is CfnMitigationAction;
    static arnForMitigationAction(resource: IMitigationActionRef): string;
    /**
     ...
     * The set of parameters for this mitigation action.
     */
    get actionParams(): CfnMitigationAction.ActionParamsProperty | cdk.IResolvable;
    /**
     * The set of parameters for this mitigation action.
     */
    set actionParams(value: CfnMitigationAction.ActionParamsProperty | cdk.IResolvable);
    /**
     * The IAM role ARN used to apply this mitigation action.
     */
    get roleArn(): string;
...
export declare class CfnPolicy extends cdk.CfnResource implements cdk.IInspectable, IPolicyRef, cdk.ITaggableV2 {
     ...
     */
    static fromPolicyArn(scope: constructs.Construct, id: string, arn: string): IPolicyRef;
    /**
     * Creates a new IPolicyRef from a policyName
     */
    static fromPolicyName(scope: constructs.Construct, id: string, policyName: string): IPolicyRef;
...
export declare class CfnPolicyPrincipalAttachment extends cdk.CfnResource implements cdk.IInspectable, IPolicyPrincipalAttachmentRef {
     ...
     */
    static isCfnPolicyPrincipalAttachment(x: any): x is CfnPolicyPrincipalAttachment;
    /**
...
export declare class CfnProvisioningTemplate extends cdk.CfnResource implements cdk.IInspectable, IProvisioningTemplateRef, cdk.ITaggable {
     ...
     */
    static isCfnProvisioningTemplate(x: any): x is CfnProvisioningTemplate;
    /**
     * Creates a new IProvisioningTemplateRef from a templateName
     */
    static fromTemplateName(scope: constructs.Construct, id: string, templateName: string): IProvisioningTemplateRef;
    static arnForProvisioningTemplate(resource: IProvisioningTemplateRef): string;
    /**
     ...
     * Creates a pre-provisioning hook template.
     */
    get preProvisioningHook(): cdk.IResolvable | CfnProvisioningTemplate.ProvisioningHookProperty | undefined;
    /**
     * Creates a pre-provisioning hook template.
     */
    set preProvisioningHook(value: cdk.IResolvable | CfnProvisioningTemplate.ProvisioningHookProperty | undefined);
    /**
     * The role ARN for the role associated with the fleet provisioning template.
     */
     ...
     * The type of the provisioning template.
     */
    set templateType(value: string | undefined);
    /**
...
export interface CfnProvisioningTemplateProps {
     ...
     */
    readonly provisioningRoleArn: iamRefs.IRoleRef | string;
    /**
     * Metadata that can be used to manage the fleet provisioning template.
     *
...
export declare class CfnResourceSpecificLogging extends cdk.CfnResource implements cdk.IInspectable, IResourceSpecificLoggingRef {
    ...
    /**
     * Checks whether the given object is a CfnResourceSpecificLogging
     */
    static isCfnResourceSpecificLogging(x: any): x is CfnResourceSpecificLogging;
    /**
...
export declare class CfnRoleAlias extends cdk.CfnResource implements cdk.IInspectable, IRoleAliasRef, cdk.ITaggable {
     ...
     */
    static isCfnRoleAlias(x: any): x is CfnRoleAlias;
    /**
     * Creates a new IRoleAliasRef from an ARN
     */
    static fromRoleAliasArn(scope: constructs.Construct, id: string, arn: string): IRoleAliasRef;
    /**
     * Creates a new IRoleAliasRef from a roleAlias
     */
    static fromRoleAlias(scope: constructs.Construct, id: string, roleAlias: string): IRoleAliasRef;
    static arnForRoleAlias(resource: IRoleAliasRef): string;
    /**
     * The number of seconds for which the credential is valid.
     */
    private _credentialDurationSeconds?;
    /**
     * The role alias.
     */
    private _roleAlias?;
     ...
     * The number of seconds for which the credential is valid.
     */
    get credentialDurationSeconds(): number | undefined;
    /**
     * The number of seconds for which the credential is valid.
     */
    set credentialDurationSeconds(value: number | undefined);
    /**
     * The role alias.
     */
     ...
     * The role alias.
     */
    set roleAlias(value: string | undefined);
    /**
     * The role ARN.
     */
    get roleArn(): string;
...
export declare class CfnScheduledAudit extends cdk.CfnResource implements cdk.IInspectable, IScheduledAuditRef, cdk.ITaggable {
     ...
     */
    static isCfnScheduledAudit(x: any): x is CfnScheduledAudit;
    /**
     * Creates a new IScheduledAuditRef from an ARN
     */
    static fromScheduledAuditArn(scope: constructs.Construct, id: string, arn: string): IScheduledAuditRef;
    /**
     * Creates a new IScheduledAuditRef from a scheduledAuditName
     */
    static fromScheduledAuditName(scope: constructs.Construct, id: string, scheduledAuditName: string): IScheduledAuditRef;
    static arnForScheduledAudit(resource: IScheduledAuditRef): string;
    /**
     ...
     * The day of the month on which the scheduled audit is run (if the `frequency` is "MONTHLY").
     */
    get dayOfMonth(): string | undefined;
    /**
     * The day of the month on which the scheduled audit is run (if the `frequency` is "MONTHLY").
     */
    set dayOfMonth(value: string | undefined);
    /**
     * The day of the week on which the scheduled audit is run (if the `frequency` is "WEEKLY" or "BIWEEKLY").
     */
     ...
     * The name of the scheduled audit.
     */
    get scheduledAuditName(): string | undefined;
    /**
     * The name of the scheduled audit.
     */
    set scheduledAuditName(value: string | undefined);
    /**
     * Metadata that can be used to manage the scheduled audit.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Which checks are performed during the scheduled audit.
     */
    get targetCheckNames(): Array<string>;
    /**
     * Which checks are performed during the scheduled audit.
     */
    set targetCheckNames(value: Array<string>);
    /**
     * The ARN of the scheduled audit.
     *
     * @cloudformationAttribute ScheduledAuditArn
     */
    get attrScheduledAuditArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnSecurityProfile extends cdk.CfnResource implements cdk.IInspectable, ISecurityProfileRef, cdk.ITaggable {
     ...
     */
    static fromSecurityProfileArn(scope: constructs.Construct, id: string, arn: string): ISecurityProfileRef;
    /**
     * Creates a new ISecurityProfileRef from a securityProfileName
     */
    static fromSecurityProfileName(scope: constructs.Construct, id: string, securityProfileName: string): ISecurityProfileRef;
     ...
     * A list of metrics whose data is retained (stored).
     */
    get additionalMetricsToRetainV2(): Array<cdk.IResolvable | CfnSecurityProfile.MetricToRetainProperty> | cdk.IResolvable | undefined;
    /**
     * A list of metrics whose data is retained (stored).
     */
    set additionalMetricsToRetainV2(value: Array<cdk.IResolvable | CfnSecurityProfile.MetricToRetainProperty> | cdk.IResolvable | undefined);
    /**
     * Specifies the destinations to which alerts are sent.
     */
    get alertTargets(): cdk.IResolvable | Record<string, CfnSecurityProfile.AlertTargetProperty | cdk.IResolvable> | undefined;
    /**
     * Specifies the destinations to which alerts are sent.
     */
    set alertTargets(value: cdk.IResolvable | Record<string, CfnSecurityProfile.AlertTargetProperty | cdk.IResolvable> | undefined);
    /**
     * Specifies the behaviors that, when violated by a device (thing), cause an alert.
     */
    get behaviors(): Array<CfnSecurityProfile.BehaviorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the behaviors that, when violated by a device (thing), cause an alert.
     */
    set behaviors(value: Array<CfnSecurityProfile.BehaviorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the MQTT topic and role ARN required for metric export.
     */
    get metricsExportConfig(): cdk.IResolvable | CfnSecurityProfile.MetricsExportConfigProperty | undefined;
    /**
     * Specifies the MQTT topic and role ARN required for metric export.
     */
    set metricsExportConfig(value: cdk.IResolvable | CfnSecurityProfile.MetricsExportConfigProperty | undefined);
    /**
     * A description of the security profile.
     */
    get securityProfileDescription(): string | undefined;
    /**
     * A description of the security profile.
     */
    set securityProfileDescription(value: string | undefined);
    /**
     * The name you gave to the security profile.
     */
    get securityProfileName(): string | undefined;
    /**
     * The name you gave to the security profile.
     */
    set securityProfileName(value: string | undefined);
    /**
     * Metadata that can be used to manage the security profile.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The ARN of the target (thing group) to which the security profile is attached.
     */
    get targetArns(): Array<string> | undefined;
    /**
     * The ARN of the target (thing group) to which the security profile is attached.
     */
    set targetArns(value: Array<string> | undefined);
    /**
...
export declare class CfnSoftwarePackage extends cdk.CfnResource implements cdk.IInspectable, ISoftwarePackageRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnSoftwarePackage(x: any): x is CfnSoftwarePackage;
    /**
     * Creates a new ISoftwarePackageRef from a packageName
     */
    static fromPackageName(scope: constructs.Construct, id: string, packageName: string): ISoftwarePackageRef;
    static arnForSoftwarePackage(resource: ISoftwarePackageRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnSoftwarePackageVersion extends cdk.CfnResource implements cdk.IInspectable, ISoftwarePackageVersionRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnSoftwarePackageVersion(x: any): x is CfnSoftwarePackageVersion;
    /**
     ...
     * The artifact location of the package version.
     */
    get artifact(): cdk.IResolvable | CfnSoftwarePackageVersion.PackageVersionArtifactProperty | undefined;
    /**
     * The artifact location of the package version.
     */
    set artifact(value: cdk.IResolvable | CfnSoftwarePackageVersion.PackageVersionArtifactProperty | undefined);
    /**
     * Metadata that can be used to define a package version’s configuration.
     */
     ...
     * The inline json job document associated with a software package version.
     */
    get recipe(): string | undefined;
    /**
     * The inline json job document associated with a software package version.
     */
    set recipe(value: string | undefined);
    /**
     * The sbom zip archive location of the package version.
     */
    get sbom(): cdk.IResolvable | CfnSoftwarePackageVersion.SbomProperty | undefined;
    /**
     * The sbom zip archive location of the package version.
     */
    set sbom(value: cdk.IResolvable | CfnSoftwarePackageVersion.SbomProperty | undefined);
    /**
     * Metadata that can be used to manage the package version.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnThing extends cdk.CfnResource implements cdk.IInspectable, IThingRef {
     ...
     */
    static isCfnThing(x: any): x is CfnThing;
    /**
     * Creates a new IThingRef from an ARN
     */
    static fromThingArn(scope: constructs.Construct, id: string, arn: string): IThingRef;
    /**
     * Creates a new IThingRef from a thingName
     */
    static fromThingName(scope: constructs.Construct, id: string, thingName: string): IThingRef;
    static arnForThing(resource: IThingRef): string;
    /**
     ...
     * A string that contains up to three key value pairs.
     */
    get attributePayload(): CfnThing.AttributePayloadProperty | cdk.IResolvable | undefined;
    /**
     * A string that contains up to three key value pairs.
     */
    set attributePayload(value: CfnThing.AttributePayloadProperty | cdk.IResolvable | undefined);
    /**
     * The name of the thing to update.
     */
    get thingName(): string | undefined;
    /**
     * The name of the thing to update.
     */
    set thingName(value: string | undefined);
    /**
...
export declare class CfnThingGroup extends cdk.CfnResource implements cdk.IInspectable, IThingGroupRef, cdk.ITaggable {
    ...
    /**
     * Checks whether the given object is a CfnThingGroup
     */
    static isCfnThingGroup(x: any): x is CfnThingGroup;
    /**
     * Creates a new IThingGroupRef from an ARN
     */
    static fromThingGroupArn(scope: constructs.Construct, id: string, arn: string): IThingGroupRef;
    /**
     * Creates a new IThingGroupRef from a thingGroupName
     */
    static fromThingGroupName(scope: constructs.Construct, id: string, thingGroupName: string): IThingGroupRef;
    static arnForThingGroup(resource: IThingGroupRef): string;
    /**
     ...
     * The parent thing group name.
     */
    get parentGroupName(): string | undefined;
    /**
     * The parent thing group name.
     */
    set parentGroupName(value: string | undefined);
    /**
     * The dynamic thing group search query string.
     */
    get queryString(): string | undefined;
     ...
     * The thing group name.
     */
    get thingGroupName(): string | undefined;
    /**
     * The thing group name.
     */
    set thingGroupName(value: string | undefined);
    /**
     * Thing group properties.
     */
    get thingGroupProperties(): cdk.IResolvable | CfnThingGroup.ThingGroupPropertiesProperty | undefined;
    /**
     * Thing group properties.
     */
    set thingGroupProperties(value: cdk.IResolvable | CfnThingGroup.ThingGroupPropertiesProperty | undefined);
    /**
     * The thing group ARN.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnThingPrincipalAttachment extends cdk.CfnResource implements cdk.IInspectable, IThingPrincipalAttachmentRef {
    ...
    /**
     * Checks whether the given object is a CfnThingPrincipalAttachment
     */
    static isCfnThingPrincipalAttachment(x: any): x is CfnThingPrincipalAttachment;
    /**
     * The principal, which can be a certificate ARN (as returned from the `CreateCertificate` operation) or an Amazon Cognito ID.
     */
    private _principal;
    ...
    get thingPrincipalType(): string | undefined;
    set thingPrincipalType(value: string | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnThingType extends cdk.CfnResource implements cdk.IInspectable, IThingTypeRef, cdk.ITaggable {
     ...
     */
    static isCfnThingType(x: any): x is CfnThingType;
    /**
     * Creates a new IThingTypeRef from an ARN
     */
    static fromThingTypeArn(scope: constructs.Construct, id: string, arn: string): IThingTypeRef;
    /**
     * Creates a new IThingTypeRef from a thingTypeName
     */
    static fromThingTypeName(scope: constructs.Construct, id: string, thingTypeName: string): IThingTypeRef;
    static arnForThingType(resource: IThingTypeRef): string;
    /**
     * Deprecates a thing type. You can not associate new things with deprecated thing type.
     */
    private _deprecateThingType?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * Deprecates a thing type. You can not associate new things with deprecated thing type.
     */
    get deprecateThingType(): boolean | cdk.IResolvable | undefined;
    /**
     * Deprecates a thing type. You can not associate new things with deprecated thing type.
     */
    set deprecateThingType(value: boolean | cdk.IResolvable | undefined);
    /**
     * Metadata which can be used to manage the thing type.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The thing type properties for the thing type to create.
     */
    get thingTypeProperties(): cdk.IResolvable | CfnThingType.ThingTypePropertiesProperty | undefined;
    /**
     * The thing type properties for the thing type to create.
     */
    set thingTypeProperties(value: cdk.IResolvable | CfnThingType.ThingTypePropertiesProperty | undefined);
    /**
     * The thing type arn.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnTopicRule extends cdk.CfnResource implements cdk.IInspectable, ITopicRuleRef, cdk.ITaggable {
     ...
     */
    static isCfnTopicRule(x: any): x is CfnTopicRule;
    /**
     * Creates a new ITopicRuleRef from an ARN
     */
    static fromTopicRuleArn(scope: constructs.Construct, id: string, arn: string): ITopicRuleRef;
    /**
     * Creates a new ITopicRuleRef from a ruleName
     */
    static fromRuleName(scope: constructs.Construct, id: string, ruleName: string): ITopicRuleRef;
    static arnForTopicRule(resource: ITopicRuleRef): string;
    /**
     ...
     * The rule payload.
     */
    get topicRulePayload(): cdk.IResolvable | CfnTopicRule.TopicRulePayloadProperty;
    /**
     * The rule payload.
     */
    set topicRulePayload(value: cdk.IResolvable | CfnTopicRule.TopicRulePayloadProperty);
    /**
...
export declare namespace CfnTopicRule {
    ...
    interface HttpActionProperty {
         ...
         */
        readonly batchConfig?: CfnTopicRule.BatchConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly enableBatching?: boolean | cdk.IResolvable;
        /**
    ...
    interface BatchConfigProperty {
         ...
         */
        readonly batchAcrossTopics?: boolean | cdk.IResolvable;
        /**
...
export declare class CfnTopicRuleDestination extends cdk.CfnResource implements cdk.IInspectable, ITopicRuleDestinationRef {
     ...
     */
    static isCfnTopicRuleDestination(x: any): x is CfnTopicRuleDestination;
    static arnForTopicRuleDestination(resource: ITopicRuleDestinationRef): string;
    /**
     ...
     * Properties of the HTTP URL.
     */
    get httpUrlProperties(): CfnTopicRuleDestination.HttpUrlDestinationSummaryProperty | cdk.IResolvable | undefined;
    /**
     * Properties of the HTTP URL.
     */
    set httpUrlProperties(value: CfnTopicRuleDestination.HttpUrlDestinationSummaryProperty | cdk.IResolvable | undefined);
    /**
     * - **IN_PROGRESS** - A topic rule destination was created but has not been confirmed.
     */
    get status(): string | undefined;
     ...
     * Properties of the virtual private cloud (VPC) connection.
     */
    get vpcProperties(): cdk.IResolvable | CfnTopicRuleDestination.VpcDestinationPropertiesProperty | undefined;
    /**
     * Properties of the virtual private cloud (VPC) connection.
     */
    set vpcProperties(value: cdk.IResolvable | CfnTopicRuleDestination.VpcDestinationPropertiesProperty | undefined);
    /**
...
export declare class CfnCertificateProvider extends cdk.CfnResource implements cdk.IInspectable, ICertificateProviderRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCertificateProvider(x: any): x is CfnCertificateProvider;
    /**
     * Creates a new ICertificateProviderRef from an ARN
     */
    static fromCertificateProviderArn(scope: constructs.Construct, id: string, arn: string): ICertificateProviderRef;
    /**
     * Creates a new ICertificateProviderRef from a certificateProviderName
     */
    static fromCertificateProviderName(scope: constructs.Construct, id: string, certificateProviderName: string): ICertificateProviderRef;
    static arnForCertificateProvider(resource: ICertificateProviderRef): string;
    /**
     * A list of the operations that the certificate provider will use to generate certificates.
     */
    private _accountDefaultForOperations;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _certificateProviderName?;
    /**
     * The ARN of the Lambda function.
     */
     ...
     * A list of the operations that the certificate provider will use to generate certificates.
     */
    get accountDefaultForOperations(): Array<string>;
    /**
     * A list of the operations that the certificate provider will use to generate certificates.
     */
    set accountDefaultForOperations(value: Array<string>);
    /**
     * The name of the certificate provider.
     */
    get certificateProviderName(): string | undefined;
    /**
     * The name of the certificate provider.
     */
    set certificateProviderName(value: string | undefined);
    /**
     * The ARN of the Lambda function.
     */
...
export declare class CfnCommand extends cdk.CfnResource implements cdk.IInspectable, ICommandRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCommand(x: any): x is CfnCommand;
    /**
     * Creates a new ICommandRef from an ARN
     */
    static fromCommandArn(scope: constructs.Construct, id: string, arn: string): ICommandRef;
    /**
     * Creates a new ICommandRef from a commandId
     */
    static fromCommandId(scope: constructs.Construct, id: string, commandId: string): ICommandRef;
    static arnForCommand(resource: ICommandRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * Indicates whether the command has been deprecated.
     */
    get deprecated(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the command has been deprecated.
     */
    set deprecated(value: boolean | cdk.IResolvable | undefined);
    /**
     * The description of the command parameter.
     */
    get description(): string | undefined;
     ...
     * The timestamp, when the command was last updated.
     */
    set lastUpdatedAt(value: string | undefined);
    get mandatoryParameters(): Array<CfnCommand.CommandParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    set mandatoryParameters(value: Array<CfnCommand.CommandParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The namespace to which the command belongs.
     */
    ...
    get payload(): CfnCommand.CommandPayloadProperty | cdk.IResolvable | undefined;
    set payload(value: CfnCommand.CommandPayloadProperty | cdk.IResolvable | undefined);
    /**
     * The payload template associated with the command.
     */
    get payloadTemplate(): string | undefined;
    /**
     * The payload template associated with the command.
     */
    set payloadTemplate(value: string | undefined);
    /**
     * Indicates whether the command is pending deletion.
     */
    get pendingDeletion(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the command is pending deletion.
     */
    set pendingDeletion(value: boolean | cdk.IResolvable | undefined);
    get preprocessor(): CfnCommand.CommandPreprocessorProperty | cdk.IResolvable | undefined;
    set preprocessor(value: CfnCommand.CommandPreprocessorProperty | cdk.IResolvable | undefined);
    /**
     * The customer role associated with the command.
     */
...
export declare namespace CfnCommand {
    ...
    interface CommandParameterProperty {
         ...
         */
        readonly valueConditions?: Array<CfnCommand.CommandParameterValueConditionProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CommandParameterValueConditionProperty {
         ...
         */
        readonly operand: CfnCommand.CommandParameterValueComparisonOperandProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface CommandParameterValueComparisonOperandProperty {
        /**
         ...
         */
        readonly numberRange?: CfnCommand.CommandParameterValueNumberRangeProperty | cdk.IResolvable;
        /**
     ...
     */
    interface CommandParameterValueNumberRangeProperty {
        /**
     ...
     */
    interface CommandPreprocessorProperty {
        /**
         ...
         */
        readonly awsJsonSubstitution?: CfnCommand.AwsJsonSubstitutionCommandPreprocessorConfigProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface AwsJsonSubstitutionCommandPreprocessorConfigProperty {
        /**
...
export interface CfnCommandProps {
     ...
     */
    readonly preprocessor?: CfnCommand.CommandPreprocessorProperty | cdk.IResolvable;
    /**
     * The customer role associated with the command.
     *
...
export declare class CfnEncryptionConfiguration extends cdk.CfnResource implements cdk.IInspectable, IEncryptionConfigurationRef {
     ...
     */
    static isCfnEncryptionConfiguration(x: any): x is CfnEncryptionConfiguration;
    /**
     ...
     * The Amazon Resource Name (ARN) of the IAM role assumed by AWS IoT Core to call AWS  on behalf of the customer.
     */
    get kmsAccessRoleArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the IAM role assumed by AWS IoT Core to call AWS  on behalf of the customer.
     */
    set kmsAccessRoleArn(value: string | undefined);
    /**
     * The ARN of the customer managed KMS key.
     */
     ...
     */
    get attrConfigurationDetails(): cdk.IResolvable;
    /**
     * The date when encryption configuration is last updated.
     *
     * @cloudformationAttribute LastModifiedDate
     */
    get attrLastModifiedDate(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 *
 * @cloudformationResource AWS::IoT::Index
 * @stability external
...
export declare class CfnIndex extends cdk.CfnResource implements cdk.IInspectable, IIndexRef {
    ...
    get attrId(): string;
    /**
     * @cloudformationAttribute IndexStatus
     */
    get attrIndexStatus(): string;
    /**
     * @cloudformationAttribute Schema
     */
    get attrSchema(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IAccountAuditConfigurationRef, AccountAuditConfigurationReference };
export type { IAuthorizerRef, AuthorizerReference };
export type { IBillingGroupRef, BillingGroupReference };
export type { ICACertificateRef, CACertificateReference };
export type { ICertificateRef, CertificateReference };
export type { ICustomMetricRef, CustomMetricReference };
export type { IDimensionRef, DimensionReference };
export type { IDomainConfigurationRef, DomainConfigurationReference };
export type { IFleetMetricRef, FleetMetricReference };
export type { IJobTemplateRef, JobTemplateReference };
export type { ILoggingRef, LoggingReference };
export type { IMitigationActionRef, MitigationActionReference };
export type { IPolicyRef, PolicyReference };
export type { IPolicyPrincipalAttachmentRef, PolicyPrincipalAttachmentReference };
export type { IProvisioningTemplateRef, ProvisioningTemplateReference };
export type { IResourceSpecificLoggingRef, ResourceSpecificLoggingReference };
export type { IRoleAliasRef, RoleAliasReference };
export type { IScheduledAuditRef, ScheduledAuditReference };
export type { ISecurityProfileRef, SecurityProfileReference };
export type { ISoftwarePackageRef, SoftwarePackageReference };
export type { ISoftwarePackageVersionRef, SoftwarePackageVersionReference };
export type { IThingRef, ThingReference };
export type { IThingGroupRef, ThingGroupReference };
export type { IThingPrincipalAttachmentRef, ThingPrincipalAttachmentReference };
export type { IThingTypeRef, ThingTypeReference };
export type { ITopicRuleRef, TopicRuleReference };
export type { ITopicRuleDestinationRef, TopicRuleDestinationReference };
export type { ICertificateProviderRef, CertificateProviderReference };
export type { ICommandRef, CommandReference };
export type { IEncryptionConfigurationRef, EncryptionConfigurationReference };
