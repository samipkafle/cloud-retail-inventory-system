...
import type { IAccessPolicy, AccessEntryType } from './access-entry';
...
export declare class KubernetesVersion {
     ...
     */
    static readonly V1_35: KubernetesVersion;
    /**
     ...
     */
    static readonly V1_36: KubernetesVersion;
    /**
...
export declare class Cluster extends ClusterBase {
    ...
    private readonly _removalPolicy?;
    /**
     ...
     */
    grantAccess(id: string, principal: string, accessPolicies: IAccessPolicy[], options?: GrantAccessOptions): void;
    /**
