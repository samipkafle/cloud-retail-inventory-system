...
import type { ISubnetRef, IVPCRef, SubnetReference, VPCReference } from './ec2.generated';
import { CfnNatGateway } from './ec2.generated';
import type { IIpAddresses, IIpv6Addresses } from './ip-addresses';
import { NatProvider } from './nat';
import type { INetworkAcl } from './network-acl';
import { SubnetFilter } from './subnet';
import type { GatewayVpcEndpointOptions, InterfaceVpcEndpointOptions } from './vpc-endpoint';
import { GatewayVpcEndpoint, InterfaceVpcEndpoint } from './vpc-endpoint';
import type { FlowLogOptions } from './vpc-flow-logs';
import { FlowLog } from './vpc-flow-logs';
