...
import { IInboundExternalLinkRef, ILinkRef, ILinkRoutingRuleRef, InboundExternalLinkReference, IOutboundExternalLinkRef, IRequesterGatewayRef, IResponderGatewayRef, LinkReference, LinkRoutingRuleReference, OutboundExternalLinkReference, RequesterGatewayReference, ResponderGatewayReference } from "../../interfaces/generated/aws-rtbfabric-interfaces.generated";
...
export declare class CfnInboundExternalLink extends cdk.CfnResource implements cdk.IInspectable, IInboundExternalLinkRef, cdk.ITaggableV2 {
    ...
    get linkAttributes(): cdk.IResolvable | CfnInboundExternalLink.LinkAttributesProperty | undefined;
    set linkAttributes(value: cdk.IResolvable | CfnInboundExternalLink.LinkAttributesProperty | undefined);
    get linkLogSettings(): cdk.IResolvable | CfnInboundExternalLink.LinkLogSettingsProperty;
    set linkLogSettings(value: cdk.IResolvable | CfnInboundExternalLink.LinkLogSettingsProperty);
    /**
     * Tags to assign to the Link.
     */
     ...
     */
    get attrLinkStatus(): string;
    /**
     * @cloudformationAttribute UpdatedTimestamp
     */
    get attrUpdatedTimestamp(): string;
...
export declare class CfnLink extends cdk.CfnResource implements cdk.IInspectable, ILinkRef, cdk.ITaggableV2 {
     ...
     */
    private _linkLogSettings;
    private _moduleConfigurationList?;
    /**
     * The unique identifier of the peer gateway.
     */
    private _peerGatewayId;
    /**
     ...
     * Boolean to specify if an HTTP responder is allowed.
     */
    get httpResponderAllowed(): boolean | cdk.IResolvable | undefined;
    /**
     * Boolean to specify if an HTTP responder is allowed.
     */
    set httpResponderAllowed(value: boolean | cdk.IResolvable | undefined);
    /**
     * Attributes of the link.
     */
    get linkAttributes(): cdk.IResolvable | CfnLink.LinkAttributesProperty | undefined;
    /**
     * Attributes of the link.
     */
    set linkAttributes(value: cdk.IResolvable | CfnLink.LinkAttributesProperty | undefined);
    /**
     * Settings for the application logs.
     */
    get linkLogSettings(): cdk.IResolvable | CfnLink.LinkLogSettingsProperty;
    /**
     * Settings for the application logs.
     */
    set linkLogSettings(value: cdk.IResolvable | CfnLink.LinkLogSettingsProperty);
    get moduleConfigurationList(): Array<cdk.IResolvable | CfnLink.ModuleConfigurationProperty> | cdk.IResolvable | undefined;
    set moduleConfigurationList(value: Array<cdk.IResolvable | CfnLink.ModuleConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The unique identifier of the peer gateway.
     */
    get peerGatewayId(): string;
    /**
     * The unique identifier of the peer gateway.
     */
    set peerGatewayId(value: string);
    /**
     * A map of the key-value pairs of the tag or tags to assign to the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
 ...
 */
export declare class CfnLinkRoutingRule extends cdk.CfnResource implements cdk.IInspectable, ILinkRoutingRuleRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLinkRoutingRule from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLinkRoutingRule;
    /**
     * Checks whether the given object is a CfnLinkRoutingRule
     */
    static isCfnLinkRoutingRule(x: any): x is CfnLinkRoutingRule;
    static arnForLinkRoutingRule(resource: ILinkRoutingRuleRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLinkRoutingRuleProps);
    get linkRoutingRuleRef(): LinkRoutingRuleReference;
    /**
     * Conditions for a routing rule.
     */
    get conditions(): cdk.IResolvable | CfnLinkRoutingRule.RuleConditionProperty;
    /**
     * Conditions for a routing rule.
     */
    set conditions(value: cdk.IResolvable | CfnLinkRoutingRule.RuleConditionProperty);
    get gatewayId(): string;
    set gatewayId(value: string);
    get linkId(): string;
...
export declare namespace CfnLinkRoutingRule {
    /**
     * Conditions for a routing rule.
     *
    ...
    interface RuleConditionProperty {
         ...
         */
        readonly queryStringEquals?: cdk.IResolvable | CfnLinkRoutingRule.QueryStringKeyValuePairProperty;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rtbfabric-linkroutingrule.html
 */
export interface CfnLinkRoutingRuleProps {
    /**
     * Conditions for a routing rule.
     *
     * All non-null fields must match (AND logic). At least one field must be set. HostHeader and HostHeaderWildcard are mutually exclusive. PathPrefix and PathExact are mutually exclusive.
     ...
     */
    readonly conditions: cdk.IResolvable | CfnLinkRoutingRule.RuleConditionProperty;
    /**
...
export declare class CfnOutboundExternalLink extends cdk.CfnResource implements cdk.IInspectable, IOutboundExternalLinkRef, cdk.ITaggableV2 {
    ...
    get gatewayId(): string;
    set gatewayId(value: string);
    get linkAttributes(): cdk.IResolvable | CfnOutboundExternalLink.LinkAttributesProperty | undefined;
    set linkAttributes(value: cdk.IResolvable | CfnOutboundExternalLink.LinkAttributesProperty | undefined);
    get linkLogSettings(): cdk.IResolvable | CfnOutboundExternalLink.LinkLogSettingsProperty;
    set linkLogSettings(value: cdk.IResolvable | CfnOutboundExternalLink.LinkLogSettingsProperty);
    get publicEndpoint(): string;
    set publicEndpoint(value: string);
    /**
     * Tags to assign to the Link.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRequesterGateway extends cdk.CfnResource implements cdk.IInspectable, IRequesterGatewayRef, cdk.ITaggableV2 {
     ...
     */
    get attrActiveLinksCount(): number;
    /**
     * @cloudformationAttribute Arn
     */
    get attrArn(): string;
     ...
     */
    get attrGatewayId(): string;
    /**
     * @cloudformationAttribute RequesterGatewayStatus
     */
    get attrRequesterGatewayStatus(): string;
    /**
     * @cloudformationAttribute TotalLinksCount
     */
    get attrTotalLinksCount(): number;
    /**
     * @cloudformationAttribute UpdatedTimestamp
     */
    get attrUpdatedTimestamp(): string;
...
export declare class CfnResponderGateway extends cdk.CfnResource implements cdk.IInspectable, IResponderGatewayRef, cdk.ITaggableV2 {
     ...
     */
    private _managedEndpointConfiguration?;
    /**
     ...
     */
    private _trustStoreConfiguration?;
    /**
     * The unique identifier of the Virtual Private Cloud (VPC).
     */
    private _vpcId;
    ...
    get acmCertificateArn(): string | undefined;
    set acmCertificateArn(value: string | undefined);
    /**
     * An optional description for the responder gateway.
     */
    get description(): string | undefined;
    ...
    get listenerConfig(): cdk.IResolvable | CfnResponderGateway.ListenerConfigProperty | undefined;
    set listenerConfig(value: cdk.IResolvable | CfnResponderGateway.ListenerConfigProperty | undefined);
    /**
     * The configuration for the managed endpoint.
     */
    get managedEndpointConfiguration(): cdk.IResolvable | CfnResponderGateway.ManagedEndpointConfigurationProperty | undefined;
    /**
     * The configuration for the managed endpoint.
     */
    set managedEndpointConfiguration(value: cdk.IResolvable | CfnResponderGateway.ManagedEndpointConfigurationProperty | undefined);
    /**
     * The networking port to use.
     */
    get port(): number;
     ...
     * The configuration of the trust store.
     */
    get trustStoreConfiguration(): cdk.IResolvable | CfnResponderGateway.TrustStoreConfigurationProperty | undefined;
    /**
     * The configuration of the trust store.
     */
    set trustStoreConfiguration(value: cdk.IResolvable | CfnResponderGateway.TrustStoreConfigurationProperty | undefined);
    /**
     * The unique identifier of the Virtual Private Cloud (VPC).
     */
    get vpcId(): string;
     ...
     */
    get attrCertificateAssociationStatus(): string;
    /**
     * @cloudformationAttribute CreatedTimestamp
     */
    get attrCreatedTimestamp(): string;
     ...
     */
    get attrExternalInboundEndpoint(): string;
    /**
     * @cloudformationAttribute GatewayId
     */
    get attrGatewayId(): string;
     ...
     */
    get attrResponderGatewayStatus(): string;
    /**
     * @cloudformationAttribute UpdatedTimestamp
     */
    get attrUpdatedTimestamp(): string;
...
export declare namespace CfnResponderGateway {
    ...
    interface AutoScalingGroupsConfigurationProperty {
         ...
         */
        readonly healthCheckConfig?: CfnResponderGateway.HealthCheckConfigProperty | cdk.IResolvable;
        /**
     ...
     */
    interface ListenerConfigProperty {
        /**
...
export interface CfnResponderGatewayProps {
     ...
     */
    readonly listenerConfig?: cdk.IResolvable | CfnResponderGateway.ListenerConfigProperty;
    /**
     * The configuration for the managed endpoint.
     *
...
export type { ILinkRoutingRuleRef, LinkRoutingRuleReference };
