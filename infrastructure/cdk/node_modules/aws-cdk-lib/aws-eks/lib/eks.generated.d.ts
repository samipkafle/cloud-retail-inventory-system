...
export declare class CfnAddon extends cdk.CfnResource implements cdk.IInspectable, IAddonRef, cdk.ITaggable {
     ...
     */
    static isCfnAddon(x: any): x is CfnAddon;
    static arnForAddon(resource: IAddonRef): string;
    /**
     ...
     * The configuration values that you provided.
     */
    get configurationValues(): string | undefined;
    /**
     * The configuration values that you provided.
     */
    set configurationValues(value: string | undefined);
    /**
     * The namespace configuration for the addon.
     */
    get namespaceConfig(): cdk.IResolvable | CfnAddon.NamespaceConfigProperty | undefined;
    /**
     * The namespace configuration for the addon.
     */
    set namespaceConfig(value: cdk.IResolvable | CfnAddon.NamespaceConfigProperty | undefined);
    /**
     * An array of EKS Pod Identity associations owned by the add-on.
     */
    get podIdentityAssociations(): Array<cdk.IResolvable | CfnAddon.PodIdentityAssociationProperty> | cdk.IResolvable | undefined;
    /**
     * An array of EKS Pod Identity associations owned by the add-on.
     */
    set podIdentityAssociations(value: Array<cdk.IResolvable | CfnAddon.PodIdentityAssociationProperty> | cdk.IResolvable | undefined);
    /**
     * Specifying this option preserves the add-on software on your cluster but Amazon EKS stops managing any settings for the add-on.
     */
    get preserveOnDelete(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifying this option preserves the add-on software on your cluster but Amazon EKS stops managing any settings for the add-on.
     */
    set preserveOnDelete(value: boolean | cdk.IResolvable | undefined);
    /**
     * How to resolve field value conflicts for an Amazon EKS add-on.
     */
    get resolveConflicts(): string | undefined;
    /**
     * How to resolve field value conflicts for an Amazon EKS add-on.
     */
     ...
     * The Amazon Resource Name (ARN) of an existing IAM role to bind to the add-on's service account.
     */
    get serviceAccountRoleArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of an existing IAM role to bind to the add-on's service account.
     */
...
export interface CfnAddonProps {
     ...
     */
    readonly serviceAccountRoleArn?: iamRefs.IRoleRef | string;
    /**
     * The metadata that you apply to the add-on to assist with categorization and organization.
     *
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggable {
     ...
     * The access configuration for the cluster.
     */
    get accessConfig(): CfnCluster.AccessConfigProperty | cdk.IResolvable | undefined;
    /**
     * The access configuration for the cluster.
     */
    set accessConfig(value: CfnCluster.AccessConfigProperty | cdk.IResolvable | undefined);
    /**
     * If you set this value to `False` when creating a cluster, the default networking add-ons will not be installed.
     */
    get bootstrapSelfManagedAddons(): boolean | cdk.IResolvable | undefined;
    /**
     * If you set this value to `False` when creating a cluster, the default networking add-ons will not be installed.
     */
    set bootstrapSelfManagedAddons(value: boolean | cdk.IResolvable | undefined);
    /**
     * Indicates the current configuration of the compute capability on your EKS Auto Mode cluster.
     */
    get computeConfig(): CfnCluster.ComputeConfigProperty | cdk.IResolvable | undefined;
    /**
     * Indicates the current configuration of the compute capability on your EKS Auto Mode cluster.
     */
    set computeConfig(value: CfnCluster.ComputeConfigProperty | cdk.IResolvable | undefined);
    /**
     * The control plane scaling tier configuration.
     */
    get controlPlaneScalingConfig(): CfnCluster.ControlPlaneScalingConfigProperty | cdk.IResolvable | undefined;
    /**
     * The control plane scaling tier configuration.
     */
    set controlPlaneScalingConfig(value: CfnCluster.ControlPlaneScalingConfigProperty | cdk.IResolvable | undefined);
    /**
     * The current deletion protection setting for the cluster.
     */
     ...
     * The encryption configuration for the cluster.
     */
    get encryptionConfig(): Array<CfnCluster.EncryptionConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The encryption configuration for the cluster.
     */
    set encryptionConfig(value: Array<CfnCluster.EncryptionConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Set this value to `true` to override upgrade-blocking readiness checks when updating a cluster.
     */
    get force(): boolean | cdk.IResolvable | undefined;
    /**
     * Set this value to `true` to override upgrade-blocking readiness checks when updating a cluster.
     */
    set force(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Kubernetes network configuration for the cluster.
     */
    get kubernetesNetworkConfig(): cdk.IResolvable | CfnCluster.KubernetesNetworkConfigProperty | undefined;
    /**
     * The Kubernetes network configuration for the cluster.
     */
    set kubernetesNetworkConfig(value: cdk.IResolvable | CfnCluster.KubernetesNetworkConfigProperty | undefined);
    /**
     * The logging configuration for your cluster.
     */
    get logging(): cdk.IResolvable | CfnCluster.LoggingProperty | undefined;
    /**
     * The logging configuration for your cluster.
     */
    set logging(value: cdk.IResolvable | CfnCluster.LoggingProperty | undefined);
    /**
     * The unique name to give to your cluster.
     */
     ...
     * An object representing the configuration of your local Amazon EKS cluster on an AWS Outpost.
     */
    get outpostConfig(): cdk.IResolvable | CfnCluster.OutpostConfigProperty | undefined;
    /**
     * An object representing the configuration of your local Amazon EKS cluster on an AWS Outpost.
     */
    set outpostConfig(value: cdk.IResolvable | CfnCluster.OutpostConfigProperty | undefined);
    /**
     * The configuration in the cluster for EKS Hybrid Nodes.
     */
    get remoteNetworkConfig(): cdk.IResolvable | CfnCluster.RemoteNetworkConfigProperty | undefined;
    /**
     * The configuration in the cluster for EKS Hybrid Nodes.
     */
    set remoteNetworkConfig(value: cdk.IResolvable | CfnCluster.RemoteNetworkConfigProperty | undefined);
    /**
     * The VPC configuration that's used by the cluster control plane.
     */
    get resourcesVpcConfig(): cdk.IResolvable | CfnCluster.ResourcesVpcConfigProperty;
    /**
     * The VPC configuration that's used by the cluster control plane.
     */
    set resourcesVpcConfig(value: cdk.IResolvable | CfnCluster.ResourcesVpcConfigProperty);
    /**
     * The Amazon Resource Name (ARN) of the IAM role that provides permissions for the Kubernetes control plane to make calls to AWS API operations on your behalf.
     */
    get roleArn(): string;
     ...
     * The rollback configuration to use for the cluster version rollback.
     */
    get rollbackConfig(): cdk.IResolvable | CfnCluster.RollbackConfigProperty | undefined;
    /**
     * The rollback configuration to use for the cluster version rollback.
     */
    set rollbackConfig(value: cdk.IResolvable | CfnCluster.RollbackConfigProperty | undefined);
    /**
     * Indicates the current configuration of the block storage capability on your EKS Auto Mode cluster.
     */
    get storageConfig(): cdk.IResolvable | CfnCluster.StorageConfigProperty | undefined;
    /**
     * Indicates the current configuration of the block storage capability on your EKS Auto Mode cluster.
     */
    set storageConfig(value: cdk.IResolvable | CfnCluster.StorageConfigProperty | undefined);
    /**
     * The metadata that you apply to the cluster to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * This value indicates if extended support is enabled or disabled for the cluster.
     */
    get upgradePolicy(): cdk.IResolvable | CfnCluster.UpgradePolicyProperty | undefined;
    /**
     * This value indicates if extended support is enabled or disabled for the cluster.
     */
    set upgradePolicy(value: cdk.IResolvable | CfnCluster.UpgradePolicyProperty | undefined);
    /**
     * The desired Kubernetes version for your cluster.
     */
     ...
     * The configuration for zonal shift for the cluster.
     */
    get zonalShiftConfig(): cdk.IResolvable | CfnCluster.ZonalShiftConfigProperty | undefined;
    /**
     * The configuration for zonal shift for the cluster.
     */
    set zonalShiftConfig(value: cdk.IResolvable | CfnCluster.ZonalShiftConfigProperty | undefined);
    /**
     ...
     */
    get attrKubernetesNetworkConfigServiceIpv6Cidr(): string;
    /**
...
export declare namespace CfnCluster {
    ...
    interface OutpostConfigProperty {
         ...
         */
        readonly etcdPlacement?: CfnCluster.EtcdPlacementProperty | cdk.IResolvable;
        /**
...
export interface CfnClusterProps {
     ...
     */
    readonly controlPlaneScalingConfig?: CfnCluster.ControlPlaneScalingConfigProperty | cdk.IResolvable;
    /**
     * The current deletion protection setting for the cluster.
     *
     ...
     */
    readonly rollbackConfig?: cdk.IResolvable | CfnCluster.RollbackConfigProperty;
    /**
     * Indicates the current configuration of the block storage capability on your EKS Auto Mode cluster.
     *
     * For example, if the capability is enabled or disabled. If the block storage capability is enabled, EKS Auto Mode will create and delete EBS volumes in your AWS account. For more information, see EKS Auto Mode block storage capability in the *Amazon EKS User Guide* .
...
export declare class CfnFargateProfile extends cdk.CfnResource implements cdk.IInspectable, IFargateProfileRef, cdk.ITaggable {
     ...
     */
    static isCfnFargateProfile(x: any): x is CfnFargateProfile;
    static arnForFargateProfile(resource: IFargateProfileRef): string;
    /**
     * The name of your cluster.
     */
    private _clusterName;
     ...
     * The name of the Fargate profile.
     */
    get fargateProfileName(): string | undefined;
    /**
     * The name of the Fargate profile.
     */
    set fargateProfileName(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the `Pod` execution role to use for a `Pod` that matches the selectors in the Fargate profile.
     */
     ...
     * The selectors to match for a `Pod` to use this Fargate profile.
     */
    get selectors(): Array<cdk.IResolvable | CfnFargateProfile.SelectorProperty> | cdk.IResolvable;
    /**
     * The selectors to match for a `Pod` to use this Fargate profile.
     */
    set selectors(value: Array<cdk.IResolvable | CfnFargateProfile.SelectorProperty> | cdk.IResolvable);
    /**
     * The IDs of subnets to launch a `Pod` into.
     */
...
export declare class CfnIdentityProviderConfig extends cdk.CfnResource implements cdk.IInspectable, IIdentityProviderConfigRef, cdk.ITaggable {
     ...
     */
    static isCfnIdentityProviderConfig(x: any): x is CfnIdentityProviderConfig;
    static arnForIdentityProviderConfig(resource: IIdentityProviderConfigRef): string;
    /**
     * The name of your cluster.
     */
    private _clusterName;
     ...
     * The name of the configuration.
     */
    get identityProviderConfigName(): string | undefined;
    /**
     * The name of the configuration.
     */
    set identityProviderConfigName(value: string | undefined);
    /**
     * An object representing an OpenID Connect (OIDC) identity provider configuration.
     */
    get oidc(): cdk.IResolvable | CfnIdentityProviderConfig.OidcIdentityProviderConfigProperty | undefined;
    /**
     * An object representing an OpenID Connect (OIDC) identity provider configuration.
     */
    set oidc(value: cdk.IResolvable | CfnIdentityProviderConfig.OidcIdentityProviderConfigProperty | undefined);
    /**
     * Metadata that assists with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrIdentityProviderConfigArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnNodegroup extends cdk.CfnResource implements cdk.IInspectable, INodegroupRef, cdk.ITaggable {
     ...
     */
    static isCfnNodegroup(x: any): x is CfnNodegroup;
    static arnForNodegroup(resource: INodegroupRef): string;
    /**
     ...
     * The capacity type of your managed node group.
     */
    get capacityType(): string | undefined;
    /**
     * The capacity type of your managed node group.
     */
    set capacityType(value: string | undefined);
    /**
     * The name of your cluster.
     */
    get clusterName(): string;
     ...
     * Force the update if any `Pod` on the existing node group can't be drained due to a `Pod` disruption budget issue.
     */
    get forceUpdateEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Force the update if any `Pod` on the existing node group can't be drained due to a `Pod` disruption budget issue.
     */
    set forceUpdateEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specify the instance types for a node group.
     */
     ...
     * The Kubernetes `labels` applied to the nodes in the node group.
     */
    get labels(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * The Kubernetes `labels` applied to the nodes in the node group.
     */
    set labels(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * An object representing a node group's launch template specification.
     */
    get launchTemplate(): cdk.IResolvable | CfnNodegroup.LaunchTemplateSpecificationProperty | undefined;
    /**
     * An object representing a node group's launch template specification.
     */
    set launchTemplate(value: cdk.IResolvable | CfnNodegroup.LaunchTemplateSpecificationProperty | undefined);
    /**
     * The unique name to give your node group.
     */
     ...
     * The unique name to give your node group.
     */
    set nodegroupName(value: string | undefined);
    /**
     * The node auto repair configuration for the node group.
     */
    get nodeRepairConfig(): cdk.IResolvable | CfnNodegroup.NodeRepairConfigProperty | undefined;
    /**
     * The node auto repair configuration for the node group.
     */
    set nodeRepairConfig(value: cdk.IResolvable | CfnNodegroup.NodeRepairConfigProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role to associate with your node group.
     */
    get nodeRole(): string;
     ...
     * The remote access configuration to use with your node group.
     */
    get remoteAccess(): cdk.IResolvable | CfnNodegroup.RemoteAccessProperty | undefined;
    /**
     * The remote access configuration to use with your node group.
     */
    set remoteAccess(value: cdk.IResolvable | CfnNodegroup.RemoteAccessProperty | undefined);
    /**
     * The scaling configuration details for the Auto Scaling group that is created for your node group.
     */
    get scalingConfig(): cdk.IResolvable | CfnNodegroup.ScalingConfigProperty | undefined;
    /**
     * The scaling configuration details for the Auto Scaling group that is created for your node group.
     */
    set scalingConfig(value: cdk.IResolvable | CfnNodegroup.ScalingConfigProperty | undefined);
    /**
     * The subnets to use for the Auto Scaling group that is created for your node group.
     */
    get subnets(): Array<string>;
    /**
     * The subnets to use for the Auto Scaling group that is created for your node group.
     */
    set subnets(value: Array<string>);
    /**
     * Metadata that assists with categorization and organization.
     */
     ...
     * The Kubernetes taints to be applied to the nodes in the node group when they are created.
     */
    get taints(): Array<cdk.IResolvable | CfnNodegroup.TaintProperty> | cdk.IResolvable | undefined;
    /**
     * The Kubernetes taints to be applied to the nodes in the node group when they are created.
     */
    set taints(value: Array<cdk.IResolvable | CfnNodegroup.TaintProperty> | cdk.IResolvable | undefined);
    /**
     * The node group update configuration.
     */
    get updateConfig(): cdk.IResolvable | CfnNodegroup.UpdateConfigProperty | undefined;
    /**
     * The node group update configuration.
     */
    set updateConfig(value: cdk.IResolvable | CfnNodegroup.UpdateConfigProperty | undefined);
    /**
     * The Kubernetes version to use for your managed nodes.
     */
    get version(): string | undefined;
     ...
     * The warm pool configuration for the node group.
     */
    get warmPoolConfig(): cdk.IResolvable | CfnNodegroup.WarmPoolConfigProperty | undefined;
    /**
     * The warm pool configuration for the node group.
     */
    set warmPoolConfig(value: cdk.IResolvable | CfnNodegroup.WarmPoolConfigProperty | undefined);
    /**
...
export declare namespace CfnNodegroup {
    ...
    interface NodeRepairConfigProperty {
         ...
         */
        readonly nodeRepairConfigOverrides?: Array<cdk.IResolvable | CfnNodegroup.NodeRepairConfigOverridesProperty> | cdk.IResolvable;
    }
    /**
     * Specify granular overrides for specific repair actions.
     *
...
export interface CfnNodegroupProps {
     ...
     */
    readonly clusterName: eksRefs.IClusterRef | string;
    /**
     * The root device disk size (in GiB) for your node group instances.
     *
     ...
     */
    readonly nodeRole: iamRefs.IRoleRef | string;
    /**
     * The AMI version of the Amazon EKS optimized AMI to use with your node group (for example, `1.14.7- *YYYYMMDD*` ). By default, the latest available AMI version for the node group's current Kubernetes version is used. For more information, see [Amazon EKS optimized Linux AMI Versions](https://docs.aws.amazon.com/eks/latest/userguide/eks-linux-ami-versions.html) in the *Amazon EKS User Guide* .
     *
     ...
     */
    readonly warmPoolConfig?: cdk.IResolvable | CfnNodegroup.WarmPoolConfigProperty;
}
/**
...
export declare class CfnAccessEntry extends cdk.CfnResource implements cdk.IInspectable, IAccessEntryRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnAccessEntry(x: any): x is CfnAccessEntry;
    static arnForAccessEntry(resource: IAccessEntryRef): string;
    /**
     ...
     * The access policies to associate to the access entry.
     */
    get accessPolicies(): Array<CfnAccessEntry.AccessPolicyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The access policies to associate to the access entry.
     */
    set accessPolicies(value: Array<CfnAccessEntry.AccessPolicyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of your cluster.
     */
    get clusterName(): string;
     ...
     * The value for `name` that you've specified for `kind: Group` as a `subject` in a Kubernetes `RoleBinding` or `ClusterRoleBinding` object.
     */
    get kubernetesGroups(): Array<string> | undefined;
    /**
     * The value for `name` that you've specified for `kind: Group` as a `subject` in a Kubernetes `RoleBinding` or `ClusterRoleBinding` object.
     */
    set kubernetesGroups(value: Array<string> | undefined);
    /**
     * The ARN of the IAM principal for the `AccessEntry` .
     */
...
export declare class CfnCapability extends cdk.CfnResource implements cdk.IInspectable, ICapabilityRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCapability(x: any): x is CfnCapability;
    static arnForCapability(resource: ICapabilityRef): string;
    /**
     ...
     * The configuration settings for the capability.
     */
    get configuration(): CfnCapability.CapabilityConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration settings for the capability.
     */
    set configuration(value: CfnCapability.CapabilityConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The delete propagation policy for the capability.
     */
     ...
     */
    get attrConfigurationArgoCdAwsIdcIdcManagedApplicationArn(): string;
    /**
     ...
     */
    get attrConfigurationArgoCdServerUrl(): string;
    /**
...
export declare namespace CfnCapability {
    ...
    interface CapabilityConfigurationProperty {
         ...
         */
        readonly argoCd?: CfnCapability.ArgoCdProperty | cdk.IResolvable;
    }
    /**
     * Configuration settings for an Argo CD capability.
     *
    ...
    interface ArgoCdProperty {
         ...
         */
        readonly awsIdc: CfnCapability.AwsIdcProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly networkAccess?: cdk.IResolvable | CfnCapability.NetworkAccessProperty;
        /**
         ...
         */
        readonly rbacRoleMappings?: Array<CfnCapability.ArgoCdRoleMappingProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface AwsIdcProperty {
         ...
         */
        readonly idcManagedApplicationArn?: string;
        /**
    ...
    interface ArgoCdRoleMappingProperty {
         ...
         */
        readonly identities: Array<cdk.IResolvable | CfnCapability.SsoIdentityProperty> | cdk.IResolvable;
        /**
...
export declare class CfnPodIdentityAssociation extends cdk.CfnResource implements cdk.IInspectable, IPodIdentityAssociationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnPodIdentityAssociation(x: any): x is CfnPodIdentityAssociation;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The state of the automatic sessions tags. The value of *true* disables these tags.
     */
    get disableSessionTags(): boolean | cdk.IResolvable | undefined;
    /**
     * The state of the automatic sessions tags. The value of *true* disables these tags.
     */
    set disableSessionTags(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the Kubernetes namespace inside the cluster to create the association in.
     */
     ...
     * The Amazon Resource Name (ARN) of the target IAM role to associate with the service account.
     */
    get targetRoleArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the target IAM role to associate with the service account.
     */
    set targetRoleArn(value: string | undefined);
    /**
...
export type { IAddonRef, AddonReference };
export type { IClusterRef, ClusterReference };
export type { IFargateProfileRef, FargateProfileReference };
export type { IIdentityProviderConfigRef, IdentityProviderConfigReference };
export type { INodegroupRef, NodegroupReference };
export type { IAccessEntryRef, AccessEntryReference };
export type { ICapabilityRef, CapabilityReference };
export type { IPodIdentityAssociationRef, PodIdentityAssociationReference };
