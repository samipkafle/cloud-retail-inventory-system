 ...
 */
export declare class CfnClassifier extends cdk.CfnResource implements cdk.IInspectable, IClassifierRef {
    /**
     ...
     */
    static isCfnClassifier(x: any): x is CfnClassifier;
    /**
    ...
    get classifierRef(): ClassifierReference;
    /**
     * A classifier for comma-separated values (CSV).
     */
    get csvClassifier(): CfnClassifier.CsvClassifierProperty | cdk.IResolvable | undefined;
    /**
     * A classifier for comma-separated values (CSV).
     */
    set csvClassifier(value: CfnClassifier.CsvClassifierProperty | cdk.IResolvable | undefined);
    /**
     * A classifier that uses `grok` .
     */
    get grokClassifier(): CfnClassifier.GrokClassifierProperty | cdk.IResolvable | undefined;
    /**
     * A classifier that uses `grok` .
     */
    set grokClassifier(value: CfnClassifier.GrokClassifierProperty | cdk.IResolvable | undefined);
    /**
     * A classifier for JSON content.
     */
    get jsonClassifier(): cdk.IResolvable | CfnClassifier.JsonClassifierProperty | undefined;
    /**
     * A classifier for JSON content.
     */
    set jsonClassifier(value: cdk.IResolvable | CfnClassifier.JsonClassifierProperty | undefined);
    /**
     * A classifier for XML content.
     */
    get xmlClassifier(): cdk.IResolvable | CfnClassifier.XMLClassifierProperty | undefined;
    /**
     * A classifier for XML content.
     */
    set xmlClassifier(value: cdk.IResolvable | CfnClassifier.XMLClassifierProperty | undefined);
    /**
...
export declare class CfnConnection extends cdk.CfnResource implements cdk.IInspectable, IConnectionRef {
     ...
     * The connection that you want to create.
     */
    get connectionInput(): CfnConnection.ConnectionInputProperty | cdk.IResolvable;
    /**
     * The connection that you want to create.
     */
    set connectionInput(value: CfnConnection.ConnectionInputProperty | cdk.IResolvable);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
 ...
 */
export declare class CfnCrawler extends cdk.CfnResource implements cdk.IInspectable, ICrawlerRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnCrawler(x: any): x is CfnCrawler;
    /**
     * Creates a new ICrawlerRef from a crawlerName
     */
    static fromCrawlerName(scope: constructs.Construct, id: string, crawlerName: string): ICrawlerRef;
    static arnForCrawler(resource: ICrawlerRef): string;
    /**
     ...
     */
    private _crawlerSecurityConfiguration?;
    /**
    ...
    get crawlerRef(): CrawlerReference;
    /**
     * A list of UTF-8 strings that specify the names of custom classifiers that are associated with the crawler.
     */
    get classifiers(): Array<string> | undefined;
    /**
     * A list of UTF-8 strings that specify the names of custom classifiers that are associated with the crawler.
     */
    set classifiers(value: Array<string> | undefined);
    /**
     * Crawler configuration information.
     */
     ...
     * The name of the `SecurityConfiguration` structure to be used by this crawler.
     */
    get crawlerSecurityConfiguration(): string | undefined;
    /**
     * The name of the `SecurityConfiguration` structure to be used by this crawler.
     */
    set crawlerSecurityConfiguration(value: string | undefined);
    /**
     * The name of the database in which the crawler's output is stored.
     */
     ...
     * Specifies whether the crawler should use AWS Lake Formation credentials for the crawler instead of the IAM role credentials.
     */
    get lakeFormationConfiguration(): cdk.IResolvable | CfnCrawler.LakeFormationConfigurationProperty | undefined;
    /**
     * Specifies whether the crawler should use AWS Lake Formation credentials for the crawler instead of the IAM role credentials.
     */
    set lakeFormationConfiguration(value: cdk.IResolvable | CfnCrawler.LakeFormationConfigurationProperty | undefined);
    /**
     * The name of the crawler.
     */
     ...
     * A policy that specifies whether to crawl the entire dataset again, or to crawl only folders that were added since the last crawler run.
     */
    get recrawlPolicy(): cdk.IResolvable | CfnCrawler.RecrawlPolicyProperty | undefined;
    /**
     * A policy that specifies whether to crawl the entire dataset again, or to crawl only folders that were added since the last crawler run.
     */
    set recrawlPolicy(value: cdk.IResolvable | CfnCrawler.RecrawlPolicyProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of an IAM role that's used to access customer resources, such as Amazon Simple Storage Service (Amazon S3) data.
     */
    get role(): string;
     ...
     * For scheduled crawlers, the schedule when the crawler runs.
     */
    get schedule(): cdk.IResolvable | CfnCrawler.ScheduleProperty | undefined;
    /**
     * For scheduled crawlers, the schedule when the crawler runs.
     */
    set schedule(value: cdk.IResolvable | CfnCrawler.ScheduleProperty | undefined);
    /**
     * The policy that specifies update and delete behaviors for the crawler.
     */
    get schemaChangePolicy(): cdk.IResolvable | CfnCrawler.SchemaChangePolicyProperty | undefined;
    /**
     * The policy that specifies update and delete behaviors for the crawler.
     */
    set schemaChangePolicy(value: cdk.IResolvable | CfnCrawler.SchemaChangePolicyProperty | undefined);
    /**
     * The prefix added to the names of tables that are created.
     */
     ...
     * A collection of targets to crawl.
     */
    get targets(): cdk.IResolvable | CfnCrawler.TargetsProperty;
    /**
     * A collection of targets to crawl.
     */
    set targets(value: cdk.IResolvable | CfnCrawler.TargetsProperty);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnCrawlerProps {
     ...
     */
    readonly databaseName?: s3Refs.IBucketRef | string;
    /**
     * A description of the crawler.
     *
 ...
 */
export declare class CfnDataCatalogEncryptionSettings extends cdk.CfnResource implements cdk.IInspectable, IDataCatalogEncryptionSettingsRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDataCatalogEncryptionSettings(x: any): x is CfnDataCatalogEncryptionSettings;
    /**
    ...
    get dataCatalogEncryptionSettingsRef(): DataCatalogEncryptionSettingsReference;
    /**
     * The ID of the Data Catalog in which the settings are created.
     */
    get catalogId(): string;
     ...
     * Contains configuration information for maintaining Data Catalog security.
     */
    get dataCatalogEncryptionSettings(): CfnDataCatalogEncryptionSettings.DataCatalogEncryptionSettingsProperty | cdk.IResolvable;
    /**
     * Contains configuration information for maintaining Data Catalog security.
     */
    set dataCatalogEncryptionSettings(value: CfnDataCatalogEncryptionSettings.DataCatalogEncryptionSettingsProperty | cdk.IResolvable);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnDataQualityRuleset extends cdk.CfnResource implements cdk.IInspectable, IDataQualityRulesetRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDataQualityRuleset(x: any): x is CfnDataQualityRuleset;
    /**
     * Tag Manager which manages the tags for this resource
     */
    ...
    get dataQualityRulesetRef(): DataQualityRulesetReference;
    /**
     * Used for idempotency and is recommended to be set to a random ID (such as a UUID) to avoid creating or starting multiple instances of the same resource.
     */
     ...
     * A Data Quality Definition Language (DQDL) ruleset.
     */
    get ruleset(): string | undefined;
    /**
     * A Data Quality Definition Language (DQDL) ruleset.
     */
    set ruleset(value: string | undefined);
    /**
     * A list of tags applied to the data quality ruleset.
     */
     ...
     * A list of tags applied to the data quality ruleset.
     */
    set tags(value: any | undefined);
    /**
     * An object representing an AWS Glue table.
     */
    get targetTable(): CfnDataQualityRuleset.DataQualityTargetTableProperty | cdk.IResolvable | undefined;
    /**
     * An object representing an AWS Glue table.
     */
    set targetTable(value: CfnDataQualityRuleset.DataQualityTargetTableProperty | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
 ...
 */
export declare class CfnDatabase extends cdk.CfnResource implements cdk.IInspectable, IDatabaseRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static fromDatabaseName(scope: constructs.Construct, id: string, databaseName: string): IDatabaseRef;
     ...
     * The metadata for the database.
     */
    get databaseInput(): CfnDatabase.DatabaseInputProperty | cdk.IResolvable;
    /**
     * The metadata for the database.
     */
    set databaseInput(value: CfnDatabase.DatabaseInputProperty | cdk.IResolvable);
    /**
     * The name of the catalog database.
     */
    get databaseName(): string | undefined;
 ...
 */
export declare class CfnDevEndpoint extends cdk.CfnResource implements cdk.IInspectable, IDevEndpointRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDevEndpoint(x: any): x is CfnDevEndpoint;
    /**
    ...
    get devEndpointRef(): DevEndpointReference;
    /**
     * A map of arguments used to configure the `DevEndpoint` .
     */
    get arguments(): any | cdk.IResolvable | undefined;
    /**
     * A map of arguments used to configure the `DevEndpoint` .
     */
    set arguments(value: any | cdk.IResolvable | undefined);
    /**
     * The name of the `DevEndpoint` .
     */
     ...
     * The name of the `DevEndpoint` .
     */
    set endpointName(value: string | undefined);
    /**
     * The path to one or more Java `.jar` files in an S3 bucket that should be loaded in your `DevEndpoint` .
     */
    get extraJarsS3Path(): string | undefined;
    /**
     * The path to one or more Java `.jar` files in an S3 bucket that should be loaded in your `DevEndpoint` .
     */
    set extraJarsS3Path(value: string | undefined);
    /**
     * The paths to one or more Python libraries in an Amazon S3 bucket that should be loaded in your `DevEndpoint` .
     */
    get extraPythonLibsS3Path(): string | undefined;
    /**
     * The paths to one or more Python libraries in an Amazon S3 bucket that should be loaded in your `DevEndpoint` .
     */
    set extraPythonLibsS3Path(value: string | undefined);
    /**
     * The AWS Glue version determines the versions of Apache Spark and Python that AWS Glue supports.
     */
     ...
     * A list of public keys to be used by the `DevEndpoints` for authentication.
     */
    get publicKeys(): Array<string> | undefined;
    /**
     * A list of public keys to be used by the `DevEndpoints` for authentication.
     */
    set publicKeys(value: Array<string> | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role used in this `DevEndpoint` .
     */
    get roleArn(): string;
...
export declare class CfnJob extends cdk.CfnResource implements cdk.IInspectable, IJobRef, cdk.ITaggable {
     ...
     */
    static isCfnJob(x: any): x is CfnJob;
    /**
     * Creates a new IJobRef from a jobName
     */
    static fromJobName(scope: constructs.Construct, id: string, jobName: string): IJobRef;
    static arnForJob(resource: IJobRef): string;
    /**
     ...
     * The code that executes a job.
     */
    get command(): cdk.IResolvable | CfnJob.JobCommandProperty;
    /**
     * The code that executes a job.
     */
    set command(value: cdk.IResolvable | CfnJob.JobCommandProperty);
    /**
     * The connections used for this job.
     */
    get connections(): CfnJob.ConnectionsListProperty | cdk.IResolvable | undefined;
    /**
     * The connections used for this job.
     */
    set connections(value: CfnJob.ConnectionsListProperty | cdk.IResolvable | undefined);
    /**
     * The default arguments for this job, specified as name-value pairs.
     */
    get defaultArguments(): any | cdk.IResolvable | undefined;
    /**
     * The default arguments for this job, specified as name-value pairs.
     */
    set defaultArguments(value: any | cdk.IResolvable | undefined);
    /**
     * A description of the job.
     */
    get description(): string | undefined;
     ...
     * Indicates whether the job is run with a standard or flexible execution class.
     */
    get executionClass(): string | undefined;
    /**
     * Indicates whether the job is run with a standard or flexible execution class.
     */
    set executionClass(value: string | undefined);
    /**
     * The maximum number of concurrent runs that are allowed for this job.
     */
    get executionProperty(): CfnJob.ExecutionPropertyProperty | cdk.IResolvable | undefined;
    /**
     * The maximum number of concurrent runs that are allowed for this job.
     */
    set executionProperty(value: CfnJob.ExecutionPropertyProperty | cdk.IResolvable | undefined);
    /**
     * Glue version determines the versions of Apache Spark and Python that AWS Glue supports.
     */
    get glueVersion(): string | undefined;
     ...
     * A mode that describes how a job was created. Valid values are:.
     */
    get jobMode(): string | undefined;
    /**
     * A mode that describes how a job was created. Valid values are:.
     */
    set jobMode(value: string | undefined);
    /**
     * Specifies whether job run queuing is enabled for the job runs for this job.
     */
    get jobRunQueuingEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether job run queuing is enabled for the job runs for this job.
     */
    set jobRunQueuingEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * This field is reserved for future use.
     */
     ...
     * Non-overridable arguments for this job, specified as name-value pairs.
     */
    get nonOverridableArguments(): any | cdk.IResolvable | undefined;
    /**
     * Non-overridable arguments for this job, specified as name-value pairs.
     */
    set nonOverridableArguments(value: any | cdk.IResolvable | undefined);
    /**
     * Specifies configuration properties of a notification.
     */
    get notificationProperty(): cdk.IResolvable | CfnJob.NotificationPropertyProperty | undefined;
    /**
     * Specifies configuration properties of a notification.
     */
    set notificationProperty(value: cdk.IResolvable | CfnJob.NotificationPropertyProperty | undefined);
    /**
     * The number of workers of a defined `workerType` that are allocated when a job runs.
     */
    get numberOfWorkers(): number | undefined;
 ...
 */
export declare class CfnMLTransform extends cdk.CfnResource implements cdk.IInspectable, IMLTransformRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnMLTransform(x: any): x is CfnMLTransform;
    /**
     ...
     */
    private _transformEncryption?;
    /**
     * The algorithm-specific parameters that are associated with the machine learning transform.
     */
    private _transformParameters;
    /**
    ...
    get mlTransformRef(): MLTransformReference;
    /**
     * A user-defined, long-form description text for the machine learning transform.
     */
    get description(): string | undefined;
     ...
     * A list of AWS Glue table definitions used by the transform.
     */
    get inputRecordTables(): CfnMLTransform.InputRecordTablesProperty | cdk.IResolvable;
    /**
     * A list of AWS Glue table definitions used by the transform.
     */
    set inputRecordTables(value: CfnMLTransform.InputRecordTablesProperty | cdk.IResolvable);
    /**
     * The number of AWS Glue data processing units (DPUs) that are allocated to task runs for this transform.
     */
    get maxCapacity(): number | undefined;
     ...
     * The encryption-at-rest settings of the transform that apply to accessing user data.
     */
    get transformEncryption(): cdk.IResolvable | CfnMLTransform.TransformEncryptionProperty | undefined;
    /**
     * The encryption-at-rest settings of the transform that apply to accessing user data.
     */
    set transformEncryption(value: cdk.IResolvable | CfnMLTransform.TransformEncryptionProperty | undefined);
    /**
     * The algorithm-specific parameters that are associated with the machine learning transform.
     */
    get transformParameters(): cdk.IResolvable | CfnMLTransform.TransformParametersProperty;
    /**
     * The algorithm-specific parameters that are associated with the machine learning transform.
     */
    set transformParameters(value: cdk.IResolvable | CfnMLTransform.TransformParametersProperty);
    /**
     * The type of predefined worker that is allocated when a task of this transform runs.
     */
    get workerType(): string | undefined;
 ...
 */
export declare class CfnPartition extends cdk.CfnResource implements cdk.IInspectable, IPartitionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnPartition(x: any): x is CfnPartition;
    /**
    ...
    get partitionRef(): PartitionReference;
    /**
     * The AWS account ID of the catalog in which the partion is to be created.
     */
    get catalogId(): string;
     ...
     * The structure used to create and update a partition.
     */
    get partitionInput(): cdk.IResolvable | CfnPartition.PartitionInputProperty;
    /**
     * The structure used to create and update a partition.
     */
    set partitionInput(value: cdk.IResolvable | CfnPartition.PartitionInputProperty);
    /**
     * The name of the metadata table in which the partition is to be created.
     */
...
export declare class CfnRegistry extends cdk.CfnResource implements cdk.IInspectable, IRegistryRef, cdk.ITaggable {
     ...
     */
    static isCfnRegistry(x: any): x is CfnRegistry;
    static arnForRegistry(resource: IRegistryRef): string;
    /**
...
export declare class CfnSchema extends cdk.CfnResource implements cdk.IInspectable, ISchemaRef, cdk.ITaggable {
     ...
     */
    static isCfnSchema(x: any): x is CfnSchema;
    static arnForSchema(resource: ISchemaRef): string;
    /**
     ...
     * Specify the `VersionNumber` or the `IsLatest` for setting the checkpoint for the schema.
     */
    get checkpointVersion(): cdk.IResolvable | CfnSchema.SchemaVersionProperty | undefined;
    /**
     * Specify the `VersionNumber` or the `IsLatest` for setting the checkpoint for the schema.
     */
    set checkpointVersion(value: cdk.IResolvable | CfnSchema.SchemaVersionProperty | undefined);
    /**
     * The compatibility mode of the schema.
     */
     ...
     * The registry where a schema is stored.
     */
    get registry(): cdk.IResolvable | CfnSchema.RegistryProperty | undefined;
    /**
     * The registry where a schema is stored.
     */
    set registry(value: cdk.IResolvable | CfnSchema.RegistryProperty | undefined);
    /**
     * The schema definition using the `DataFormat` setting for `SchemaName` .
     */
    get schemaDefinition(): string | undefined;
    /**
     * The schema definition using the `DataFormat` setting for `SchemaName` .
     */
    set schemaDefinition(value: string | undefined);
    /**
     * AWS tags that contain a key value pair and may be searched by console, command line, or API.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrInitialSchemaVersionId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnSchemaVersion extends cdk.CfnResource implements cdk.IInspectable, ISchemaVersionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnSchemaVersion(x: any): x is CfnSchemaVersion;
    /**
    ...
    get schemaVersionRef(): SchemaVersionReference;
    /**
     * The schema that includes the schema version.
     */
    get schema(): cdk.IResolvable | CfnSchemaVersion.SchemaProperty;
    /**
     * The schema that includes the schema version.
     */
    set schema(value: cdk.IResolvable | CfnSchemaVersion.SchemaProperty);
    /**
     * The schema definition for the schema version.
     */
 ...
 */
export declare class CfnSchemaVersionMetadata extends cdk.CfnResource implements cdk.IInspectable, ISchemaVersionMetadataRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnSchemaVersionMetadata(x: any): x is CfnSchemaVersionMetadata;
    /**
    ...
    get schemaVersionMetadataRef(): SchemaVersionMetadataReference;
    /**
     * A metadata key in a key-value pair for metadata.
     */
    get key(): string;
...
export interface CfnSchemaVersionMetadataProps {
     ...
     */
    readonly schemaVersionId: glueRefs.ISchemaVersionRef | string;
    /**
     * A metadata key's corresponding value.
     *
...
export declare class CfnSecurityConfiguration extends cdk.CfnResource implements cdk.IInspectable, ISecurityConfigurationRef {
     ...
     * The encryption configuration associated with this security configuration.
     */
    get encryptionConfiguration(): CfnSecurityConfiguration.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * The encryption configuration associated with this security configuration.
     */
    set encryptionConfiguration(value: CfnSecurityConfiguration.EncryptionConfigurationProperty | cdk.IResolvable);
    /**
     * The name of the security configuration.
     */
    get name(): string;
...
export declare class CfnTable extends cdk.CfnResource implements cdk.IInspectable, ITableRef {
     ...
     * Specifies an `OpenTableFormatInput` structure when creating an open format table.
     */
    get openTableFormatInput(): cdk.IResolvable | CfnTable.OpenTableFormatInputProperty | undefined;
    /**
     * Specifies an `OpenTableFormatInput` structure when creating an open format table.
     */
    set openTableFormatInput(value: cdk.IResolvable | CfnTable.OpenTableFormatInputProperty | undefined);
    /**
     * A structure used to define a table.
     */
    get tableInput(): cdk.IResolvable | CfnTable.TableInputProperty | undefined;
    /**
     * A structure used to define a table.
     */
    set tableInput(value: cdk.IResolvable | CfnTable.TableInputProperty | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare namespace CfnTable {
    ...
    interface TableInputProperty {
         ...
         */
        readonly viewDefinition?: cdk.IResolvable | CfnTable.ViewDefinitionProperty;
        /**
    ...
    interface ViewDefinitionProperty {
         ...
         */
        readonly isProtected?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly representations?: Array<cdk.IResolvable | CfnTable.ViewRepresentationProperty> | cdk.IResolvable;
        /**
         ...
         */
        readonly subObjects?: Array<string>;
    }
    /**
     * @struct
     * @stability external
    ...
    interface IcebergInputProperty {
         ...
         */
        readonly icebergTableInput?: CfnTable.IcebergTableInputProperty | cdk.IResolvable;
        /**
    ...
    interface IcebergTableInputProperty {
         ...
         */
        readonly partitionSpec?: CfnTable.IcebergPartitionSpecProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly properties?: any | cdk.IResolvable;
        /**
         ...
         */
        readonly schema: CfnTable.IcebergSchemaProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly writeOrder?: CfnTable.IcebergSortOrderProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface IcebergSchemaProperty {
         ...
         */
        readonly fields: Array<CfnTable.IcebergStructFieldProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
 ...
 */
export declare class CfnTrigger extends cdk.CfnResource implements cdk.IInspectable, ITriggerRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnTrigger(x: any): x is CfnTrigger;
    /**
     * Creates a new ITriggerRef from a triggerName
     */
    static fromTriggerName(scope: constructs.Construct, id: string, triggerName: string): ITriggerRef;
    static arnForTrigger(resource: ITriggerRef): string;
    /**
    ...
    get triggerRef(): TriggerReference;
    /**
     * The actions initiated by this trigger.
     */
    get actions(): Array<CfnTrigger.ActionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The actions initiated by this trigger.
     */
    set actions(value: Array<CfnTrigger.ActionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * A description of this trigger.
     */
    get description(): string | undefined;
     ...
     * Batch condition that must be met (specified number of events received or batch time window expired) before EventBridge event trigger fires.
     */
    get eventBatchingCondition(): CfnTrigger.EventBatchingConditionProperty | cdk.IResolvable | undefined;
    /**
     * Batch condition that must be met (specified number of events received or batch time window expired) before EventBridge event trigger fires.
     */
    set eventBatchingCondition(value: CfnTrigger.EventBatchingConditionProperty | cdk.IResolvable | undefined);
    /**
     * The name of the trigger.
     */
    get name(): string | undefined;
     ...
     * The predicate of this trigger, which defines when it will fire.
     */
    get predicate(): cdk.IResolvable | CfnTrigger.PredicateProperty | undefined;
    /**
     * The predicate of this trigger, which defines when it will fire.
     */
    set predicate(value: cdk.IResolvable | CfnTrigger.PredicateProperty | undefined);
    /**
     * A `cron` expression used to specify the schedule.
     */
     ...
     * Set to true to start `SCHEDULED` and `CONDITIONAL` triggers when created.
     */
    get startOnCreation(): boolean | cdk.IResolvable | undefined;
    /**
     * Set to true to start `SCHEDULED` and `CONDITIONAL` triggers when created.
     */
    set startOnCreation(value: boolean | cdk.IResolvable | undefined);
    /**
     * The tags to use with this trigger.
     */
    get tagsRaw(): any | undefined;
...
export declare class CfnWorkflow extends cdk.CfnResource implements cdk.IInspectable, IWorkflowRef, cdk.ITaggable {
     ...
     */
    static fromWorkflowName(scope: constructs.Construct, id: string, workflowName: string): IWorkflowRef;
     ...
     * A collection of properties to be used as part of each execution of the workflow.
     */
    get defaultRunProperties(): any | cdk.IResolvable | undefined;
    /**
     * A collection of properties to be used as part of each execution of the workflow.
     */
    set defaultRunProperties(value: any | cdk.IResolvable | undefined);
    /**
     * A description of the workflow.
     */
    get description(): string | undefined;
     ...
     * You can use this parameter to prevent unwanted multiple updates to data, to control costs, or in some cases, to prevent exceeding the maximum number of concurrent runs of any of the component jobs.
     */
    get maxConcurrentRuns(): number | undefined;
    /**
     * You can use this parameter to prevent unwanted multiple updates to data, to control costs, or in some cases, to prevent exceeding the maximum number of concurrent runs of any of the component jobs.
     */
    set maxConcurrentRuns(value: number | undefined);
    /**
     * The name of the workflow representing the flow.
     */
    get name(): string | undefined;
 ...
 */
export declare class CfnCatalog extends cdk.CfnResource implements cdk.IInspectable, ICatalogRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCatalog from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCatalog;
    /**
     * Checks whether the given object is a CfnCatalog
     */
    static isCfnCatalog(x: any): x is CfnCatalog;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCatalogProps);
    get catalogRef(): CatalogReference;
    /**
     * Allows third-party engines to access data in Amazon S3 locations that are registered with Lake Formation.
     */
    get allowFullTableExternalDataAccess(): string | undefined;
    /**
     * Allows third-party engines to access data in Amazon S3 locations that are registered with Lake Formation.
     */
    set allowFullTableExternalDataAccess(value: string | undefined);
    /**
     * A structure that specifies data lake access properties and other custom properties.
     */
    get catalogProperties(): CfnCatalog.CatalogPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * A structure that specifies data lake access properties and other custom properties.
     */
    set catalogProperties(value: CfnCatalog.CatalogPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * An array of PrincipalPermissions objects for default database permissions.
     */
    get createDatabaseDefaultPermissions(): Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable | undefined;
    /**
     * An array of PrincipalPermissions objects for default database permissions.
     */
    set createDatabaseDefaultPermissions(value: Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable | undefined);
    /**
     * An array of PrincipalPermissions objects for default table permissions.
     */
    get createTableDefaultPermissions(): Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable | undefined;
    /**
     * An array of PrincipalPermissions objects for default table permissions.
     */
    set createTableDefaultPermissions(value: Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable | undefined);
    /**
     * A description of the catalog.
     */
    get description(): string | undefined;
     ...
     * A FederatedCatalog structure that references an entity outside the Glue Data Catalog.
     */
    get federatedCatalog(): CfnCatalog.FederatedCatalogProperty | cdk.IResolvable | undefined;
    /**
     * A FederatedCatalog structure that references an entity outside the Glue Data Catalog.
     */
    set federatedCatalog(value: CfnCatalog.FederatedCatalogProperty | cdk.IResolvable | undefined);
    /**
     * The name of the catalog to create.
     */
    get name(): string;
     ...
     * Specifies whether to overwrite child resource permissions with the default permissions.
     */
    get overwriteChildResourcePermissionsWithDefault(): string | undefined;
    /**
     * Specifies whether to overwrite child resource permissions with the default permissions.
     */
    set overwriteChildResourcePermissionsWithDefault(value: string | undefined);
    /**
     * A map of key-value pairs that define parameters and properties of the catalog.
     */
     ...
     * A structure that describes a target catalog for resource linking.
     */
    get targetRedshiftCatalog(): cdk.IResolvable | CfnCatalog.TargetRedshiftCatalogProperty | undefined;
    /**
     * A structure that describes a target catalog for resource linking.
     */
    set targetRedshiftCatalog(value: cdk.IResolvable | CfnCatalog.TargetRedshiftCatalogProperty | undefined);
    /**
     * The ID of the catalog.
     *
     * @cloudformationAttribute CatalogId
     */
    get attrCatalogId(): string;
    /**
     * Additional key-value properties for the catalog.
     *
     * @cloudformationAttribute CatalogProperties.CustomProperties
     */
    get attrCatalogPropertiesCustomProperties(): cdk.IResolvable;
    /**
     ...
     */
    get attrCatalogPropertiesDataLakeAccessPropertiesManagedWorkgroupName(): string;
    /**
     ...
     */
    get attrCatalogPropertiesDataLakeAccessPropertiesManagedWorkgroupStatus(): string;
    /**
     * The name of the Redshift database.
     *
     * @cloudformationAttribute CatalogProperties.DataLakeAccessProperties.RedshiftDatabaseName
     */
    get attrCatalogPropertiesDataLakeAccessPropertiesRedshiftDatabaseName(): string;
    /**
     * The time at which the catalog was created.
     *
     * @cloudformationAttribute CreateTime
     */
    get attrCreateTime(): number;
    /**
...
export declare namespace CfnCatalog {
    /**
     * A FederatedCatalog structure that references an entity outside the Glue Data Catalog.
     *
     * @struct
    ...
    interface CatalogPropertiesProperty {
         ...
         */
        readonly dataLakeAccessProperties?: CfnCatalog.DataLakeAccessPropertiesProperty | cdk.IResolvable;
    }
    /**
     * Data lake access properties for the catalog.
     *
    ...
    interface DataLakeAccessPropertiesProperty {
         ...
         */
        readonly dataLakeAccess?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly managedWorkgroupStatus?: string;
        /**
         * The name of the Redshift database.
         *
    ...
    interface PrincipalPermissionsProperty {
         ...
         */
        readonly principal?: CfnCatalog.DataLakePrincipalProperty | cdk.IResolvable;
    }
    /**
     * The Lake Formation principal.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-catalog.html
 */
export interface CfnCatalogProps {
    /**
     * Allows third-party engines to access data in Amazon S3 locations that are registered with Lake Formation.
     *
     ...
     */
    readonly catalogProperties?: CfnCatalog.CatalogPropertiesProperty | cdk.IResolvable;
    /**
     * An array of PrincipalPermissions objects for default database permissions.
     *
     ...
     */
    readonly createDatabaseDefaultPermissions?: Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable;
    /**
     * An array of PrincipalPermissions objects for default table permissions.
     *
     ...
     */
    readonly createTableDefaultPermissions?: Array<cdk.IResolvable | CfnCatalog.PrincipalPermissionsProperty> | cdk.IResolvable;
    /**
     * A description of the catalog.
     *
     ...
     */
    readonly federatedCatalog?: CfnCatalog.FederatedCatalogProperty | cdk.IResolvable;
    /**
     * The name of the catalog to create.
     *
     ...
     */
    readonly targetRedshiftCatalog?: cdk.IResolvable | CfnCatalog.TargetRedshiftCatalogProperty;
}
/**
 ...
 */
export declare class CfnCustomEntityType extends cdk.CfnResource implements cdk.IInspectable, ICustomEntityTypeRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnCustomEntityType(x: any): x is CfnCustomEntityType;
    /**
     * Creates a new ICustomEntityTypeRef from a customEntityTypeId
     */
    static fromCustomEntityTypeId(scope: constructs.Construct, id: string, customEntityTypeId: string): ICustomEntityTypeRef;
    static arnForCustomEntityType(resource: ICustomEntityTypeRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    ...
    get customEntityTypeRef(): CustomEntityTypeReference;
    /**
     * A list of context words.
     */
    get contextWords(): Array<string> | undefined;
    /**
     * A list of context words.
     */
    set contextWords(value: Array<string> | undefined);
    /**
     * A name for the custom pattern that allows it to be retrieved or deleted later.
     */
    get name(): string | undefined;
     ...
     * A regular expression string that is used for detecting sensitive data in a custom pattern.
     */
    get regexString(): string | undefined;
    /**
     * A regular expression string that is used for detecting sensitive data in a custom pattern.
     */
    set regexString(value: string | undefined);
    /**
     * AWS tags that contain a key value pair and may be searched by console, command line, or API.
     */
    get tags(): any | undefined;
 ...
 */
export declare class CfnIdentityCenterConfiguration extends cdk.CfnResource implements cdk.IInspectable, IIdentityCenterConfigurationRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnIdentityCenterConfiguration from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnIdentityCenterConfiguration;
    /**
     * Checks whether the given object is a CfnIdentityCenterConfiguration
     */
    static isCfnIdentityCenterConfiguration(x: any): x is CfnIdentityCenterConfiguration;
    /**
     ...
     */
    private _userBackgroundSessionsEnabled?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnIdentityCenterConfigurationProps);
    get identityCenterConfigurationRef(): IdentityCenterConfigurationReference;
    /**
     * The Amazon Resource Name (ARN) of the Identity Center instance associated with the AWS Glue configuration.
     */
     ...
     * A list of Identity Center scopes that define the permissions and access levels for the AWS Glue configuration.
     */
    get scopes(): Array<string> | undefined;
    /**
     * A list of Identity Center scopes that define the permissions and access levels for the AWS Glue configuration.
     */
    set scopes(value: Array<string> | undefined);
    /**
     * Indicates whether users can run background sessions when using Identity Center authentication with AWS Glue services.
     */
    get userBackgroundSessionsEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether users can run background sessions when using Identity Center authentication with AWS Glue services.
     */
    set userBackgroundSessionsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-identitycenterconfiguration.html
 */
export interface CfnIdentityCenterConfigurationProps {
    /**
     * The Amazon Resource Name (ARN) of the Identity Center instance associated with the AWS Glue configuration.
     *
     ...
     */
    readonly userBackgroundSessionsEnabled?: boolean | cdk.IResolvable;
}
/**
...
export declare class CfnIntegration extends cdk.CfnResource implements cdk.IInspectable, IIntegrationRef, cdk.ITaggableV2 {
     ...
     * An optional set of non-secret key–value pairs that contains additional contextual information for encryption.
     */
    get additionalEncryptionContext(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * An optional set of non-secret key–value pairs that contains additional contextual information for encryption.
     */
    set additionalEncryptionContext(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * Selects source tables for the integration using Maxwell filter syntax.
     */
    get dataFilter(): string | undefined;
    /**
     * Selects source tables for the integration using Maxwell filter syntax.
     */
    set dataFilter(value: string | undefined);
    /**
     * A description for the integration.
     */
    get description(): string | undefined;
     ...
     * The structure used to define properties associated with the zero-ETL integration.
     */
    get integrationConfig(): CfnIntegration.IntegrationConfigProperty | cdk.IResolvable | undefined;
    /**
     * The structure used to define properties associated with the zero-ETL integration.
     */
    set integrationConfig(value: CfnIntegration.IntegrationConfigProperty | cdk.IResolvable | undefined);
    /**
     * A unique name for the integration.
     */
...
export declare namespace CfnIntegration {
    ...
    interface IntegrationConfigProperty {
         ...
         */
        readonly continuousSync?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly sourceProperties?: cdk.IResolvable | Record<string, string>;
    }
}
/**
...
export interface CfnIntegrationProps {
     ...
     */
    readonly integrationConfig?: CfnIntegration.IntegrationConfigProperty | cdk.IResolvable;
    /**
     * A unique name for the integration.
     *
 ...
 */
export declare class CfnIntegrationResourceProperty extends cdk.CfnResource implements cdk.IInspectable, IIntegrationResourcePropertyRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnIntegrationResourceProperty from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnIntegrationResourceProperty;
    /**
     * Checks whether the given object is a CfnIntegrationResourceProperty
     */
    static isCfnIntegrationResourceProperty(x: any): x is CfnIntegrationResourceProperty;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _sourceProcessingProperties?;
    /**
     * An array of key-value pairs to apply to this resource.
     */
    private _tags?;
     ...
     */
    private _targetProcessingProperties?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnIntegrationResourcePropertyProps);
    get integrationResourcePropertyRef(): IntegrationResourcePropertyReference;
    /**
     * The connection ARN of the source, or the database ARN of the target.
     */
     ...
     * The resource properties associated with the integration source.
     */
    get sourceProcessingProperties(): cdk.IResolvable | CfnIntegrationResourceProperty.SourceProcessingPropertiesProperty | undefined;
    /**
     * The resource properties associated with the integration source.
     */
    set sourceProcessingProperties(value: cdk.IResolvable | CfnIntegrationResourceProperty.SourceProcessingPropertiesProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * The structure used to define the resource properties associated with the integration target.
     */
    get targetProcessingProperties(): cdk.IResolvable | CfnIntegrationResourceProperty.TargetProcessingPropertiesProperty | undefined;
    /**
     * The structure used to define the resource properties associated with the integration target.
     */
    set targetProcessingProperties(value: cdk.IResolvable | CfnIntegrationResourceProperty.TargetProcessingPropertiesProperty | undefined);
    /**
     * The integration resource property ARN.
     *
     * @cloudformationAttribute ResourcePropertyArn
     */
    get attrResourcePropertyArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnIntegrationResourceProperty {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-integrationresourceproperty.html
 */
export interface CfnIntegrationResourcePropertyProps {
    /**
     * The connection ARN of the source, or the database ARN of the target.
     *
     ...
     */
    readonly sourceProcessingProperties?: cdk.IResolvable | CfnIntegrationResourceProperty.SourceProcessingPropertiesProperty;
    /**
     * An array of key-value pairs to apply to this resource.
     *
     ...
     */
    readonly targetProcessingProperties?: cdk.IResolvable | CfnIntegrationResourceProperty.TargetProcessingPropertiesProperty;
}
/**
 ...
 */
export declare class CfnTableOptimizer extends cdk.CfnResource implements cdk.IInspectable, ITableOptimizerRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnTableOptimizer(x: any): x is CfnTableOptimizer;
    /**
     ...
     */
    private _tableOptimizerConfiguration;
    /**
    ...
    get tableOptimizerRef(): TableOptimizerReference;
    /**
     * The catalog ID of the table.
     */
    get catalogId(): string;
     ...
     * Specifies configuration details of a table optimizer.
     */
    get tableOptimizerConfiguration(): cdk.IResolvable | CfnTableOptimizer.TableOptimizerConfigurationProperty;
    /**
     * Specifies configuration details of a table optimizer.
     */
    set tableOptimizerConfiguration(value: cdk.IResolvable | CfnTableOptimizer.TableOptimizerConfigurationProperty);
    /**
     * The type of table optimizer. The valid values are:.
     */
    get type(): string;
...
export declare namespace CfnTableOptimizer {
    ...
    interface TableOptimizerConfigurationProperty {
         ...
         */
        readonly compactionConfiguration?: CfnTableOptimizer.CompactionConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface CompactionConfigurationProperty {
         ...
         */
        readonly icebergConfiguration?: CfnTableOptimizer.IcebergCompactionConfigurationProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface IcebergCompactionConfigurationProperty {
        /**
 ...
 */
export declare class CfnUsageProfile extends cdk.CfnResource implements cdk.IInspectable, IUsageProfileRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnUsageProfile(x: any): x is CfnUsageProfile;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
    ...
    get usageProfileRef(): UsageProfileReference;
    get configuration(): cdk.IResolvable | CfnUsageProfile.ProfileConfigurationProperty | undefined;
    set configuration(value: cdk.IResolvable | CfnUsageProfile.ProfileConfigurationProperty | undefined);
    /**
     * A description of the usage profile.
     */
    get description(): string | undefined;
...
export type { IClassifierRef, ClassifierReference };
export type { IConnectionRef, ConnectionReference };
export type { ICrawlerRef, CrawlerReference };
export type { IDataCatalogEncryptionSettingsRef, DataCatalogEncryptionSettingsReference };
export type { IDataQualityRulesetRef, DataQualityRulesetReference };
export type { IDatabaseRef, DatabaseReference };
export type { IDevEndpointRef, DevEndpointReference };
export type { IJobRef, JobReference };
export type { IMLTransformRef, MLTransformReference };
export type { IPartitionRef, PartitionReference };
export type { IRegistryRef, RegistryReference };
export type { ISchemaRef, SchemaReference };
export type { ISchemaVersionRef, SchemaVersionReference };
export type { ISchemaVersionMetadataRef, SchemaVersionMetadataReference };
export type { ISecurityConfigurationRef, SecurityConfigurationReference };
export type { ITableRef, TableReference };
export type { ITriggerRef, TriggerReference };
export type { IWorkflowRef, WorkflowReference };
export type { ICatalogRef, CatalogReference };
export type { ICustomEntityTypeRef, CustomEntityTypeReference };
export type { IIdentityCenterConfigurationRef, IdentityCenterConfigurationReference };
export type { IIntegrationRef, IntegrationReference };
export type { IIntegrationResourcePropertyRef, IntegrationResourcePropertyReference };
export type { ITableOptimizerRef, TableOptimizerReference };
export type { IUsageProfileRef, UsageProfileReference };
