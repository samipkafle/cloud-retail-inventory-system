 ...
 */
export declare enum BucketNamespace {
    /**
...
export declare class Bucket extends BucketBase {
     ...
     */
    private static readonly MAX_BUCKET_NAME_PREFIX_LENGTH;
    /**
     ...
     */
    private static _validateBucketNamePrefix;
    /**
     * Like '_validateBucketNamePrefix', but throws a scoped ValidationError
     */
    private static validateBucketNamePrefixScoped;
    private static validateBucketNamingCombination;
    ...
    private readonly ownershipControls;
