...
import { BuildBatchReference, BuildReference, FleetReference, IBuildBatchRef, IBuildRef, IFleetRef, IProjectRef, IReportGroupRef, ISourceCredentialRef, ProjectReference, ReportGroupReference, SourceCredentialReference } from "../../interfaces/generated/aws-codebuild-interfaces.generated";
/**
...
export declare class CfnReportGroup extends cdk.CfnResource implements cdk.IInspectable, IReportGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnReportGroup(x: any): x is CfnReportGroup;
    static arnForReportGroup(resource: IReportGroupRef): string;
    /**
     ...
     * When deleting a report group, specifies if reports within the report group should be deleted.
     */
    get deleteReports(): boolean | cdk.IResolvable | undefined;
    /**
     * When deleting a report group, specifies if reports within the report group should be deleted.
     */
    set deleteReports(value: boolean | cdk.IResolvable | undefined);
    /**
     * Information about the destination where the raw data of this `ReportGroup` is exported.
     */
    get exportConfig(): cdk.IResolvable | CfnReportGroup.ReportExportConfigProperty;
    /**
     * Information about the destination where the raw data of this `ReportGroup` is exported.
     */
    set exportConfig(value: cdk.IResolvable | CfnReportGroup.ReportExportConfigProperty);
    /**
     * The name of the `ReportGroup` .
     */
    get name(): string | undefined;
...
export declare class CfnSourceCredential extends cdk.CfnResource implements cdk.IInspectable, ISourceCredentialRef {
     ...
     */
    static isCfnSourceCredential(x: any): x is CfnSourceCredential;
    /**
...
export declare class CfnFleet extends cdk.CfnResource implements cdk.IInspectable, IFleetRef, cdk.ITaggableV2 {
     ...
     */
    private _fleetProxyConfiguration?;
    /**
     ...
     * The initial number of machines allocated to the compute ﬂeet, which deﬁnes the number of builds that can run in parallel.
     */
    get baseCapacity(): number | undefined;
    /**
     * The initial number of machines allocated to the compute ﬂeet, which deﬁnes the number of builds that can run in parallel.
     */
    set baseCapacity(value: number | undefined);
    /**
     * The compute configuration of the compute fleet.
     */
    get computeConfiguration(): CfnFleet.ComputeConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The compute configuration of the compute fleet.
     */
    set computeConfiguration(value: CfnFleet.ComputeConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Information about the compute resources the compute fleet uses. Available values include:.
     */
    get computeType(): string | undefined;
    /**
     * Information about the compute resources the compute fleet uses. Available values include:.
     */
     ...
     * The environment type of the compute fleet.
     */
    set environmentType(value: string | undefined);
    /**
     * Information about the proxy configurations that apply network access control to your reserved capacity instances.
     */
    get fleetProxyConfiguration(): cdk.IResolvable | CfnFleet.ProxyConfigurationProperty | undefined;
    /**
     * Information about the proxy configurations that apply network access control to your reserved capacity instances.
     */
    set fleetProxyConfiguration(value: cdk.IResolvable | CfnFleet.ProxyConfigurationProperty | undefined);
    /**
     * The service role associated with the compute fleet.
     */
    get fleetServiceRole(): string | undefined;
    /**
     * The service role associated with the compute fleet.
     */
    set fleetServiceRole(value: string | undefined);
    /**
     * Information about the VPC configuration that AWS CodeBuild accesses.
     */
    get fleetVpcConfig(): cdk.IResolvable | CfnFleet.VpcConfigProperty | undefined;
    /**
     * Information about the VPC configuration that AWS CodeBuild accesses.
     */
    set fleetVpcConfig(value: cdk.IResolvable | CfnFleet.VpcConfigProperty | undefined);
    /**
     * The Amazon Machine Image (AMI) of the compute fleet.
     */
     ...
     * The compute fleet overflow behavior.
     */
    get overflowBehavior(): string | undefined;
    /**
     * The compute fleet overflow behavior.
     */
    set overflowBehavior(value: string | undefined);
    /**
     * The scaling configuration of the compute fleet.
     */
    get scalingConfiguration(): cdk.IResolvable | CfnFleet.ScalingConfigurationInputProperty | undefined;
    /**
     * The scaling configuration of the compute fleet.
     */
    set scalingConfiguration(value: cdk.IResolvable | CfnFleet.ScalingConfigurationInputProperty | undefined);
    /**
     * A list of tag key and value pairs associated with this compute fleet.
     */
 ...
 */
export declare class CfnBuild extends cdk.CfnResource implements cdk.IInspectable, IBuildRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    get attrBuildComplete(): cdk.IResolvable;
    /**
     * @cloudformationAttribute BuildNumber
     */
    get attrBuildNumber(): number;
    /**
     * @cloudformationAttribute BuildStatus
     */
    get attrBuildStatus(): string;
    /**
     * @cloudformationAttribute CurrentPhase
     */
    get attrCurrentPhase(): string;
    /**
     ...
     */
    get attrInitiator(): string;
    /**
     * @cloudformationAttribute QueuedTimeoutInMinutes
     */
    get attrQueuedTimeoutInMinutes(): number;
    /**
     ...
     */
    get attrTimeoutInMinutes(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnBuildBatch extends cdk.CfnResource implements cdk.IInspectable, IBuildBatchRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnBuildBatch from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnBuildBatch;
    /**
     * Checks whether the given object is a CfnBuildBatch
     */
    static isCfnBuildBatch(x: any): x is CfnBuildBatch;
    /**
     * Creates a new IBuildBatchRef from an ARN
     */
    static fromBuildBatchArn(scope: constructs.Construct, id: string, arn: string): IBuildBatchRef;
    /**
     * Creates a new IBuildBatchRef from a buildBatchId
     */
    static fromBuildBatchId(scope: constructs.Construct, id: string, buildBatchId: string): IBuildBatchRef;
    static arnForBuildBatch(resource: IBuildBatchRef): string;
    private _projectName?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnBuildBatchProps);
    get buildBatchRef(): BuildBatchReference;
    get projectName(): string | undefined;
    set projectName(value: string | undefined);
    /**
     * @cloudformationAttribute Arn
     ...
     */
    get attrBuildBatchNumber(): number;
    /**
     * @cloudformationAttribute BuildBatchStatus
     */
    get attrBuildBatchStatus(): string;
    /**
     * @cloudformationAttribute BuildTimeoutInMinutes
     */
    get attrBuildTimeoutInMinutes(): number;
    /**
     * @cloudformationAttribute Complete
     */
    get attrComplete(): cdk.IResolvable;
    /**
     * @cloudformationAttribute CurrentPhase
     */
    get attrCurrentPhase(): string;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-buildbatch.html
 */
export interface CfnBuildBatchProps {
    /**
...
export type { IReportGroupRef, ReportGroupReference };
export type { ISourceCredentialRef, SourceCredentialReference };
export type { IFleetRef, FleetReference };
export type { IBuildRef, BuildReference };
export type { IBuildBatchRef, BuildBatchReference };
