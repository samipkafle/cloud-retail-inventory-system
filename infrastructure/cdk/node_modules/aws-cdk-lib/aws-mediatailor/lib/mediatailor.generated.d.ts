...
export declare class CfnPlaybackConfiguration extends cdk.CfnResource implements cdk.IInspectable, IPlaybackConfigurationRef, cdk.ITaggable {
     ...
     * A map of event names to function identifiers for custom processing during session lifecycle events.
     */
    get functionMapping(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A map of event names to function identifiers for custom processing during session lifecycle events.
     */
    set functionMapping(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The configuration for HLS content.
     */
...
export declare namespace CfnPlaybackConfiguration {
    ...
    interface AdDecisionServerConfigurationProperty {
         ...
         */
        readonly httpRequest: CfnPlaybackConfiguration.HttpRequestProperty | cdk.IResolvable;
    }
    /**
     * The configuration for the request to the Ad Decision Server URL.
     *
...
export interface CfnPlaybackConfigurationProps {
     ...
     */
    readonly adDecisionServerConfiguration?: CfnPlaybackConfiguration.AdDecisionServerConfigurationProperty | cdk.IResolvable;
    /**
     * The URL for the ad decision server (ADS).
     *
     * This includes the specification of static parameters and placeholders for dynamic parameters. AWS Elemental MediaTailor substitutes player-specific and session-specific parameters as needed when calling the ADS. Alternately, for testing you can provide a static VAST URL. The maximum length is 25,000 characters.
...
export declare class CfnSourceLocation extends cdk.CfnResource implements cdk.IInspectable, ISourceLocationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnSourceLocation(x: any): x is CfnSourceLocation;
    /**
     * Creates a new ISourceLocationRef from an ARN
     */
    static fromSourceLocationArn(scope: constructs.Construct, id: string, arn: string): ISourceLocationRef;
    /**
     * Creates a new ISourceLocationRef from a sourceLocationName
     */
    static fromSourceLocationName(scope: constructs.Construct, id: string, sourceLocationName: string): ISourceLocationRef;
    static arnForSourceLocation(resource: ISourceLocationRef): string;
    /**
     * The access configuration for the source location.
     */
    private _accessConfiguration?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _defaultSegmentDeliveryConfiguration?;
    /**
     ...
     */
    private _segmentDeliveryConfigurations?;
    /**
     * The name of the source location.
     */
    private _sourceLocationName;
     ...
     * The access configuration for the source location.
     */
    get accessConfiguration(): CfnSourceLocation.AccessConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The access configuration for the source location.
     */
    set accessConfiguration(value: CfnSourceLocation.AccessConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The default segment delivery configuration.
     */
    get defaultSegmentDeliveryConfiguration(): CfnSourceLocation.DefaultSegmentDeliveryConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The default segment delivery configuration.
     */
    set defaultSegmentDeliveryConfiguration(value: CfnSourceLocation.DefaultSegmentDeliveryConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The HTTP configuration for the source location.
     */
    get httpConfiguration(): CfnSourceLocation.HttpConfigurationProperty | cdk.IResolvable;
    /**
     * The HTTP configuration for the source location.
     */
    set httpConfiguration(value: CfnSourceLocation.HttpConfigurationProperty | cdk.IResolvable);
    /**
     * The segment delivery configurations for the source location.
     */
    get segmentDeliveryConfigurations(): Array<cdk.IResolvable | CfnSourceLocation.SegmentDeliveryConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * The segment delivery configurations for the source location.
     */
    set segmentDeliveryConfigurations(value: Array<cdk.IResolvable | CfnSourceLocation.SegmentDeliveryConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The name of the source location.
     */
    get sourceLocationName(): string;
...
export declare class CfnVodSource extends cdk.CfnResource implements cdk.IInspectable, IVodSourceRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnVodSource(x: any): x is CfnVodSource;
    static arnForVodSource(resource: IVodSourceRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The HTTP package configurations for the VOD source.
     */
    get httpPackageConfigurations(): Array<CfnVodSource.HttpPackageConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The HTTP package configurations for the VOD source.
     */
    set httpPackageConfigurations(value: Array<CfnVodSource.HttpPackageConfigurationProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of the source location that the VOD source is associated with.
     */
    get sourceLocationName(): string;
     ...
     * The name of the VOD source.
     */
    get vodSourceName(): string;
    /**
     * The name of the VOD source.
     */
    set vodSourceName(value: string);
    /**
...
export type { ILiveSourceRef, LiveSourceReference };
export type { IPlaybackConfigurationRef, PlaybackConfigurationReference };
export type { ISourceLocationRef, SourceLocationReference };
export type { IVodSourceRef, VodSourceReference };
