...
export declare class CfnCacheCluster extends cdk.CfnResource implements cdk.IInspectable, ICacheClusterRef, cdk.ITaggable {
     ...
     */
    get attrConfigurationEndpoint(): cdk.IResolvable;
    /**
     ...
     */
    get attrRedisEndpoint(): cdk.IResolvable;
    /**
...
export declare class CfnParameterGroup extends cdk.CfnResource implements cdk.IInspectable, IParameterGroupRef, cdk.ITaggable {
     ...
     */
    static fromCacheParameterGroupName(scope: constructs.Construct, id: string, cacheParameterGroupName: string): IParameterGroupRef;
    static arnForParameterGroup(resource: IParameterGroupRef): string;
    /**
     * The name of the cache parameter group family that this cache parameter group is compatible with.
     */
    private _cacheParameterGroupFamily;
    /**
     ...
     * The name of the cache parameter group family that this cache parameter group is compatible with.
     */
    get cacheParameterGroupFamily(): string;
    /**
     * The name of the cache parameter group family that this cache parameter group is compatible with.
     */
    set cacheParameterGroupFamily(value: string);
    /**
     * The description for this cache parameter group.
     */
     ...
     * A comma-delimited list of parameter name/value pairs.
     */
    get properties(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A comma-delimited list of parameter name/value pairs.
     */
    set properties(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * A tag that can be added to an ElastiCache parameter group.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrCacheParameterGroupName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnReplicationGroup extends cdk.CfnResource implements cdk.IInspectable, IReplicationGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnReplicationGroup(x: any): x is CfnReplicationGroup;
    /**
     * Creates a new IReplicationGroupRef from a replicationGroupId
     */
    static fromReplicationGroupId(scope: constructs.Construct, id: string, replicationGroupId: string): IReplicationGroupRef;
    static arnForReplicationGroup(resource: IReplicationGroupRef): string;
    /**
     ...
     */
    private _snapshottingClusterId?;
    /**
     * The daily time range (in UTC) during which ElastiCache begins taking a daily snapshot of your node group (shard).
     */
    private _snapshotWindow?;
     ...
     * A flag that enables encryption at rest when set to `true` .
     */
    get atRestEncryptionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A flag that enables encryption at rest when set to `true` .
     */
    set atRestEncryptionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * *Reserved parameter.* The password used to access a password protected server.
     */
     ...
     * The mode can be enabled or disabled.
     */
    set clusterMode(value: string | undefined);
    /**
     * Enables data tiering.
     */
    get dataTieringEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Enables data tiering.
     */
    set dataTieringEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The durability setting for the replication group.
     */
     ...
     * The durability setting for the replication group.
     */
    set durability(value: string | undefined);
    /**
     * The name of the cache engine to be used for the clusters in this replication group.
     */
    get engine(): string | undefined;
     ...
     * The name of the Global datastore.
     */
    get globalReplicationGroupId(): string | undefined;
    /**
     * The name of the Global datastore.
     */
    set globalReplicationGroupId(value: string | undefined);
    /**
     * The network type you choose when creating a replication group, either `ipv4` | `ipv6` .
     */
    get ipDiscovery(): string | undefined;
     ...
     * Specifies the destination, format and type of the logs.
     */
    get logDeliveryConfigurations(): Array<cdk.IResolvable | CfnReplicationGroup.LogDeliveryConfigurationRequestProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the destination, format and type of the logs.
     */
    set logDeliveryConfigurations(value: Array<cdk.IResolvable | CfnReplicationGroup.LogDeliveryConfigurationRequestProperty> | cdk.IResolvable | undefined);
    /**
     * A flag indicating if you have Multi-AZ enabled to enhance fault tolerance.
     */
    get multiAzEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A flag indicating if you have Multi-AZ enabled to enhance fault tolerance.
     */
    set multiAzEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Must be either `ipv4` | `ipv6` | `dual_stack` .
     */
    get networkType(): string | undefined;
     ...
     * `NodeGroupConfiguration` is a property of the `AWS::ElastiCache::ReplicationGroup` resource that configures an Amazon ElastiCache (ElastiCache) Valkey or Redis OSS cluster node group.
     */
    get nodeGroupConfiguration(): Array<cdk.IResolvable | CfnReplicationGroup.NodeGroupConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * `NodeGroupConfiguration` is a property of the `AWS::ElastiCache::ReplicationGroup` resource that configures an Amazon ElastiCache (ElastiCache) Valkey or Redis OSS cluster node group.
     */
    set nodeGroupConfiguration(value: Array<cdk.IResolvable | CfnReplicationGroup.NodeGroupConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (SNS) topic to which notifications are sent.
     */
    get notificationTopicArn(): string | undefined;
     ...
     * The number of clusters this replication group initially has.
     */
    get numCacheClusters(): number | undefined;
    /**
     * The number of clusters this replication group initially has.
     */
    set numCacheClusters(value: number | undefined);
    /**
     * An optional parameter that specifies the number of node groups (shards) for this Valkey or Redis OSS (cluster mode enabled) replication group.
     */
    get numNodeGroups(): number | undefined;
    /**
     * An optional parameter that specifies the number of node groups (shards) for this Valkey or Redis OSS (cluster mode enabled) replication group.
     */
    set numNodeGroups(value: number | undefined);
    /**
     * The port number on which each member of the replication group accepts connections.
     */
    get port(): number | undefined;
     ...
     * A list of EC2 Availability Zones in which the replication group's clusters are created.
     */
    get preferredCacheClusterAZs(): Array<string> | undefined;
    /**
     * A list of EC2 Availability Zones in which the replication group's clusters are created.
     */
    set preferredCacheClusterAZs(value: Array<string> | undefined);
    /**
     * Specifies the weekly time range during which maintenance on the cluster is performed.
     */
    get preferredMaintenanceWindow(): string | undefined;
     ...
     * The identifier of the cluster that serves as the primary for this replication group.
     */
    get primaryClusterId(): string | undefined;
    /**
     * The identifier of the cluster that serves as the primary for this replication group.
     */
    set primaryClusterId(value: string | undefined);
    /**
     * An optional parameter that specifies the number of replica nodes in each node group (shard).
     */
    get replicasPerNodeGroup(): number | undefined;
    /**
     * An optional parameter that specifies the number of replica nodes in each node group (shard).
     */
    set replicasPerNodeGroup(value: number | undefined);
    /**
     * A user-created description for the replication group.
     */
     ...
     * The cluster ID that is used as the daily snapshot source for the replication group.
     */
    get snapshottingClusterId(): string | undefined;
    /**
     * The cluster ID that is used as the daily snapshot source for the replication group.
     */
    set snapshottingClusterId(value: string | undefined);
    /**
     * The daily time range (in UTC) during which ElastiCache begins taking a daily snapshot of your node group (shard).
     */
    get snapshotWindow(): string | undefined;
     ...
     * A setting that allows you to migrate your clients to use in-transit encryption, with no downtime.
     */
    get transitEncryptionMode(): string | undefined;
    /**
     * A setting that allows you to migrate your clients to use in-transit encryption, with no downtime.
     */
    set transitEncryptionMode(value: string | undefined);
    /**
     * The ID of user group to associate with the replication group.
     */
    get userGroupIds(): Array<string> | undefined;
    /**
     * The ID of user group to associate with the replication group.
     */
    set userGroupIds(value: Array<string> | undefined);
    /**
     * @cloudformationAttribute ConfigurationEndPoint
     */
    get attrConfigurationEndPoint(): cdk.IResolvable;
     ...
     */
    get attrEffectiveDurability(): string;
    /**
     * @cloudformationAttribute PrimaryEndPoint
     */
    get attrPrimaryEndPoint(): cdk.IResolvable;
    /**
     * The DNS address of the primary read-write cache node.
     *
     * @cloudformationAttribute PrimaryEndPoint.Address
     */
    get attrPrimaryEndPointAddress(): string;
    /**
     ...
     */
    get attrPrimaryEndPointPort(): string;
    /**
     ...
     */
    get attrReadEndPointAddresses(): string;
    /**
     ...
     */
    get attrReadEndPointAddressesList(): Array<string>;
    /**
     ...
     */
    get attrReadEndPointPorts(): string;
    /**
...
export declare namespace CfnReplicationGroup {
    ...
    interface ReadEndPointProperty {
         ...
         */
        readonly addressesList?: Array<string>;
        /**
         ...
         */
        readonly portsList?: Array<string>;
    }
}
/**
...
export declare class CfnSecurityGroup extends cdk.CfnResource implements cdk.IInspectable, ISecurityGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnSecurityGroup(x: any): x is CfnSecurityGroup;
    /**
...
export declare class CfnSecurityGroupIngress extends cdk.CfnResource implements cdk.IInspectable, ISecurityGroupIngressRef {
     ...
     */
    static isCfnSecurityGroupIngress(x: any): x is CfnSecurityGroupIngress;
    /**
     * The name of the Cache Security Group to authorize.
     */
    private _cacheSecurityGroupName;
    /**
     ...
     * The name of the Cache Security Group to authorize.
     */
    get cacheSecurityGroupName(): string;
    /**
     * The name of the Cache Security Group to authorize.
     */
    set cacheSecurityGroupName(value: string);
    /**
     * Name of the EC2 Security Group to include in the authorization.
     */
    get ec2SecurityGroupName(): string;
    /**
     * Name of the EC2 Security Group to include in the authorization.
     */
    set ec2SecurityGroupName(value: string);
    /**
     * Specifies the Amazon Account ID of the owner of the EC2 security group specified in the EC2SecurityGroupName property.
     */
...
export declare class CfnSubnetGroup extends cdk.CfnResource implements cdk.IInspectable, ISubnetGroupRef, cdk.ITaggable {
     ...
     */
    static fromCacheSubnetGroupName(scope: constructs.Construct, id: string, cacheSubnetGroupName: string): ISubnetGroupRef;
...
export declare class CfnUser extends cdk.CfnResource implements cdk.IInspectable, IUserRef, cdk.ITaggable {
     ...
     * Indicates a password is not required for this user.
     */
    get noPasswordRequired(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates a password is not required for this user.
     */
    set noPasswordRequired(value: boolean | cdk.IResolvable | undefined);
    /**
     * Passwords used for this user.
     */
    get passwords(): Array<string> | undefined;
    /**
     * Passwords used for this user.
     */
    set passwords(value: Array<string> | undefined);
    /**
     * The list of tags.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnUserGroup extends cdk.CfnResource implements cdk.IInspectable, IUserGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnUserGroup(x: any): x is CfnUserGroup;
    /**
     * Creates a new IUserGroupRef from an ARN
     */
    static fromUserGroupArn(scope: constructs.Construct, id: string, arn: string): IUserGroupRef;
    /**
     * Creates a new IUserGroupRef from a userGroupId
     */
    static fromUserGroupId(scope: constructs.Construct, id: string, userGroupId: string): IUserGroupRef;
    static arnForUserGroup(resource: IUserGroupRef): string;
    /**
     * The current supported values are valkey and redis.
     */
    private _engine;
...
export declare class CfnServerlessCache extends cdk.CfnResource implements cdk.IInspectable, IServerlessCacheRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnServerlessCache(x: any): x is CfnServerlessCache;
    /**
     * Creates a new IServerlessCacheRef from an ARN
     */
    static fromServerlessCacheArn(scope: constructs.Construct, id: string, arn: string): IServerlessCacheRef;
    /**
     * Creates a new IServerlessCacheRef from a serverlessCacheName
     */
    static fromServerlessCacheName(scope: constructs.Construct, id: string, serverlessCacheName: string): IServerlessCacheRef;
    static arnForServerlessCache(resource: IServerlessCacheRef): string;
    /**
     ...
     * The cache usage limit for the serverless cache.
     */
    get cacheUsageLimits(): CfnServerlessCache.CacheUsageLimitsProperty | cdk.IResolvable | undefined;
    /**
     * The cache usage limit for the serverless cache.
     */
    set cacheUsageLimits(value: CfnServerlessCache.CacheUsageLimitsProperty | cdk.IResolvable | undefined);
    /**
     * The daily time that a cache snapshot will be created.
     */
    get dailySnapshotTime(): string | undefined;
    /**
     * The daily time that a cache snapshot will be created.
     */
    set dailySnapshotTime(value: string | undefined);
    /**
     * A description of the serverless cache.
     */
     ...
     * Represents the information required for client programs to connect to a cache node.
     */
    get endpoint(): CfnServerlessCache.EndpointProperty | cdk.IResolvable | undefined;
    /**
     * Represents the information required for client programs to connect to a cache node.
     */
    set endpoint(value: CfnServerlessCache.EndpointProperty | cdk.IResolvable | undefined);
    /**
     * The engine the serverless cache is compatible with.
     */
    get engine(): string;
     ...
     * The version number of the engine the serverless cache is compatible with.
     */
    get majorEngineVersion(): string | undefined;
    /**
     * The version number of the engine the serverless cache is compatible with.
     */
    set majorEngineVersion(value: string | undefined);
    /**
     * The network type for the serverless cache.
     */
    get networkType(): string | undefined;
     ...
     * Represents the information required for client programs to connect to a cache node.
     */
    get readerEndpoint(): CfnServerlessCache.EndpointProperty | cdk.IResolvable | undefined;
    /**
     * Represents the information required for client programs to connect to a cache node.
     */
    set readerEndpoint(value: CfnServerlessCache.EndpointProperty | cdk.IResolvable | undefined);
    /**
     * The IDs of the EC2 security groups associated with the serverless cache.
     */
    get securityGroupIds(): Array<string> | undefined;
     ...
     * The unique identifier of the serverless cache.
     */
    get serverlessCacheName(): string;
    /**
     * The unique identifier of the serverless cache.
     */
    set serverlessCacheName(value: string);
    /**
     * The ARN of the snapshot from which to restore data into the new cache.
     */
    get snapshotArnsToRestore(): Array<string> | undefined;
    /**
     * The ARN of the snapshot from which to restore data into the new cache.
     */
    set snapshotArnsToRestore(value: Array<string> | undefined);
    /**
     * The current setting for the number of serverless cache snapshots the system will retain.
     */
    get snapshotRetentionLimit(): number | undefined;
     ...
     * The identifier of the user group associated with the serverless cache.
     */
    set userGroupId(value: string | undefined);
    /**
     ...
     */
    get attrFullEngineVersion(): string;
    /**
     * The DNS hostname of the cache node.
     *
     * @cloudformationAttribute ReaderEndpoint.Address
...
export interface CfnServerlessCacheProps {
     ...
     */
    readonly userGroupId?: elastiCacheRefs.IUserGroupRef | string;
}
export type { ICacheClusterRef, CacheClusterReference };
export type { IGlobalReplicationGroupRef, GlobalReplicationGroupReference };
export type { IParameterGroupRef, ParameterGroupReference };
export type { IReplicationGroupRef, ReplicationGroupReference };
export type { ISecurityGroupRef, SecurityGroupReference };
export type { ISecurityGroupIngressRef, SecurityGroupIngressReference };
export type { ISubnetGroupRef, SubnetGroupReference };
export type { IUserRef, UserReference };
export type { IUserGroupRef, UserGroupReference };
export type { IServerlessCacheRef, ServerlessCacheReference };
