...
import { AccessPolicyReference, CollectionGroupReference, CollectionIndexReference, CollectionReference, IAccessPolicyRef, ICollectionGroupRef, ICollectionIndexRef, ICollectionRef, IIndexRef, ILifecyclePolicyRef, IndexReference, ISecurityConfigRef, ISecurityPolicyRef, IVpcEndpointRef, LifecyclePolicyReference, SecurityConfigReference, SecurityPolicyReference, VpcEndpointReference } from "../../interfaces/generated/aws-opensearchserverless-interfaces.generated";
 ...
 */
export declare class CfnCollectionIndex extends cdk.CfnResource implements cdk.IInspectable, ICollectionIndexRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCollectionIndex from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCollectionIndex;
    /**
     * Checks whether the given object is a CfnCollectionIndex
     */
    static isCfnCollectionIndex(x: any): x is CfnCollectionIndex;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCollectionIndexProps);
    get collectionIndexRef(): CollectionIndexReference;
    /**
     * The identifier of the collection.
     */
    get id(): string;
     ...
     * The Mappings for the collection index.
     */
    get indexSchema(): string | undefined;
    /**
     * The Mappings for the collection index.
     */
    set indexSchema(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-opensearchserverless-collectionindex.html
 */
export interface CfnCollectionIndexProps {
    /**
     * The identifier of the collection.
     *
...
export declare namespace CfnIndex {
    ...
    interface IndexSettingsProperty {
         ...
         */
        readonly analysis?: CfnIndex.AnalysisProperty | cdk.IResolvable;
        /**
         * Index settings.
         *
    ...
    interface AnalysisProperty {
         ...
         */
        readonly analyzer?: cdk.IResolvable | Record<string, CfnIndex.AnalyzerItemsProperty | cdk.IResolvable>;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface AnalyzerItemsProperty {
        /**
         ...
         */
        readonly charFilter?: Array<string>;
        /**
...
export type { ICollectionIndexRef, CollectionIndexReference };
