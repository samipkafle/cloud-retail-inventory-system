...
import { GlobalTableReference, IGlobalTableRef, IStreamRef, ITableRef, StreamReference, TableReference } from "../../interfaces/generated/aws-dynamodb-interfaces.generated";
/**
...
export declare class CfnGlobalTable extends cdk.CfnResource implements cdk.IInspectable, IGlobalTableRef {
     ...
     */
    static isCfnGlobalTable(x: any): x is CfnGlobalTable;
    static arnForGlobalTable(resource: IGlobalTableRef): string;
    /**
    ...
    private _globalTableSourceArn?;
    /**
     * The list of witnesses of the MRSC global table.
     */
    private _globalTableWitnesses?;
    /**
     ...
     */
    private _multiRegionConsistency?;
    private _readOnDemandThroughputSettings?;
    private _readProvisionedThroughputSettings?;
    /**
     ...
     */
    private _writeOnDemandThroughputSettings?;
    /**
     ...
     * A list of attributes that describe the key schema for the global table and indexes.
     */
    get attributeDefinitions(): Array<CfnGlobalTable.AttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of attributes that describe the key schema for the global table and indexes.
     */
    set attributeDefinitions(value: Array<CfnGlobalTable.AttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies how you are charged for read and write throughput and how you manage capacity. Valid values are:.
     */
     ...
     * Global secondary indexes to be created on the global table.
     */
    get globalSecondaryIndexes(): Array<CfnGlobalTable.GlobalSecondaryIndexProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Global secondary indexes to be created on the global table.
     */
    set globalSecondaryIndexes(value: Array<CfnGlobalTable.GlobalSecondaryIndexProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get globalTableSourceArn(): string | undefined;
    set globalTableSourceArn(value: string | undefined);
    /**
     * The list of witnesses of the MRSC global table.
     */
    get globalTableWitnesses(): Array<CfnGlobalTable.GlobalTableWitnessProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of witnesses of the MRSC global table.
     */
    set globalTableWitnesses(value: Array<CfnGlobalTable.GlobalTableWitnessProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the attributes that make up the primary key for the table.
     */
    get keySchema(): Array<cdk.IResolvable | CfnGlobalTable.KeySchemaProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the attributes that make up the primary key for the table.
     */
    set keySchema(value: Array<cdk.IResolvable | CfnGlobalTable.KeySchemaProperty> | cdk.IResolvable | undefined);
    /**
     * Local secondary indexes to be created on the table.
     */
    get localSecondaryIndexes(): Array<cdk.IResolvable | CfnGlobalTable.LocalSecondaryIndexProperty> | cdk.IResolvable | undefined;
    /**
     * Local secondary indexes to be created on the table.
     */
    set localSecondaryIndexes(value: Array<cdk.IResolvable | CfnGlobalTable.LocalSecondaryIndexProperty> | cdk.IResolvable | undefined);
    /**
     * Specifies the consistency mode for a new global table.
     */
    get multiRegionConsistency(): string | undefined;
    /**
     * Specifies the consistency mode for a new global table.
     */
    set multiRegionConsistency(value: string | undefined);
    get readOnDemandThroughputSettings(): cdk.IResolvable | CfnGlobalTable.ReadOnDemandThroughputSettingsProperty | undefined;
    set readOnDemandThroughputSettings(value: cdk.IResolvable | CfnGlobalTable.ReadOnDemandThroughputSettingsProperty | undefined);
    get readProvisionedThroughputSettings(): CfnGlobalTable.GlobalReadProvisionedThroughputSettingsProperty | cdk.IResolvable | undefined;
    set readProvisionedThroughputSettings(value: CfnGlobalTable.GlobalReadProvisionedThroughputSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the list of replicas for your global table.
     */
    get replicas(): Array<cdk.IResolvable | CfnGlobalTable.ReplicaSpecificationProperty> | cdk.IResolvable;
    /**
     * Specifies the list of replicas for your global table.
     */
    set replicas(value: Array<cdk.IResolvable | CfnGlobalTable.ReplicaSpecificationProperty> | cdk.IResolvable);
    /**
     * Specifies the settings to enable server-side encryption.
     */
    get sseSpecification(): cdk.IResolvable | CfnGlobalTable.SSESpecificationProperty | undefined;
    /**
     * Specifies the settings to enable server-side encryption.
     */
    set sseSpecification(value: cdk.IResolvable | CfnGlobalTable.SSESpecificationProperty | undefined);
    /**
     * Specifies the streams settings on your global table.
     */
    get streamSpecification(): cdk.IResolvable | CfnGlobalTable.StreamSpecificationProperty | undefined;
    /**
     * Specifies the streams settings on your global table.
     */
    set streamSpecification(value: cdk.IResolvable | CfnGlobalTable.StreamSpecificationProperty | undefined);
    /**
     * A name for the global table.
     */
     ...
     * Specifies the time to live (TTL) settings for the table.
     */
    get timeToLiveSpecification(): cdk.IResolvable | CfnGlobalTable.TimeToLiveSpecificationProperty | undefined;
    /**
     * Specifies the time to live (TTL) settings for the table.
     */
    set timeToLiveSpecification(value: cdk.IResolvable | CfnGlobalTable.TimeToLiveSpecificationProperty | undefined);
    /**
     * Provides visibility into the number of read and write operations your table or secondary index can instantaneously support.
     */
    get warmThroughput(): cdk.IResolvable | CfnGlobalTable.WarmThroughputProperty | undefined;
    /**
     * Provides visibility into the number of read and write operations your table or secondary index can instantaneously support.
     */
    set warmThroughput(value: cdk.IResolvable | CfnGlobalTable.WarmThroughputProperty | undefined);
    /**
     * Sets the write request settings for a global table or a global secondary index.
     */
    get writeOnDemandThroughputSettings(): cdk.IResolvable | CfnGlobalTable.WriteOnDemandThroughputSettingsProperty | undefined;
    /**
     * Sets the write request settings for a global table or a global secondary index.
     */
    set writeOnDemandThroughputSettings(value: cdk.IResolvable | CfnGlobalTable.WriteOnDemandThroughputSettingsProperty | undefined);
    /**
     * Specifies an auto scaling policy for write capacity.
     */
    get writeProvisionedThroughputSettings(): cdk.IResolvable | CfnGlobalTable.WriteProvisionedThroughputSettingsProperty | undefined;
    /**
     * Specifies an auto scaling policy for write capacity.
     */
    set writeProvisionedThroughputSettings(value: cdk.IResolvable | CfnGlobalTable.WriteProvisionedThroughputSettingsProperty | undefined);
    /**
...
export declare namespace CfnGlobalTable {
    ...
    interface GlobalSecondaryIndexProperty {
         ...
         */
        readonly readProvisionedThroughputSettings?: CfnGlobalTable.GlobalReadProvisionedThroughputSettingsProperty | cdk.IResolvable;
        /**
...
export declare class CfnTable extends cdk.CfnResource implements cdk.IInspectable, ITableRef, cdk.ITaggable {
     ...
     */
    static fromTableArn(scope: constructs.Construct, id: string, arn: string): ITableRef;
    /**
     * Creates a new ITableRef from a tableName
     */
    static fromTableName(scope: constructs.Construct, id: string, tableName: string): ITableRef;
     ...
     */
    private _contributorInsightsSpecification?;
    /**
     ...
     */
    private _importSourceSpecification?;
    /**
     * Specifies the attributes that make up the primary key for the table.
     */
    private _keySchema;
     ...
     */
    private _kinesisStreamSpecification?;
    /**
     * Local secondary indexes to be created on the table.
     */
    private _localSecondaryIndexes?;
     ...
     * The settings used to enable point in time recovery.
     */
    private _pointInTimeRecoverySpecification?;
    /**
     ...
     * A list of attributes that describe the key schema for the table and indexes.
     */
    get attributeDefinitions(): Array<CfnTable.AttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of attributes that describe the key schema for the table and indexes.
     */
    set attributeDefinitions(value: Array<CfnTable.AttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specify how you are charged for read and write throughput and how you manage capacity.
     */
    get billingMode(): string | undefined;
     ...
     * The settings used to specify whether to enable CloudWatch Contributor Insights for the table and define which events to monitor.
     */
    get contributorInsightsSpecification(): CfnTable.ContributorInsightsSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * The settings used to specify whether to enable CloudWatch Contributor Insights for the table and define which events to monitor.
     */
    set contributorInsightsSpecification(value: CfnTable.ContributorInsightsSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * Determines if a table is protected from deletion.
     */
     ...
     * Global secondary indexes to be created on the table. You can create up to 20 global secondary indexes.
     */
    get globalSecondaryIndexes(): Array<CfnTable.GlobalSecondaryIndexProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Global secondary indexes to be created on the table. You can create up to 20 global secondary indexes.
     */
    set globalSecondaryIndexes(value: Array<CfnTable.GlobalSecondaryIndexProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the properties of data being imported from the S3 bucket source to the" table.
     */
    get importSourceSpecification(): CfnTable.ImportSourceSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the properties of data being imported from the S3 bucket source to the" table.
     */
    set importSourceSpecification(value: CfnTable.ImportSourceSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the attributes that make up the primary key for the table.
     */
    get keySchema(): Array<cdk.IResolvable | CfnTable.KeySchemaProperty> | cdk.IResolvable;
    /**
     * Specifies the attributes that make up the primary key for the table.
     */
    set keySchema(value: Array<cdk.IResolvable | CfnTable.KeySchemaProperty> | cdk.IResolvable);
    /**
     * The Kinesis Data Streams configuration for the specified table.
     */
    get kinesisStreamSpecification(): cdk.IResolvable | CfnTable.KinesisStreamSpecificationProperty | undefined;
    /**
     * The Kinesis Data Streams configuration for the specified table.
     */
    set kinesisStreamSpecification(value: cdk.IResolvable | CfnTable.KinesisStreamSpecificationProperty | undefined);
    /**
     * Local secondary indexes to be created on the table.
     */
    get localSecondaryIndexes(): Array<cdk.IResolvable | CfnTable.LocalSecondaryIndexProperty> | cdk.IResolvable | undefined;
    /**
     * Local secondary indexes to be created on the table.
     */
    set localSecondaryIndexes(value: Array<cdk.IResolvable | CfnTable.LocalSecondaryIndexProperty> | cdk.IResolvable | undefined);
    /**
     * Sets the maximum number of read and write units for the specified on-demand table.
     */
    get onDemandThroughput(): cdk.IResolvable | CfnTable.OnDemandThroughputProperty | undefined;
    /**
     * Sets the maximum number of read and write units for the specified on-demand table.
     */
    set onDemandThroughput(value: cdk.IResolvable | CfnTable.OnDemandThroughputProperty | undefined);
    /**
     * The settings used to enable point in time recovery.
     */
    get pointInTimeRecoverySpecification(): cdk.IResolvable | CfnTable.PointInTimeRecoverySpecificationProperty | undefined;
    /**
     * The settings used to enable point in time recovery.
     */
    set pointInTimeRecoverySpecification(value: cdk.IResolvable | CfnTable.PointInTimeRecoverySpecificationProperty | undefined);
    /**
     * Throughput for the specified table, which consists of values for `ReadCapacityUnits` and `WriteCapacityUnits` .
     */
    get provisionedThroughput(): cdk.IResolvable | CfnTable.ProvisionedThroughputProperty | undefined;
    /**
     * Throughput for the specified table, which consists of values for `ReadCapacityUnits` and `WriteCapacityUnits` .
     */
    set provisionedThroughput(value: cdk.IResolvable | CfnTable.ProvisionedThroughputProperty | undefined);
    /**
     * An AWS resource-based policy document in JSON format that will be attached to the table.
     */
    get resourcePolicy(): cdk.IResolvable | CfnTable.ResourcePolicyProperty | undefined;
    /**
     * An AWS resource-based policy document in JSON format that will be attached to the table.
     */
    set resourcePolicy(value: cdk.IResolvable | CfnTable.ResourcePolicyProperty | undefined);
    /**
     * Specifies the settings to enable server-side encryption.
     */
    get sseSpecification(): cdk.IResolvable | CfnTable.SSESpecificationProperty | undefined;
    /**
     * Specifies the settings to enable server-side encryption.
     */
    set sseSpecification(value: cdk.IResolvable | CfnTable.SSESpecificationProperty | undefined);
    /**
     * The settings for the DynamoDB table stream, which captures changes to items stored in the table.
     */
    get streamSpecification(): cdk.IResolvable | CfnTable.StreamSpecificationProperty | undefined;
    /**
     * The settings for the DynamoDB table stream, which captures changes to items stored in the table.
     */
    set streamSpecification(value: cdk.IResolvable | CfnTable.StreamSpecificationProperty | undefined);
    /**
     * The table class of the new table.
     */
    get tableClass(): string | undefined;
    /**
     * The table class of the new table.
     */
    set tableClass(value: string | undefined);
    /**
     * A name for the table.
     */
    get tableName(): string | undefined;
     ...
     * Specifies the Time to Live (TTL) settings for the table.
     */
    get timeToLiveSpecification(): cdk.IResolvable | CfnTable.TimeToLiveSpecificationProperty | undefined;
    /**
     * Specifies the Time to Live (TTL) settings for the table.
     */
    set timeToLiveSpecification(value: cdk.IResolvable | CfnTable.TimeToLiveSpecificationProperty | undefined);
    /**
     * Represents the warm throughput (in read units per second and write units per second) for creating a table.
     */
    get warmThroughput(): cdk.IResolvable | CfnTable.WarmThroughputProperty | undefined;
    /**
     * Represents the warm throughput (in read units per second and write units per second) for creating a table.
     */
    set warmThroughput(value: cdk.IResolvable | CfnTable.WarmThroughputProperty | undefined);
    /**
 ...
 */
export declare class CfnStream extends cdk.CfnResource implements cdk.IInspectable, IStreamRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    get attrCreationRequestDateTime(): string;
    /**
     ...
     */
    get attrKeySchema(): cdk.IResolvable;
    /**
     * @cloudformationAttribute StreamArn
     */
    get attrStreamArn(): string;
     ...
     */
    get attrStreamLabel(): string;
    /**
     * @cloudformationAttribute StreamStatus
     */
    get attrStreamStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IGlobalTableRef, GlobalTableReference };
