...
import { ChannelPlacementGroupReference, ChannelReference, CloudWatchAlarmTemplateGroupReference, CloudWatchAlarmTemplateReference, ClusterReference, EventBridgeRuleTemplateGroupReference, EventBridgeRuleTemplateReference, IChannelPlacementGroupRef, IChannelRef, ICloudWatchAlarmTemplateGroupRef, ICloudWatchAlarmTemplateRef, IClusterRef, IEventBridgeRuleTemplateGroupRef, IEventBridgeRuleTemplateRef, IInputRef, IInputSecurityGroupRef, IMultiplexprogramRef, IMultiplexRef, INetworkRef, INodeRef, InputReference, InputSecurityGroupReference, ISdiSourceRef, ISignalMapRef, MultiplexprogramReference, MultiplexReference, NetworkReference, NodeReference, SdiSourceReference, SignalMapReference } from "../../interfaces/generated/aws-medialive-interfaces.generated";
/**
...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggable {
     ...
     */
    static fromChannelId(scope: constructs.Construct, id: string, channelId: string): IChannelRef;
    static arnForChannel(resource: IChannelRef): string;
    private _anywhereSettings?;
    /**
    ...
    private _channelEngineVersion?;
    private _channelSecurityGroups?;
    /**
    ...
    private _linkedChannelSettings?;
    /**
    ...
    get anywhereSettings(): CfnChannel.AnywhereSettingsProperty | cdk.IResolvable | undefined;
    set anywhereSettings(value: CfnChannel.AnywhereSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Specification of CDI inputs for this channel.
     */
    get cdiInputSpecification(): CfnChannel.CdiInputSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * Specification of CDI inputs for this channel.
     */
    set cdiInputSpecification(value: CfnChannel.CdiInputSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * The class for this channel.
     */
    get channelClass(): string | undefined;
    /**
     * The class for this channel.
     */
    set channelClass(value: string | undefined);
    get channelEngineVersion(): CfnChannel.ChannelEngineVersionRequestProperty | cdk.IResolvable | undefined;
    set channelEngineVersion(value: CfnChannel.ChannelEngineVersionRequestProperty | cdk.IResolvable | undefined);
    get channelSecurityGroups(): Array<string> | undefined;
    set channelSecurityGroups(value: Array<string> | undefined);
    /**
     * The settings that identify the destination for the outputs in this MediaLive output package.
     */
    get destinations(): Array<cdk.IResolvable | CfnChannel.OutputDestinationProperty> | cdk.IResolvable | undefined;
    /**
     * The settings that identify the destination for the outputs in this MediaLive output package.
     */
    set destinations(value: Array<cdk.IResolvable | CfnChannel.OutputDestinationProperty> | cdk.IResolvable | undefined);
    get dryRun(): boolean | cdk.IResolvable | undefined;
    set dryRun(value: boolean | cdk.IResolvable | undefined);
    /**
     * The encoding configuration for the output content.
     */
    get encoderSettings(): CfnChannel.EncoderSettingsProperty | cdk.IResolvable | undefined;
    /**
     * The encoding configuration for the output content.
     */
    set encoderSettings(value: CfnChannel.EncoderSettingsProperty | cdk.IResolvable | undefined);
    get inferenceSettings(): CfnChannel.InferenceSettingsProperty | cdk.IResolvable | undefined;
    set inferenceSettings(value: CfnChannel.InferenceSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The list of input attachments for the channel.
     */
    get inputAttachments(): Array<CfnChannel.InputAttachmentProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of input attachments for the channel.
     */
    set inputAttachments(value: Array<CfnChannel.InputAttachmentProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The input specification for this channel.
     */
    get inputSpecification(): CfnChannel.InputSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * The input specification for this channel.
     */
    set inputSpecification(value: CfnChannel.InputSpecificationProperty | cdk.IResolvable | undefined);
    get linkedChannelSettings(): cdk.IResolvable | CfnChannel.LinkedChannelSettingsProperty | undefined;
    set linkedChannelSettings(value: cdk.IResolvable | CfnChannel.LinkedChannelSettingsProperty | undefined);
    /**
     * The verbosity for logging activity for this channel.
     */
     ...
     * Maintenance settings for this channel.
     */
    get maintenance(): cdk.IResolvable | CfnChannel.MaintenanceCreateSettingsProperty | undefined;
    /**
     * Maintenance settings for this channel.
     */
    set maintenance(value: cdk.IResolvable | CfnChannel.MaintenanceCreateSettingsProperty | undefined);
    /**
     * Name of channel.
     */
     ...
     * Settings to enable VPC mode in the channel, so that the endpoints for all outputs are in your VPC.
     */
    get vpc(): cdk.IResolvable | CfnChannel.VpcOutputSettingsProperty | undefined;
    /**
     * Settings to enable VPC mode in the channel, so that the endpoints for all outputs are in your VPC.
     */
    set vpc(value: cdk.IResolvable | CfnChannel.VpcOutputSettingsProperty | undefined);
    /**
...
export declare namespace CfnChannel {
    ...
    interface AudioPidSelectionProperty {
         ...
         */
        readonly pids?: Array<CfnChannel.AudioPidProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface AudioPidProperty {
         ...
         */
        readonly premixSettings?: CfnChannel.AudioPreMixerSettingsProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CaptionSelectorSettingsProperty {
         ...
         */
        readonly smartSubtitleSourceSettings?: cdk.IResolvable | CfnChannel.SmartSubtitleSourceSettingsProperty;
        /**
     ...
     */
    interface SmartSubtitleSourceSettingsProperty {
        /**
         ...
         */
        readonly captionSynchronizationMode?: string;
        /**
    ...
    interface H265ColorSpaceSettingsProperty {
         ...
         */
        readonly hlg2020Settings?: any | cdk.IResolvable;
        /**
         * Settings to configure the handling of Rec601 color space.
         *
    ...
    interface OutputLockingSettingsProperty {
         ...
         */
        readonly disabledLockingSettings?: CfnChannel.DisabledLockingSettingsProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly pipelineLockingSettings?: cdk.IResolvable | CfnChannel.PipelineLockingSettingsProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface DisabledLockingSettingsProperty {
        /**
     ...
     */
    interface PipelineLockingSettingsProperty {
        /**
         ...
         */
        readonly pipelineLockingMethod?: string;
    }
    /**
     * Settings to enable and configure the motion graphics overlay feature in the channel.
     *
    ...
    interface OutputSettingsProperty {
         ...
         */
        readonly mediaConnectRouterOutputSettings?: cdk.IResolvable | CfnChannel.MediaConnectRouterOutputSettingsProperty;
        /**
     ...
     */
    interface MediaConnectRouterOutputSettingsProperty {
        /**
         ...
         */
        readonly connectedRouterInputs?: cdk.IResolvable | CfnChannel.MediaConnectRouterOutputConnectionMapProperty;
        /**
         ...
         */
        readonly containerSettings?: cdk.IResolvable | CfnChannel.MediaConnectRouterContainerSettingsProperty;
        /**
     ...
     */
    interface MediaConnectRouterOutputConnectionMapProperty {
        /**
     ...
     */
    interface MediaConnectRouterContainerSettingsProperty {
        /**
    ...
    interface OutputGroupSettingsProperty {
         ...
         */
        readonly mediaConnectRouterGroupSettings?: cdk.IResolvable | CfnChannel.MediaConnectRouterGroupSettingsProperty;
        /**
    ...
    interface MediaPackageV2GroupSettingsProperty {
         ...
         */
        readonly additionalDestinations?: Array<cdk.IResolvable | CfnChannel.MediaPackageAdditionalDestinationsProperty> | cdk.IResolvable;
        /**
     ...
     */
    interface MediaPackageAdditionalDestinationsProperty {
        /**
     ...
     */
    interface MediaConnectRouterGroupSettingsProperty {
        /**
    ...
    interface CmafIngestGroupSettingsProperty {
         ...
         */
        readonly additionalDestinations?: Array<CfnChannel.AdditionalDestinationsProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
     ...
     */
    interface AdditionalDestinationsProperty {
        /**
    ...
    interface OutputDestinationProperty {
         ...
         */
        readonly mediaConnectRouterSettings?: Array<cdk.IResolvable | CfnChannel.MediaConnectRouterOutputDestinationSettingsProperty> | cdk.IResolvable;
        /**
    ...
    interface MediaPackageOutputDestinationSettingsProperty {
         ...
         */
        readonly mediaPackageRegionName?: string;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface MediaConnectRouterOutputDestinationSettingsProperty {
        /**
     ...
     */
    interface LinkedChannelSettingsProperty {
        /**
         ...
         */
        readonly followerChannelSettings?: CfnChannel.FollowerChannelSettingsProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly primaryChannelSettings?: cdk.IResolvable | CfnChannel.PrimaryChannelSettingsProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface PrimaryChannelSettingsProperty {
        /**
         ...
         */
        readonly linkedChannelType?: string;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface FollowerChannelSettingsProperty {
        /**
         ...
         */
        readonly primaryChannelArn?: string;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface InferenceSettingsProperty {
        /**
         ...
         */
        readonly audioFeedInputs?: Array<CfnChannel.AudioFeedInputProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
     ...
     */
    interface AudioFeedInputProperty {
        /**
...
export interface CfnChannelProps {
     ...
     */
    readonly channelSecurityGroups?: Array<string>;
    /**
     * The settings that identify the destination for the outputs in this MediaLive output package.
     *
     ...
     */
    readonly inferenceSettings?: CfnChannel.InferenceSettingsProperty | cdk.IResolvable;
    /**
     * The list of input attachments for the channel.
     *
     ...
     */
    readonly linkedChannelSettings?: cdk.IResolvable | CfnChannel.LinkedChannelSettingsProperty;
    /**
     * The verbosity for logging activity for this channel.
     *
...
export declare class CfnInput extends cdk.CfnResource implements cdk.IInspectable, IInputRef, cdk.ITaggable {
     ...
     */
    static isCfnInput(x: any): x is CfnInput;
    /**
     * Creates a new IInputRef from an ARN
     */
    static fromInputArn(scope: constructs.Construct, id: string, arn: string): IInputRef;
    /**
     * Creates a new IInputRef from a inputId
     */
    static fromInputId(scope: constructs.Construct, id: string, inputId: string): IInputRef;
    static arnForInput(resource: IInputRef): string;
    /**
     ...
     */
    private _roleArn?;
    private _routerSettings?;
    private _sdiSources?;
    private _smpte2110ReceiverGroupSettings?;
    /**
     * Settings that apply only if the input is a pull type of input.
     */
    private _sources?;
    private _srtSettings?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * Settings that apply only if the input is a push type of input.
     */
    get destinations(): Array<CfnInput.InputDestinationRequestProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Settings that apply only if the input is a push type of input.
     */
    set destinations(value: Array<CfnInput.InputDestinationRequestProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Settings that apply only if the input is an Elemental Link input.
     */
    get inputDevices(): Array<CfnInput.InputDeviceSettingsProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Settings that apply only if the input is an Elemental Link input.
     */
    set inputDevices(value: Array<CfnInput.InputDeviceSettingsProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get inputNetworkLocation(): string | undefined;
    set inputNetworkLocation(value: string | undefined);
    /**
     * The list of input security groups (referenced by IDs) to attach to the input if the input is a push type.
     */
    get inputSecurityGroups(): Array<string> | undefined;
    /**
     * The list of input security groups (referenced by IDs) to attach to the input if the input is a push type.
     */
    set inputSecurityGroups(value: Array<string> | undefined);
    /**
     * Settings that apply only if the input is a MediaConnect input.
     */
    get mediaConnectFlows(): Array<cdk.IResolvable | CfnInput.MediaConnectFlowRequestProperty> | cdk.IResolvable | undefined;
    /**
     * Settings that apply only if the input is a MediaConnect input.
     */
    set mediaConnectFlows(value: Array<cdk.IResolvable | CfnInput.MediaConnectFlowRequestProperty> | cdk.IResolvable | undefined);
    get multicastSettings(): cdk.IResolvable | CfnInput.MulticastSettingsCreateRequestProperty | undefined;
    set multicastSettings(value: cdk.IResolvable | CfnInput.MulticastSettingsCreateRequestProperty | undefined);
    /**
     * A name for the input.
     */
    get name(): string | undefined;
     ...
     */
    set roleArn(value: string | undefined);
    get routerSettings(): cdk.IResolvable | CfnInput.RouterSettingsProperty | undefined;
    set routerSettings(value: cdk.IResolvable | CfnInput.RouterSettingsProperty | undefined);
    get sdiSources(): Array<string> | undefined;
    set sdiSources(value: Array<string> | undefined);
    get smpte2110ReceiverGroupSettings(): cdk.IResolvable | CfnInput.Smpte2110ReceiverGroupSettingsProperty | undefined;
    set smpte2110ReceiverGroupSettings(value: cdk.IResolvable | CfnInput.Smpte2110ReceiverGroupSettingsProperty | undefined);
    /**
     * Settings that apply only if the input is a pull type of input.
     */
    get sources(): Array<CfnInput.InputSourceRequestProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Settings that apply only if the input is a pull type of input.
     */
    set sources(value: Array<CfnInput.InputSourceRequestProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get srtSettings(): cdk.IResolvable | CfnInput.SrtSettingsRequestProperty | undefined;
    set srtSettings(value: cdk.IResolvable | CfnInput.SrtSettingsRequestProperty | undefined);
    /**
     * A collection of tags for this input.
     */
    get tagsRaw(): any | undefined;
     ...
     * Settings that apply only if the input is an push input where the source is on Amazon VPC.
     */
    get vpc(): CfnInput.InputVpcRequestProperty | cdk.IResolvable | undefined;
    /**
     * Settings that apply only if the input is an push input where the source is on Amazon VPC.
     */
    set vpc(value: CfnInput.InputVpcRequestProperty | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrDestinations(): Array<string>;
    /**
...
export declare namespace CfnInput {
    ...
    interface SrtSettingsRequestProperty {
         ...
         */
        readonly srtListenerSettings?: cdk.IResolvable | CfnInput.SrtListenerSettingsRequestProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface SrtListenerSettingsRequestProperty {
        /**
         ...
         */
        readonly decryption?: cdk.IResolvable | CfnInput.SrtListenerDecryptionRequestProperty;
        /**
     ...
     */
    interface SrtListenerDecryptionRequestProperty {
        /**
    ...
    interface RouterSettingsProperty {
         ...
         */
        readonly destinations?: Array<cdk.IResolvable | CfnInput.RouterDestinationSettingsProperty> | cdk.IResolvable;
        /**
     ...
     */
    interface RouterDestinationSettingsProperty {
        /**
...
export interface CfnInputProps {
     ...
     */
    readonly routerSettings?: cdk.IResolvable | CfnInput.RouterSettingsProperty;
    /**
...
export declare class CfnInputSecurityGroup extends cdk.CfnResource implements cdk.IInspectable, IInputSecurityGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnInputSecurityGroup(x: any): x is CfnInputSecurityGroup;
    /**
     * Creates a new IInputSecurityGroupRef from an ARN
     */
    static fromInputSecurityGroupArn(scope: constructs.Construct, id: string, arn: string): IInputSecurityGroupRef;
    /**
     * Creates a new IInputSecurityGroupRef from a inputSecurityGroupId
     */
    static fromInputSecurityGroupId(scope: constructs.Construct, id: string, inputSecurityGroupId: string): IInputSecurityGroupRef;
    static arnForInputSecurityGroup(resource: IInputSecurityGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * The list of IPv4 CIDR addresses to include in the input security group as "allowed" addresses.
     */
    get whitelistRules(): Array<CfnInputSecurityGroup.InputWhitelistRuleCidrProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of IPv4 CIDR addresses to include in the input security group as "allowed" addresses.
     */
    set whitelistRules(value: Array<CfnInputSecurityGroup.InputWhitelistRuleCidrProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnChannelPlacementGroup extends cdk.CfnResource implements cdk.IInspectable, IChannelPlacementGroupRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnChannelPlacementGroup(x: any): x is CfnChannelPlacementGroup;
    static arnForChannelPlacementGroup(resource: IChannelPlacementGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * List of nodes added to the channel placement group.
     */
    get nodes(): Array<string> | undefined;
    /**
     * List of nodes added to the channel placement group.
     */
    set nodes(value: Array<string> | undefined);
    /**
     * A collection of key-value pairs.
     */
...
export declare class CfnCloudWatchAlarmTemplate extends cdk.CfnResource implements cdk.IInspectable, ICloudWatchAlarmTemplateRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCloudWatchAlarmTemplate(x: any): x is CfnCloudWatchAlarmTemplate;
    static arnForCloudWatchAlarmTemplate(resource: ICloudWatchAlarmTemplateRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * A cloudwatch alarm template group's identifier.
     */
    set groupIdentifier(value: string | undefined);
    /**
     * The name of the metric associated with the alarm.
     */
...
export declare class CfnCloudWatchAlarmTemplateGroup extends cdk.CfnResource implements cdk.IInspectable, ICloudWatchAlarmTemplateGroupRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnCloudWatchAlarmTemplateGroup(x: any): x is CfnCloudWatchAlarmTemplateGroup;
    static arnForCloudWatchAlarmTemplateGroup(resource: ICloudWatchAlarmTemplateGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggableV2 {
     ...
     * On premises settings which will have the interface network mappings and default Output logical interface.
     */
    get networkSettings(): CfnCluster.ClusterNetworkSettingsProperty | cdk.IResolvable | undefined;
    /**
     * On premises settings which will have the interface network mappings and default Output logical interface.
     */
    set networkSettings(value: CfnCluster.ClusterNetworkSettingsProperty | cdk.IResolvable | undefined);
    /**
     * A collection of key-value pairs.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrChannelIds(): Array<string>;
    /**
...
export declare class CfnEventBridgeRuleTemplate extends cdk.CfnResource implements cdk.IInspectable, IEventBridgeRuleTemplateRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnEventBridgeRuleTemplate(x: any): x is CfnEventBridgeRuleTemplate;
    static arnForEventBridgeRuleTemplate(resource: IEventBridgeRuleTemplateRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The destinations that will receive the event notifications.
     */
    get eventTargets(): Array<CfnEventBridgeRuleTemplate.EventBridgeRuleTemplateTargetProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The destinations that will receive the event notifications.
     */
    set eventTargets(value: Array<CfnEventBridgeRuleTemplate.EventBridgeRuleTemplateTargetProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The type of event to match with the rule.
     */
...
export declare class CfnEventBridgeRuleTemplateGroup extends cdk.CfnResource implements cdk.IInspectable, IEventBridgeRuleTemplateGroupRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnEventBridgeRuleTemplateGroup(x: any): x is CfnEventBridgeRuleTemplateGroup;
    static arnForEventBridgeRuleTemplateGroup(resource: IEventBridgeRuleTemplateGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnMultiplex extends cdk.CfnResource implements cdk.IInspectable, IMultiplexRef, cdk.ITaggableV2 {
    ...
    /**
     * Checks whether the given object is a CfnMultiplex
     */
    static isCfnMultiplex(x: any): x is CfnMultiplex;
    /**
     * Creates a new IMultiplexRef from an ARN
     */
    static fromMultiplexArn(scope: constructs.Construct, id: string, arn: string): IMultiplexRef;
    /**
     * Creates a new IMultiplexRef from a multiplexId
     */
    static fromMultiplexId(scope: constructs.Construct, id: string, multiplexId: string): IMultiplexRef;
    static arnForMultiplex(resource: IMultiplexRef): string;
    /**
     ...
     * A list of availability zones for the multiplex.
     */
    get availabilityZones(): Array<string>;
    /**
     * A list of availability zones for the multiplex.
     */
    set availabilityZones(value: Array<string>);
    /**
     * A list of the multiplex output destinations.
     */
    get destinations(): Array<cdk.IResolvable | CfnMultiplex.MultiplexOutputDestinationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of the multiplex output destinations.
     */
    set destinations(value: Array<cdk.IResolvable | CfnMultiplex.MultiplexOutputDestinationProperty> | cdk.IResolvable | undefined);
    /**
     * Configuration for a multiplex event.
     */
    get multiplexSettings(): cdk.IResolvable | CfnMultiplex.MultiplexSettingsProperty;
    /**
     * Configuration for a multiplex event.
     */
    set multiplexSettings(value: cdk.IResolvable | CfnMultiplex.MultiplexSettingsProperty);
    /**
     * The name of the multiplex.
     */
    get name(): string;
     ...
     */
    get attrPipelinesRunningCount(): number;
    /**
     * The number of programs in the multiplex.
     *
     * @cloudformationAttribute ProgramCount
     */
    get attrProgramCount(): number;
    /**
...
export declare class CfnMultiplexprogram extends cdk.CfnResource implements cdk.IInspectable, IMultiplexprogramRef {
     ...
     */
    static isCfnMultiplexprogram(x: any): x is CfnMultiplexprogram;
    /**
     * The unique id of the multiplex.
     */
     ...
     * The unique id of the multiplex.
     */
    get multiplexId(): string | undefined;
    /**
     * The unique id of the multiplex.
     */
    set multiplexId(value: string | undefined);
    /**
     * Multiplex Program settings configuration.
     */
    get multiplexProgramSettings(): cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramSettingsProperty | undefined;
    /**
     * Multiplex Program settings configuration.
     */
    set multiplexProgramSettings(value: cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramSettingsProperty | undefined);
    /**
     * Packet identifiers map for a given Multiplex program.
     */
    get packetIdentifiersMap(): cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramPacketIdentifiersMapProperty | undefined;
    /**
     * Packet identifiers map for a given Multiplex program.
     */
    set packetIdentifiersMap(value: cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramPacketIdentifiersMapProperty | undefined);
    /**
     * Contains information about the current sources for the specified program in the specified multiplex.
     */
    get pipelineDetails(): Array<cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramPipelineDetailProperty> | cdk.IResolvable | undefined;
    /**
     * Contains information about the current sources for the specified program in the specified multiplex.
     */
    set pipelineDetails(value: Array<cdk.IResolvable | CfnMultiplexprogram.MultiplexProgramPipelineDetailProperty> | cdk.IResolvable | undefined);
    /**
     * Indicates which pipeline is preferred by the multiplex for program ingest.
     */
    get preferredChannelPipeline(): string | undefined;
    /**
     * Indicates which pipeline is preferred by the multiplex for program ingest.
     */
    set preferredChannelPipeline(value: string | undefined);
    /**
     * The name of the multiplex program.
     */
     ...
     * The name of the multiplex program.
     */
    set programName(value: string | undefined);
    /**
     * The unique ID of the channel.
     *
     * @cloudformationAttribute ChannelId
     */
    get attrChannelId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnNetwork extends cdk.CfnResource implements cdk.IInspectable, INetworkRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnNetwork(x: any): x is CfnNetwork;
    /**
     * Creates a new INetworkRef from an ARN
     */
    static fromNetworkArn(scope: constructs.Construct, id: string, arn: string): INetworkRef;
    /**
     * Creates a new INetworkRef from a networkId
     */
    static fromNetworkId(scope: constructs.Construct, id: string, networkId: string): INetworkRef;
    static arnForNetwork(resource: INetworkRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The list of IP address cidr pools for the network.
     */
    get ipPools(): Array<CfnNetwork.IpPoolProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The list of IP address cidr pools for the network.
     */
    set ipPools(value: Array<CfnNetwork.IpPoolProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The user-specified name of the Network to be created.
     */
    get name(): string;
     ...
     * The routes for the network.
     */
    get routes(): Array<cdk.IResolvable | CfnNetwork.RouteProperty> | cdk.IResolvable | undefined;
    /**
     * The routes for the network.
     */
    set routes(value: Array<cdk.IResolvable | CfnNetwork.RouteProperty> | cdk.IResolvable | undefined);
    /**
     * A collection of key-value pairs.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrAssociatedClusterIds(): Array<string>;
    /**
 ...
 *
 * @cloudformationResource AWS::MediaLive::Node
 * @stability external
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-medialive-node.html
 */
export declare class CfnNode extends cdk.CfnResource implements cdk.IInspectable, INodeRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnNode(x: any): x is CfnNode;
    static arnForNode(resource: INodeRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _nodeInterfaceMappings?;
    /**
     ...
     * An array of interface mappings for the Node.
     */
    get nodeInterfaceMappings(): Array<cdk.IResolvable | CfnNode.NodeInterfaceMappingProperty> | cdk.IResolvable | undefined;
    /**
     * An array of interface mappings for the Node.
     */
    set nodeInterfaceMappings(value: Array<cdk.IResolvable | CfnNode.NodeInterfaceMappingProperty> | cdk.IResolvable | undefined);
    /**
     * The role of the Node in the Cluster.
     */
     ...
     * An array of SDI source mappings.
     */
    get sdiSourceMappings(): Array<cdk.IResolvable | CfnNode.SdiSourceMappingProperty> | cdk.IResolvable | undefined;
    /**
     * An array of SDI source mappings.
     */
    set sdiSourceMappings(value: Array<cdk.IResolvable | CfnNode.SdiSourceMappingProperty> | cdk.IResolvable | undefined);
    /**
     * A collection of key-value pairs.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     *
     * @cloudformationAttribute ChannelPlacementGroups
     */
    get attrChannelPlacementGroups(): Array<string>;
    /**
     * The current connection state of the Node.
     *
     * @cloudformationAttribute ConnectionState
     */
    get attrConnectionState(): string;
    /**
...
export interface CfnNodeProps {
     ...
     */
    readonly nodeInterfaceMappings?: Array<cdk.IResolvable | CfnNode.NodeInterfaceMappingProperty> | cdk.IResolvable;
    /**
     * The role of the Node in the Cluster.
     *
     ...
     */
    readonly sdiSourceMappings?: Array<cdk.IResolvable | CfnNode.SdiSourceMappingProperty> | cdk.IResolvable;
    /**
     * A collection of key-value pairs.
     *
...
export declare class CfnSdiSource extends cdk.CfnResource implements cdk.IInspectable, ISdiSourceRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnSdiSource(x: any): x is CfnSdiSource;
    /**
     * Creates a new ISdiSourceRef from an ARN
     */
    static fromSdiSourceArn(scope: constructs.Construct, id: string, arn: string): ISdiSourceRef;
    /**
     * Creates a new ISdiSourceRef from a sdiSourceId
     */
    static fromSdiSourceId(scope: constructs.Construct, id: string, sdiSourceId: string): ISdiSourceRef;
    static arnForSdiSource(resource: ISdiSourceRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
...
export declare class CfnSignalMap extends cdk.CfnResource implements cdk.IInspectable, ISignalMapRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnSignalMap(x: any): x is CfnSignalMap;
    static arnForSignalMap(resource: ISignalMapRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * A cloudwatch alarm template group's identifier.
     */
    private _cloudWatchAlarmTemplateGroupIdentifiers?;
    /**
     * A resource's optional description.
     */
    private _description?;
     ...
     */
    private _discoveryEntryPointArn;
    /**
     * An eventbridge rule template group's identifier.
     */
    private _eventBridgeRuleTemplateGroupIdentifiers?;
    /**
     * If true, will force a rediscovery of a signal map if an unchanged discoveryEntryPointArn is provided.
     */
    private _forceRediscovery?;
    /**
     * A resource's name.
     */
    private _name;
     ...
     * A cloudwatch alarm template group's identifier.
     */
    get cloudWatchAlarmTemplateGroupIdentifiers(): Array<string> | undefined;
    /**
     * A cloudwatch alarm template group's identifier.
     */
    set cloudWatchAlarmTemplateGroupIdentifiers(value: Array<string> | undefined);
    /**
     * A resource's optional description.
     */
    get description(): string | undefined;
     ...
     * A top-level supported Amazon Web Services resource ARN to discover a signal map from.
     */
    get discoveryEntryPointArn(): string;
    /**
     * A top-level supported Amazon Web Services resource ARN to discover a signal map from.
     */
    set discoveryEntryPointArn(value: string);
    /**
     * An eventbridge rule template group's identifier.
     */
    get eventBridgeRuleTemplateGroupIdentifiers(): Array<string> | undefined;
    /**
     * An eventbridge rule template group's identifier.
     */
    set eventBridgeRuleTemplateGroupIdentifiers(value: Array<string> | undefined);
    /**
     * If true, will force a rediscovery of a signal map if an unchanged discoveryEntryPointArn is provided.
     */
    get forceRediscovery(): boolean | cdk.IResolvable | undefined;
    /**
     * If true, will force a rediscovery of a signal map if an unchanged discoveryEntryPointArn is provided.
     */
    set forceRediscovery(value: boolean | cdk.IResolvable | undefined);
    /**
     * A resource's name.
     */
    get name(): string;
     ...
     */
    get attrCloudWatchAlarmTemplateGroupIds(): Array<string>;
    /**
     * The date and time of resource creation.
     *
     * @cloudformationAttribute CreatedAt
     ...
     */
    get attrEventBridgeRuleTemplateGroupIds(): Array<string>;
    /**
     * A map representing an incomplete AWS media workflow as a graph.
     *
     * @cloudformationAttribute FailedMediaResourceMap
     */
    get attrFailedMediaResourceMap(): cdk.IResolvable;
    /**
     * A signal map's id.
     *
     * @cloudformationAttribute Id
     ...
     */
    get attrLastDiscoveredAt(): string;
    /**
     * Represents the latest successful monitor deployment of a signal map.
     *
     * @cloudformationAttribute LastSuccessfulMonitorDeployment
     */
    get attrLastSuccessfulMonitorDeployment(): cdk.IResolvable;
    /**
     * A map representing an AWS media workflow as a graph.
     *
     * @cloudformationAttribute MediaResourceMap
     */
    get attrMediaResourceMap(): cdk.IResolvable;
    /**
     * The date and time of latest resource modification.
     *
     * @cloudformationAttribute ModifiedAt
     ...
     */
    get attrMonitorChangesPendingDeployment(): cdk.IResolvable;
    /**
     * Represents the latest monitor deployment of a signal map.
     *
     * @cloudformationAttribute MonitorDeployment
     */
    get attrMonitorDeployment(): cdk.IResolvable;
    /**
...
export type { IInputRef, InputReference };
export type { IInputSecurityGroupRef, InputSecurityGroupReference };
export type { IChannelPlacementGroupRef, ChannelPlacementGroupReference };
export type { ICloudWatchAlarmTemplateRef, CloudWatchAlarmTemplateReference };
export type { ICloudWatchAlarmTemplateGroupRef, CloudWatchAlarmTemplateGroupReference };
export type { IClusterRef, ClusterReference };
export type { IEventBridgeRuleTemplateRef, EventBridgeRuleTemplateReference };
export type { IEventBridgeRuleTemplateGroupRef, EventBridgeRuleTemplateGroupReference };
export type { IMultiplexRef, MultiplexReference };
export type { IMultiplexprogramRef, MultiplexprogramReference };
export type { INetworkRef, NetworkReference };
export type { INodeRef, NodeReference };
export type { ISdiSourceRef, SdiSourceReference };
export type { ISignalMapRef, SignalMapReference };
